...
(function () {
    var __webpack_modules__ = { 7351: function (e, t, a) {
            "use strict";
            ...
            var i = this && this.__importStar || function (e) { if (e && e.__esModule)
                return e; var t = {}; if (e != null)
                for (var a in e)
                    if (a !== "default" && Object.hasOwnProperty.call(e, a))
                        p(t, e, a); s(t, e); return t; };
            Object.defineProperty(t, "__esModule", { value: true });
            t.issue = t.issueCommand = void 0;
            var r = i(a(2087));
            var o = a(5278);
            function issueCommand(e, t, a) { var p = new Command(e, t, a); process.stdout.write(p.toString() + r.EOL); }
            ...
            var i = this && this.__importStar || function (e) { if (e && e.__esModule)
                ...
                for (var a in e)
                    if (a !== "default" && Object.hasOwnProperty.call(e, a))
                        p(t, e, a); s(t, e); return t; };
            var r = this && this.__awaiter || function (e, t, a, p) { function adopt(e) { return e instanceof a ? e : new a((function (t) { t(e); })); } return new (a || (a = Promise))((function (a, s) { function fulfilled(e) { try {
                step(p.next(e));
            }
            catch (e) {
                s(e);
            ...
            var u = a(8041);
            var c;
            (function (e) { e[e["Success"] = 0] = "Success"; e[e["Failure"] = 1] = "Failure"; })(c = t.ExitCode || (t.ExitCode = {}));
            function exportVariable(e, t) { var a = n.toCommandValue(t); process.env[e] = a; var p = process.env["GITHUB_ENV"] || ""; if (p) {
            ...
            function getBooleanInput(e, t) { var a = ["true", "True", "TRUE"]; var p = ["false", "False", "FALSE"]; var s = getInput(e, t); if (a.includes(s))
                return true; if (p.includes(s))
            ...
            "use strict";
            var p = this && this.__awaiter || function (e, t, a, p) { function adopt(e) { return e instanceof a ? e : new a((function (t) { t(e); })); } return new (a || (a = Promise))((function (a, s) { function fulfilled(e) { try {
                step(p.next(e));
            }
            catch (e) {
                s(e);
            ...
            var OidcClient = /** @class */ (function () {
                ...
                OidcClient.createHttpClient = function (e, t) {
                    ...
                    return new s.HttpClient("actions/oidc-client", [new i.BearerCredentialHandler(OidcClient.getRequestToken())], a);
                };
                ...
                OidcClient.getCall = function (e) { var t; return p(this, void 0, void 0, (function () { var a, p, s; return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            p = _a.sent();
                            s = (t = p.result) === null || t === void 0 ? void 0 : t.value;
                            if (!s) {
            ...
            var s = a(2087);
            var i = a(5747);
            var _a = i.promises, r = _a.access, o = _a.appendFile, d = _a.writeFile;
            ...
            var Summary = /** @class */ (function () {
                ...
                Summary.prototype.filePath = function () { return p(this, void 0, void 0, (function () { var e, t_4; return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, r(e, i.constants.R_OK | i.constants.W_OK)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
                ...
                Summary.prototype.addList = function (e, t) {
                    ...
                    if (t === void 0) { t = false; }
                    var a = t ? "ol" : "ul";
                    var p = e.map((function (e) { return _this_1.wrap("li", e); })).join("");
                    var s = this.wrap(a, p);
                ...
                Summary.prototype.addTable = function (e) {
                    ...
                    } var t = e.header, a = e.data, p = e.colspan, s = e.rowspan; var i = t ? "th" : "td"; var r = Object.assign(Object.assign({}, p && { colspan: p }), s && { rowspan: s }); return _this_1.wrap(i, a, r); })).join(""); return _this_1.wrap("tr", t); })).join("");
                ...
                Summary.prototype.addImage = function (e, t, a) { var _a = a || {}, p = _a.width, s = _a.height; var i = Object.assign(Object.assign({}, p && { width: p }), s && { height: s }); var r = this.wrap("img", null, Object.assign({ src: e, alt: t }, i)); return this.addRaw(r).addEOL(); };
                Summary.prototype.addHeading = function (e, t) { var a = "h".concat(t); var p = ["h1", "h2", "h3", "h4", "h5", "h6"].includes(a) ? a : "h1"; var s = this.wrap(p, e); return this.addRaw(s).addEOL(); };
            ...
            function getOctokit(e, t) { return new o.GitHub(o.getOctokitOptions(e, t)); }
            ...
            function getOctokitOptions(e, t) { var a = Object.assign({}, t || {}); var p = o.getAuthString(e, a); if (p) {
                a.auth = p;
            } return a; }
            t.getOctokitOptions = getOctokitOptions;
        }, 5526: function (e, t) {
            "use strict";
            var a = this && this.__awaiter || function (e, t, a, p) { function adopt(e) { return e instanceof a ? e : new a((function (t) { t(e); })); } return new (a || (a = Promise))((function (a, s) { function fulfilled(e) { try {
                step(p.next(e));
            }
            catch (e) {
                s(e);
            ...
            var HttpClient = /** @class */ (function () {
                ...
                HttpClient.prototype.sendStream = function (e, t, a, p) { return r(this, void 0, void 0, (function () { return __generator(this, function (_a) {
                ...
                HttpClient.prototype.postJson = function (e, t, a) {
                    if (a === void 0) { a = {}; }
                    return r(this, void 0, void 0, (function () { var p, s; return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                ...
                HttpClient.prototype.request = function (e, t, a, p) { return r(this, void 0, void 0, (function () { var s, i, r, o, d, e_4, _i, _a, t_6, t_7, r_1, o_1, e_5; return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (this._disposed) {
                            ...
                            s = new URL(t);
                            i = this._prepareRequest(e, s, p);
                            r = this._allowRetries && g.includes(e) ? this._maxRetries + 1 : 1;
                            o = 0;
                            _b.label = 1;
                        case 1: return [4 /*yield*/, this.requestRaw(i, a)];
                        case 2:
                            d = _b.sent();
                            if (d && d.message && d.message.statusCode === m.Unauthorized) {
                                ...
                                if (e_4) {
                                    return [2 /*return*/, e_4.handleAuthentication(this, i, a)];
                                }
                                else {
                                    return [2 /*return*/, d];
                                }
                        ...
                        case 3:
                            ...
                            o_1 = new URL(r_1);
                            if (s.protocol === "https:" && s.protocol !== o_1.protocol && !this._allowRedirectDowngrade) {
                                throw new Error("Redirect from HTTPS to HTTP protocol. This downgrade is not allowed for security reasons. If you want to allow this behavior, set the allowRedirectDowngrade option to true.");
                            }
                            return [4 /*yield*/, d.readBody()];
                        case 4:
                            _b.sent();
                            if (o_1.hostname !== s.hostname) {
                                for (e_5 in p) {
                            ...
                            i = this._prepareRequest(e, o_1, p);
                            return [4 /*yield*/, this.requestRaw(i, a)];
                        case 5:
                            d = _b.sent();
                            t_7--;
                            return [3 /*break*/, 3];
                ...
                HttpClient.prototype.requestRawWithCallback = function (e, t, a) { if (typeof t === "string") {
                    ...
                    p = true;
                    a(e, t);
                } } var s = e.httpModule.request(e.options, (function (e) { var t = new HttpClientResponse(e); handleResult(undefined, t); })); var i; s.on("socket", (function (e) { i = e; })); s.setTimeout(this._socketTimeout || 3 * 6e4, (function () { if (i) {
                    i.end();
                ...
                HttpClient.prototype._prepareRequest = function (e, t, a) { var p = {}; p.parsedUrl = t; var s = p.parsedUrl.protocol === "https:"; p.httpModule = s ? d : o; var i = s ? 443 : 80; p.options = {}; p.options.host = p.parsedUrl.hostname; p.options.port = p.parsedUrl.port ? parseInt(p.parsedUrl.port) : i; p.options.path = (p.parsedUrl.pathname || "") + (p.parsedUrl.search || ""); p.options.method = e; p.options.headers = this._mergeHeaders(a); if (this.userAgent != null) {
                ...
                HttpClient.prototype._getAgent = function (e) { var t; var a = n.getProxyUrl(e); var p = a && a.hostname; if (this._keepAlive && p) {
                    t = this._proxyAgent;
                } if (this._keepAlive && !p) {
                    t = this._agent;
                } if (t) {
                    return t;
                } var s = e.protocol === "https:"; var i = 100; if (this.requestOptions) {
                    i = this.requestOptions.maxSockets || o.globalAgent.maxSockets;
                } if (a && a.hostname) {
                    var e_7 = { maxSockets: i, keepAlive: this._keepAlive, proxy: Object.assign(Object.assign({}, (a.username || a.password) && { proxyAuth: "".concat(a.username, ":").concat(a.password) }), { host: a.hostname, port: a.port }) };
                    var p_3;
                    var r_2 = a.protocol === "https:";
                    if (s) {
                        p_3 = r_2 ? l.httpsOverHttps : l.httpsOverHttp;
                    }
                    else {
                        p_3 = r_2 ? l.httpOverHttps : l.httpOverHttp;
                    }
                    t = p_3(e_7);
                    this._proxyAgent = t;
                } if (this._keepAlive && !t) {
                    var e_8 = { keepAlive: this._keepAlive, maxSockets: i };
                    t = s ? new d.Agent(e_8) : new o.Agent(e_8);
                    this._agent = t;
                } if (!t) {
                    t = s ? d.globalAgent : o.globalAgent;
                ...
                HttpClient.prototype._processResponse = function (e, t) { return r(this, void 0, void 0, (function () {
                    var _this_1 = this;
                    return __generator(this, function (_a) {
                        return [2 /*return*/, new Promise((function (a, p) { return r(_this_1, void 0, void 0, (function () { function dateTimeDeserializer(e, t) { if (typeof t === "string") {
                                var e_10 = new Date(t);
                                if (!isNaN(e_10.valueOf())) {
                                    return e_10;
                                }
                            } return t; } var s, i, r, o, e_9, e_11, t_8; return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
        ...
        } return { addedStrings: p, updatedStrings: a, removedStrings: t }; } function buildString(e, t, a) { var p = ""; if (e[0] || t[0] || a[0]) {
            p += s[i].startString;
            if (e[0]) {
                p += s[i].addedHeader;
                p += buildDiffString(e, "added");
            }
            if (t[0]) {
                p += s[i].updatedHeader;
                p += buildDiffString(t, "updated");
            }
            if (a[0]) {
                p += s[i].removedHeader;
                p += buildDiffString(a, "removed");
            }
            p += s[i].endString;
        } return p; } function buildDiffString(e, t) { var a = ""; e.forEach((function (e) { a += s[i][t](e); })); return a; } e.exports = doWork; }, 7789: function (e, t, a) { var p = a(8146); e.exports = getLangStrings; function getLangStrings(e) { var t = p.parse(e, { ecmaVersion: 2022 }).body[0].expression.arguments[0].elements; var a = {}; t.forEach((function (e) { var _a; (_a = e === null || e === void 0 ? void 0 : e.properties) === null || _a === void 0 ? void 0 : _a.forEach((function (e) { var _a, _b, _c, _d, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y; if (((_j = (_h = (_g = (_f = (_d = (_c = (_b = (_a = e === null || e === void 0 ? void 0 : e.value) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.body) === null || _c === void 0 ? void 0 : _c[1]) === null || _d === void 0 ? void 0 : _d.expression) === null || _f === void 0 ? void 0 : _f.right) === null || _g === void 0 ? void 0 : _g.callee) === null || _h === void 0 ? void 0 : _h.object) === null || _j === void 0 ? void 0 : _j.name) === "Object" && ((_s = (_r = (_q = (_p = (_o = (_m = (_l = (_k = e === null || e === void 0 ? void 0 : e.value) === null || _k === void 0 ? void 0 : _k.body) === null || _l === void 0 ? void 0 : _l.body) === null || _m === void 0 ? void 0 : _m[1]) === null || _o === void 0 ? void 0 : _o.expression) === null || _p === void 0 ? void 0 : _p.right) === null || _q === void 0 ? void 0 : _q.callee) === null || _r === void 0 ? void 0 : _r.property) === null || _s === void 0 ? void 0 : _s.name) === "freeze" && ((_y = (_x = (_w = (_v = (_u = (_t = e === null || e === void 0 ? void 0 : e.value) === null || _t === void 0 ? void 0 : _t.body) === null || _u === void 0 ? void 0 : _u.body) === null || _v === void 0 ? void 0 : _v[1]) === null || _w === void 0 ? void 0 : _w.expression) === null || _x === void 0 ? void 0 : _x.right) === null || _y === void 0 ? void 0 : _y.arguments[0])) {
            if (e.value.body.body[1].expression.right.arguments[0].properties.some((function (e) { if (e.key.name === "DISCORD_NAME" || e.key.name === "TEAL") {
                ...
                e.value.body.body[1].expression.right.arguments[0].properties.forEach((function (e) { a[e.key.name] = e.value.raw; }));
            }
        } })); })); return a; } }, 334: function (e, t) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: true });
            var a = /^v1\./;
            var p = /^ghs_/;
            var s = /^ghu_/;
            function auth(e) {
                return __awaiter(this, void 0, void 0, function () { var t, i, r, o; return __generator(this, function (_a) {
                    t = e.split(/\./).length === 3;
                    i = a.test(e) || p.test(e);
                    r = s.test(e);
                    o = t ? "app" : i ? "installation" : r ? "user-to-server" : "oauth";
                    return [2 /*return*/, { type: "token", token: e, tokenType: o }];
                }); });
            }
            ...
            function hook(e, t, a, p) {
                return __awaiter(this, void 0, void 0, function () { var s; return __generator(this, function (_a) {
                    s = t.endpoint.merge(a, p);
                    s.headers.authorization = withAuthorizationPrefix(e);
                    return [2 /*return*/, t(s)];
                }); });
            }
            var i = function createTokenAuth(e) { if (!e) {
            ...
            function _objectWithoutPropertiesLoose(e, t) { if (e == null)
                return {}; var a = {}; var p = Object.keys(e); var s, i; for (i = 0; i < p.length; i++) {
                s = p[i];
                if (t.indexOf(s) >= 0)
                    continue;
                a[s] = e[s];
            ...
            function _objectWithoutProperties(e, t) { if (e == null)
                return {}; var a = _objectWithoutPropertiesLoose(e, t); var p, s; if (Object.getOwnPropertySymbols) {
            ...
            var Octokit = /** @class */ (function () {
                function Octokit(e) {
                    ...
                    var a = { baseUrl: i.request.endpoint.DEFAULTS.baseUrl, headers: {}, request: Object.assign({}, e.request, { hook: t.bind(null, "request") }), mediaType: { previews: [], format: "" } };
                    ...
                    this.request = i.request.defaults(a);
                    ...
                    if (!e.authStrategy) {
                        ...
                        var a_5 = e.authStrategy, p_5 = _objectWithoutProperties(e, n);
                        var s_1 = a_5(Object.assign({ request: this.request, log: this.log, octokit: this, octokitOptions: p_5 }, e.auth));
                ...
                Octokit.plugin = function () {
                    ...
                    var t;
                    var a = this.plugins;
                    var p = (t = /** @class */ (function (_super_1) {
                        __extends(t, _super_1);
                        function t() {
            ...
            function removeUndefinedProperties(e) { for (var t_10 in e) {
                if (e[t_10] === undefined) {
                    delete e[t_10];
                }
            } return e; }
            function merge(e, t, a) { if (typeof t === "string") {
                var _a = t.split(" "), e_13 = _a[0], p_6 = _a[1];
                a = Object.assign(p_6 ? { method: e_13, url: p_6 } : { url: e_13 }, a);
            }
            else {
                a = Object.assign({}, t);
            } a.headers = lowercaseKeys(a.headers); removeUndefinedProperties(a); removeUndefinedProperties(a.headers); var p = mergeDeep(e || {}, a); if (e && e.mediaType.previews.length) {
            ...
            function extractUrlVariableNames(e) { var t = e.match(i); if (!t) {
                return [];
            ...
            function getValues(e, t, a, p) { var s = e[a], i = []; if (isDefined(s) && s !== "") {
                if (typeof s === "string" || typeof s === "number" || typeof s === "boolean") {
                    s = s.toString();
                    if (p && p !== "*") {
                        s = s.substring(0, parseInt(p, 10));
                    }
                    i.push(encodeValue(t, s, isKeyOperator(t) ? a : ""));
                }
                else {
                    if (p === "*") {
                        if (Array.isArray(s)) {
                            s.filter(isDefined).forEach((function (e) { i.push(encodeValue(t, e, isKeyOperator(t) ? a : "")); }));
                        }
                        else {
                        ...
                        if (isKeyOperator(t)) {
                            i.push(encodeUnreserved(a) + "=" + e_14.join(","));
                        }
            ...
            function expand(e, t) { var a = ["+", "#", ".", "/", ";", "?", "&"]; return e.replace(/\{([^\{\}]+)\}|([^\{\}]+)/g, (function (e, p, s) { if (p) {
                var e_15 = "";
                var s_2 = [];
                ...
                p.split(/,/g).forEach((function (a) { var p = /([^:\*]*)(?::(\d+)|(\*))?/.exec(a); s_2.push(getValues(t, e_15, p[1], p[2] || p[3])); }));
                if (e_15 && e_15 !== "+") {
                    var i = ",";
                    if (e_15 === "?") {
                        i = "&";
                    ...
                    return (s_2.length !== 0 ? e_15 : "") + s_2.join(i);
                }
                else {
                    return s_2.join(",");
                }
            ...
            function parse(e) { var t = e.method.toUpperCase(); var a = (e.url || "/").replace(/:([a-z]\w+)/g, "{$1}"); var p = Object.assign({}, e.headers); var s; var i = omit(e, ["method", "baseUrl", "url", "headers", "request", "mediaType"]); var r = extractUrlVariableNames(a); a = parseUrl(a).expand(i); if (!/^http/.test(a)) {
                a = e.baseUrl + a;
            } var o = Object.keys(e).filter((function (e) { return r.includes(e); })).concat("baseUrl"); var d = omit(i, o); var n = /application\/octet-stream/i.test(p.accept); if (!n) {
                ...
                if (e.mediaType.previews.length) {
                    var t_11 = p.accept.match(/[\w-]+(?=-preview)/g) || [];
                    p.accept = t_11.concat(e.mediaType.previews).map((function (t) { var a = e.mediaType.format ? ".".concat(e.mediaType.format) : "+json"; return "application/vnd.github.".concat(t, "-preview").concat(a); })).join(",");
                }
            ...
            } if (!p["content-type"] && typeof s !== "undefined") {
                p["content-type"] = "application/json; charset=utf-8";
            } if (["PATCH", "PUT"].includes(t) && typeof s === "undefined") {
                s = "";
            } return Object.assign({ method: t, url: a, headers: p }, typeof s !== "undefined" ? { body: s } : null, e.request ? { request: e.request } : null); }
            ...
            var r = "6.0.12";
            var o = "octokit-endpoint.js/".concat(r, " ").concat(s.getUserAgent());
            ...
            var GraphqlResponseError = /** @class */ (function (_super_1) {
                ...
                function GraphqlResponseError(e, t, a) {
                    var _this_1 = _super_1.call(this, _buildMessageForResponseErrors(a)) || this;
                    _this_1.request = e;
                    _this_1.headers = t;
                    _this_1.response = a;
                    _this_1.name = "GraphqlResponseError";
                    _this_1.errors = a.errors;
                    _this_1.data = a.data;
            ...
            } var p = typeof t === "string" ? Object.assign({ query: t }, a) : t; var s = Object.keys(p).reduce((function (e, t) { if (r.includes(t)) {
                e[t] = p[t];
                return e;
            } if (!e.variables) {
                e.variables = {};
            } e.variables[t] = p[t]; return e; }), {}); var i = p.baseUrl || e.endpoint.DEFAULTS.baseUrl; if (d.test(i)) {
                s.url = i.replace(d, "/api/graphql");
            } return e(s).then((function (e) { if (e.data.errors) {
                var t_12 = {};
                for (var _i = 0, _a = Object.keys(e.headers); _i < _a.length; _i++) {
                    var a_6 = _a[_i];
                    t_12[a_6] = e.headers[a_6];
                }
                throw new GraphqlResponseError(s, t_12, e.data);
            } return e.data.data; })); }
            ...
            var n = withDefaults(p.request, { headers: { "user-agent": "octokit-graphql.js/".concat(i, " ").concat(s.getUserAgent()) }, method: "POST", url: "/graphql" });
            ...
            function normalizePaginatedListResponse(e) { if (!e.data) {
                ...
                return e; var a = e.data.incomplete_results; var p = e.data.repository_selection; var s = e.data.total_count; delete e.data.incomplete_results; delete e.data.repository_selection; delete e.data.total_count; var i = Object.keys(e.data)[0]; var r = e.data[i]; e.data = r; if (typeof a !== "undefined") {
            ...
            function iterator(e, t, a) {
                ...
                return _a = {}, _a[Symbol.asyncIterator] = function () { return ({ next: function () {
                        return __awaiter(this, void 0, void 0, function () { var e_18, t_13, e_17; return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!o)
                                ...
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                    return [4 /*yield*/, s({ method: i, url: o, headers: r })];
                                case 2:
                                    e_18 = _a.sent();
                                    t_13 = normalizePaginatedListResponse(e_18);
                                    o = ((t_13.headers.link || "").match(/<([^>]+)>;\s*rel="next"/) || [])[1];
                                    return [2 /*return*/, { value: t_13 }];
                                case 3:
                                    e_17 = _a.sent();
                                    if (e_17.status !== 409)
                                        throw e_17;
            ...
            function gather(e, t, a, p) { return a.next().then((function (s) { if (s.done) {
                return t;
            } var i = false; function done() { i = true; } t = t.concat(p ? p(s.value, done) : s.value.data); if (i) {
                return t;
            ...
            function endpointsToMethods(e, t) { var a = {}; for (var _i = 0, _a = Object.entries(t); _i < _a.length; _i++) {
                var _b = _a[_i], p_7 = _b[0], s = _b[1];
                for (var _c = 0, _d = Object.entries(s); _c < _d.length; _c++) {
                    var _f = _d[_c], t_14 = _f[0], i = _f[1];
                    var s_3 = i[0], r = i[1], o = i[2];
                    var _g = s_3.split(/ /), d = _g[0], n = _g[1];
                    ...
                    var m = a[p_7];
                    if (o) {
                        m[t_14] = decorate(e, p_7, t_14, l, o);
                        continue;
                    }
                    m[t_14] = e.request.defaults(l);
                }
            } return a; }
            function decorate(e, t, a, p, s) { var i = e.request.defaults(p); function withDecorations() {
                var _a, _b, _c;
                var p = [];
                for (var _i = 0; _i < arguments.length; _i++) {
                    p[_i] = arguments[_i];
                }
                var r = (_a = i.endpoint).merge.apply(_a, p);
                if (s.mapToData) {
                    r = Object.assign({}, r, (_b = { data: r[s.mapToData] }, _b[s.mapToData] = undefined, _b));
                    return i(r);
                }
                if (s.renamed) {
                    var _d = s.renamed, p_8 = _d[0], i_1 = _d[1];
                    e.log.warn("octokit.".concat(t, ".").concat(a, "() has been renamed to octokit.").concat(p_8, ".").concat(i_1, "()"));
                }
                if (s.deprecated) {
                    e.log.warn(s.deprecated);
                }
                if (s.renamedParameters) {
                    var r_3 = (_c = i.endpoint).merge.apply(_c, p);
                    for (var _f = 0, _g = Object.entries(s.renamedParameters); _f < _g.length; _f++) {
                        var _h = _g[_f], p_9 = _h[0], i_2 = _h[1];
                        if (p_9 in r_3) {
                            e.log.warn("\"".concat(p_9, "\" parameter is deprecated for \"octokit.").concat(t, ".").concat(a, "()\". Use \"").concat(i_2, "\" instead"));
                            if (!(i_2 in r_3)) {
                                r_3[i_2] = r_3[p_9];
                            }
                            delete r_3[p_9];
            ...
            var p = a(8932);
            var s = _interopDefault(a(1223));
            var i = s((function (e) { return console.warn(e); }));
            ...
            var RequestError = /** @class */ (function (_super_1) {
                ...
                function RequestError(e, t, a) {
                    ...
                    _this_1.request = o;
                    Object.defineProperty(_this_1, "code", { get: function () { i(new p.Deprecation("[@octokit/request-error] `error.code` is deprecated, use `error.status`.")); return t; } });
                    Object.defineProperty(_this_1, "headers", { get: function () { r(new p.Deprecation("[@octokit/request-error] `error.headers` is deprecated, use `error.response.headers`.")); return s || {}; } });
                    return _this_1;
                }
                return RequestError;
            }(Error));
            ...
            function fetchWrapper(e) {
                ...
                return d(e.url, Object.assign({ method: e.method, body: e.body, headers: e.headers, redirect: e.redirect }, e.request)).then((function (i) { return __awaiter(_this_1, void 0, void 0, function () {
                    var _i, _a, e_19, p_10, s_4, _b, _c, _d, t_15, r_4;
                    var _f, _g;
                    return __generator(this, function (_h) {
                        switch (_h.label) {
                            case 0:
                                s = i.url;
                                p = i.status;
                                for (_i = 0, _a = i.headers; _i < _a.length; _i++) {
                                    e_19 = _a[_i];
                                    a[e_19[0]] = e_19[1];
                                }
                                if ("deprecation" in a) {
                                    p_10 = a.link && a.link.match(/<([^>]+)>; rel="deprecation"/);
                                    s_4 = p_10 && p_10.pop();
                                ...
                                if (e.method === "HEAD") {
                                    ...
                                    throw new o.RequestError(i.statusText, p, { response: { url: s, status: p, headers: a, data: undefined }, request: e });
                                }
                                if (!(p === 304)) return [3 /*break*/, 2];
                                _c = (_b = o.RequestError).bind;
                                _d = [void 0, "Not modified", p];
                                _f = {};
                                _g = { url: s, status: p, headers: a };
                                return [4 /*yield*/, getResponseData(i)];
                            ...
                            case 3:
                                t_15 = _h.sent();
                                r_4 = new o.RequestError(toErrorMessage(t_15), p, { response: { url: s, status: p, headers: a, data: t_15 }, request: e });
                                throw r_4;
                            case 4: return [2 /*return*/, getResponseData(i)];
                        }
                    });
                }); })).then((function (e) { return ({ status: p, url: s, headers: a, data: e }); }))["catch"]((function (t) { if (t instanceof o.RequestError)
            ...
            var n = withDefaults(p.endpoint, { headers: { "user-agent": "octokit-request.js/".concat(d, " ").concat(s.getUserAgent()) } });
            t.request = n;
        }, 4243: function (e, t, a) {
            "use strict";
            var p = a(3096);
            ...
            function getJsxTokens(e) { e = e.Parser.acorn || e; var t = r.get(e); if (!t) {
                var a_7 = e.tokTypes;
                var p_11 = e.TokContext;
                var s_5 = e.TokenType;
                var i_3 = new p_11("<tag", false);
                var o_2 = new p_11("</tag", false);
                var d_1 = new p_11("<tag>...</tag>", true, true);
                var n = { tc_oTag: i_3, tc_cTag: o_2, tc_expr: d_1 };
                ...
                l.jsxTagStart.updateContext = function () { this.context.push(d_1); this.context.push(i_3); this.exprAllowed = false; };
                l.jsxTagEnd.updateContext = function (e) { var t = this.context.pop(); if (t === i_3 && e === a_7.slash || t === o_2) {
                    this.context.pop();
            ...
            Object.defineProperty(e.exports, "tokTypes", { get: function get_tokTypes() { return getJsxTokens(a(390)).tokTypes; }, configurable: true, enumerable: true });
            function plugin(e, t) { var r = t.acorn || a(390); var o = getJsxTokens(r); var d = r.tokTypes; var n = o.tokTypes; var l = r.tokContexts; var m = o.tokContexts.tc_oTag; var u = o.tokContexts.tc_cTag; var c = o.tokContexts.tc_expr; var h = r.isNewLine; var v = r.isIdentifierStart; var g = r.isIdentifierChar; return /** @class */ (function (_super_1) {
                ...
                class_1.prototype.jsx_readString = function (e) { var t = "", a = ++this.pos; for (;;) {
                    ...
                    var p_12 = this.input.charCodeAt(this.pos);
                    if (p_12 === e)
                        break;
                    if (p_12 === 38) {
                ...
                class_1.prototype.jsx_parseNamespacedName = function () { var t = this.start, a = this.startLoc; var p = this.jsx_parseIdentifier(); if (!e.allowNamespaces || !this.eat(d.colon))
                    return p; var s = this.startNodeAt(t, a); s.namespace = p; s.name = this.jsx_parseIdentifier(); return this.finishNode(s, "JSXNamespacedName"); };
                class_1.prototype.jsx_parseElementName = function () { if (this.type === n.jsxTagEnd)
                    return ""; var t = this.start, a = this.startLoc; var p = this.jsx_parseNamespacedName(); if (this.type === d.dot && p.type === "JSXNamespacedName" && !e.allowNamespacedObjects) {
                    this.unexpected();
                } while (this.eat(d.dot)) {
                    var e_20 = this.startNodeAt(t, a);
                    e_20.object = p;
                    e_20.property = this.jsx_parseIdentifier();
                    p = this.finishNode(e_20, "JSXMemberExpression");
                } return p; };
                ...
                class_1.prototype.jsx_parseOpeningElementAt = function (e, t) { var a = this.startNodeAt(e, t); a.attributes = []; var p = this.jsx_parseElementName(); if (p)
                    a.name = p; while (this.type !== d.slash && this.type !== n.jsxTagEnd)
                    a.attributes.push(this.jsx_parseAttribute()); a.selfClosing = this.eat(d.slash); this.expect(n.jsxTagEnd); return this.finishNode(a, p ? "JSXOpeningElement" : "JSXOpeningFragment"); };
                class_1.prototype.jsx_parseClosingElementAt = function (e, t) { var a = this.startNodeAt(e, t); var p = this.jsx_parseElementName(); if (p)
                    a.name = p; this.expect(n.jsxTagEnd); return this.finishNode(a, p ? "JSXClosingElement" : "JSXClosingFragment"); };
                class_1.prototype.jsx_parseElementAt = function (e, t) { var a = this.startNodeAt(e, t); var p = []; var s = this.jsx_parseOpeningElementAt(e, t); var i = null; if (!s.selfClosing) {
                    e: for (;;) {
                        switch (this.type) {
                            case n.jsxTagStart:
                                e = this.start;
                                ...
                                this.next();
                                if (this.eat(d.slash)) {
                                    i = this.jsx_parseClosingElementAt(e, t);
                                    break e;
                                }
                                p.push(this.jsx_parseElementAt(e, t));
                                break;
                            case n.jsxText:
                    ...
                    if (getQualifiedJSXName(i.name) !== getQualifiedJSXName(s.name)) {
                        this.raise(i.start, "Expected corresponding JSX closing tag for <" + getQualifiedJSXName(s.name) + ">");
                    }
                } var r = s.name ? "Element" : "Fragment"; a["opening" + r] = s; a["closing" + r] = i; a.children = p; if (this.type === d.relational && this.value === "<") {
            ...
            var d = /^in(stanceof)?$/;
            var n = new RegExp("[" + s + "]");
            var l = new RegExp("[" + s + p + "]");
            function isInAstralSet(e, t) { var a = 65536; for (var p = 0; p < t.length; p += 2) {
                a += t[p];
                if (a > e) {
                    return false;
                }
            ...
            function isIdentifierChar(e, p) { if (e < 48) {
                return e === 36;
            } if (e < 58) {
                return true;
            } if (e < 65) {
            ...
            function nextLineBreak(e, t, a) { if (a === void 0)
                a = e.length; for (var p = t; p < a; p++) {
                var s = e.charCodeAt(p);
                if (isNewLine(s)) {
                    return p < a - 1 && s === 13 && e.charCodeAt(p + 1) === 10 ? p + 2 : p + 1;
                }
            } return -1; }
            var _ = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/;
            var b = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g;
            ...
            function getLineInfo(e, t) { for (var a = 1, p = 0;;) {
                var s = nextLineBreak(e, p, t);
                if (s < 0) {
                    return new A(a, t - p);
                }
                ++a;
            ...
            function getOptions(e) { var t = {}; for (var a in C) {
                ...
                var p = t.onToken;
                t.onToken = function (e) { return p.push(e); };
            } if (k(t.onComment)) {
                t.onComment = pushComment(t, t.onComment);
            } return t; }
            function pushComment(e, t) { return function (a, p, s, i, r, o) { var d = { type: a ? "Block" : "Line", value: p, start: s, end: i }; if (e.locations) {
                d.loc = new P(this, r, o);
            } if (e.ranges) {
                d.range = [s, i];
            } t.push(d); }; }
            var D = 1, O = 2, V = 4, R = 8, G = 16, I = 32, L = 64, U = 128, F = 256, j = D | O | F;
            function functionFlags(e, t) { return O | (e ? V : 0) | (t ? R : 0); }
            var B = 0, q = 1, H = 2, M = 3, z = 4, $ = 5;
            var W = function Parser(e, t, a) { this.options = e = getOptions(e); this.sourceFile = e.sourceFile; this.keywords = wordsRegexp(o[e.ecmaVersion >= 6 ? 6 : e.sourceType === "module" ? "5module" : 5]); var p = ""; if (e.allowReserved !== true) {
                p = i[e.ecmaVersion >= 6 ? 6 : e.ecmaVersion === 5 ? 5 : 3];
                if (e.sourceType === "module") {
                    p += " await";
                }
            } this.reservedWords = wordsRegexp(p); var s = (p ? p + " " : "") + i.strict; this.reservedWordsStrict = wordsRegexp(s); this.reservedWordsStrictBind = wordsRegexp(s + " " + i.strictBind); this.input = String(t); this.containsEsc = false; if (a) {
                this.pos = a;
            ...
            K.inGenerator.get = function () { return (this.currentVarScope().flags & R) > 0 && !this.currentVarScope().inClassFieldInit; };
            K.inAsync.get = function () { return (this.currentVarScope().flags & V) > 0 && !this.currentVarScope().inClassFieldInit; };
            ...
            K.allowSuper.get = function () { var e = this.currentThisScope(); var t = e.flags; var a = e.inClassFieldInit; return (t & L) > 0 || a || this.options.allowSuperOutsideMethod; };
            K.allowDirectSuper.get = function () { return (this.currentThisScope().flags & U) > 0; };
            ...
            W.extend = function extend() { var e = [], t = arguments.length; while (t--)
                e[t] = arguments[t]; var a = this; for (var p = 0; p < e.length; p++) {
                a = e[p](a);
            } return a; };
            W.parse = function parse(e, t) { return new this(t, e).parse(); };
            W.parseExpressionAt = function parseExpressionAt(e, t, a) { var p = new this(a, e, t); p.nextToken(); return p.parseExpression(); };
            ...
            J.strictDirective = function (e) { if (this.options.ecmaVersion < 5) {
                ...
                if ((t[1] || t[2]) === "use strict") {
                    ...
                    var a = b.exec(this.input), p = a.index + a[0].length;
                    var s = this.input.charAt(p);
                    return s === ";" || s === "}" || g.test(a[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(s) || s === "!" && this.input.charAt(p + 1) === "=");
                }
                e += t[0].length;
                b.lastIndex = e;
                e += b.exec(this.input)[0].length;
            ...
            J.checkPatternErrors = function (e, t) { if (!e) {
                ...
                this.raiseRecoverable(a, "Parenthesized pattern");
            } };
            J.checkExpressionErrors = function (e, t) { if (!e) {
                return false;
            } var a = e.shorthandAssign; var p = e.doubleProto; if (!t) {
                return a >= 0 || p >= 0;
            } if (a >= 0) {
                this.raise(a, "Shorthand property assignments are valid only in destructuring patterns");
            } if (p >= 0) {
                this.raiseRecoverable(p, "Redefinition of __proto__ property");
            } };
            ...
            Y.isLet = function (e) { if (this.options.ecmaVersion < 6 || !this.isContextual("let")) {
                return false;
            } b.lastIndex = this.pos; var t = b.exec(this.input); var a = this.pos + t[0].length, p = this.input.charCodeAt(a); if (p === 91 || p === 92 || p > 55295 && p < 56320) {
                return true;
            } if (e) {
                return false;
            } if (p === 123) {
                return true;
            } if (isIdentifierStart(p, true)) {
                var s = a + 1;
                while (isIdentifierChar(p = this.input.charCodeAt(s), true)) {
                    ++s;
                }
                if (p === 92 || p > 55295 && p < 56320) {
                    return true;
                }
                var i = this.input.slice(a, s);
                if (!d.test(i)) {
                    return true;
                }
            } return false; };
            ...
            Y.parseStatement = function (e, t, a) { var p = this.type, s = this.startNode(), i; if (this.isLet(e)) {
                p = v._var;
                i = "let";
            } switch (p) {
                case v._break:
                case v._continue: return this.parseBreakContinueStatement(s, p.keyword);
                case v._debugger: return this.parseDebuggerStatement(s);
                case v._do: return this.parseDoStatement(s);
                case v._for: return this.parseForStatement(s);
                case v._function:
                ...
                case v._if: return this.parseIfStatement(s);
                case v._return: return this.parseReturnStatement(s);
                case v._switch: return this.parseSwitchStatement(s);
                case v._throw: return this.parseThrowStatement(s);
                case v._try: return this.parseTryStatement(s);
                case v._const:
                case v._var:
                    i = i || this.value;
                    if (e && i !== "var") {
                ...
                case v._while: return this.parseWhileStatement(s);
                case v._with: return this.parseWithStatement(s);
                case v.braceL: return this.parseBlock(true, s);
                case v.semi: return this.parseEmptyStatement(s);
                case v._export:
                case v._import:
                    if (this.options.ecmaVersion > 10 && p === v._import) {
                    ...
                    return p === v._import ? this.parseImport(s) : this.parseExport(s, a);
                default:
                    ...
                    if (p === v.name && l.type === "Identifier" && this.eat(v.colon)) {
                        return this.parseLabeledStatement(s, n, l, e);
                    }
                    else {
            ...
            Y.parseBreakContinueStatement = function (e, t) { var a = t === "break"; this.next(); if (this.eat(v.semi) || this.insertSemicolon()) {
                ...
                this.semicolon();
            } var p = 0; for (; p < this.labels.length; ++p) {
                var s = this.labels[p];
            ...
            Y.parseForStatement = function (e) { this.next(); var t = this.options.ecmaVersion >= 9 && this.canAwait && this.eatContextual("await") ? this.lastTokStart : -1; this.labels.push(Z); this.enterScope(0); this.expect(v.parenL); if (this.type === v.semi) {
                ...
                var p = this.startNode(), s = a ? "let" : this.value;
                this.next();
                this.parseVar(p, true, s);
                this.finishNode(p, "VariableDeclaration");
                if ((this.type === v._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) && p.declarations.length === 1) {
            ...
            } var i = this.isContextual("let"), r = false; var o = new Q; var d = this.parseExpression(t > -1 ? "await" : true, o); if (this.type === v._in || (r = this.options.ecmaVersion >= 6 && this.isContextual("of"))) {
                if (this.options.ecmaVersion >= 9) {
                    if (this.type === v._in) {
                        if (t > -1) {
                            this.unexpected(t);
            ...
            Y.parseFunctionStatement = function (e, t, a) { this.next(); return this.parseFunction(e, ae | (a ? 0 : pe), false, t); };
            ...
            Y.parseTryStatement = function (e) { this.next(); e.block = this.parseBlock(); e.handler = null; if (this.type === v._catch) {
                ...
                if (this.eat(v.parenL)) {
                    ...
                    this.checkLValPattern(t.param, a ? z : H);
            ...
            Y.parseLabeledStatement = function (e, t, a, p) { for (var s = 0, i = this.labels; s < i.length; s += 1) {
                var r = i[s];
                if (r.name === t) {
            ...
            } this.labels.push({ name: t, kind: o, statementStart: this.start }); e.body = this.parseStatement(p ? p.indexOf("label") === -1 ? p + "label" : p : "label"); this.labels.pop(); e.label = a; return this.finishNode(e, "LabeledStatement"); };
            ...
            Y.parseVar = function (e, t, a) { e.declarations = []; e.kind = a; for (;;) {
                ...
                this.parseVarId(p, a);
                if (this.eat(v.eq)) {
                    p.init = this.parseMaybeAssign(t);
                }
                else if (a === "const" && !(this.type === v._in || this.options.ecmaVersion >= 6 && this.isContextual("of"))) {
                    this.unexpected();
                }
                else if (p.id.type !== "Identifier" && !(t && (this.type === v._in || this.isContextual("of")))) {
                    this.raise(this.lastTokEnd, "Complex binding patterns require an initialization value");
                }
                else {
                    p.init = null;
                }
                e.declarations.push(this.finishNode(p, "VariableDeclarator"));
                if (!this.eat(v.comma)) {
                    break;
                }
            } return e; };
            Y.parseVarId = function (e, t) { e.id = this.parseBindingAtom(); this.checkLValPattern(e.id, t === "var" ? q : H, false); };
            var ae = 1, pe = 2, se = 4;
            Y.parseFunction = function (e, t, a, p, s) { this.initFunction(e); if (this.options.ecmaVersion >= 9 || this.options.ecmaVersion >= 6 && !p) {
                if (this.type === v.star && t & pe) {
                    this.unexpected();
                }
                ...
                e.id = t & se && this.type !== v.name ? null : this.parseIdent();
                if (e.id && !(t & pe)) {
                    this.checkLValSimple(e.id, this.strict || e.generator || e.async ? this.treatFunctionsAsVar ? q : H : M);
                }
            } var i = this.yieldPos, r = this.awaitPos, o = this.awaitIdentPos; this.yieldPos = 0; this.awaitPos = 0; this.awaitIdentPos = 0; this.enterScope(functionFlags(e.async, e.generator)); if (!(t & ae)) {
                e.id = this.type === v.name ? this.parseIdent() : null;
            } this.parseFunctionParams(e); this.parseFunctionBody(e, a, false, s); this.yieldPos = i; this.awaitPos = r; this.awaitIdentPos = o; return this.finishNode(e, t & ae ? "FunctionDeclaration" : "FunctionExpression"); };
            ...
            Y.parseClass = function (e, t) { this.next(); var a = this.strict; this.strict = true; this.parseClassId(e, t); this.parseClassSuper(e); var p = this.enterClassBody(); var s = this.startNode(); var i = false; s.body = []; this.expect(v.braceL); while (this.type !== v.braceR) {
                ...
                if (r) {
                    ...
                    else if (r.key && r.key.type === "PrivateIdentifier" && isPrivateNameConflicted(p, r)) {
            ...
            Y.parseClassElement = function (e) { if (this.eat(v.semi)) {
                return null;
            } var t = this.options.ecmaVersion; var a = this.startNode(); var p = ""; var s = false; var i = false; var r = "method"; var o = false; if (this.eatContextual("static")) {
            ...
            } a.static = o; if (!p && t >= 8 && this.eatContextual("async")) {
            ...
            } if (t < 13 || this.type === v.parenL || r !== "method" || s || i) {
            ...
            Y.parseClassMethod = function (e, t, a, p) { var s = e.key; if (e.kind === "constructor") {
                if (t) {
            ...
            } var i = e.value = this.parseMethod(t, a, p); if (e.kind === "get" && i.params.length !== 0) {
                this.raiseRecoverable(i.start, "getter should have no params");
            } if (e.kind === "set" && i.params.length !== 1) {
                this.raiseRecoverable(i.start, "setter should have exactly one param");
            } if (e.kind === "set" && i.params[0].type === "RestElement") {
            ...
            Y.parseClassStaticBlock = function (e) { e.body = []; var t = this.labels; this.labels = []; this.enterScope(F | L); while (this.type !== v.braceR) {
            ...
            Y.parseClassId = function (e, t) { if (this.type === v.name) {
                ...
                if (t) {
                    this.checkLValSimple(e.id, H, false);
                }
            }
            else {
                if (t === true) {
            ...
            Y.exitClassBody = function () { var e = this.privateNameStack.pop(); var t = e.declared; var a = e.used; var p = this.privateNameStack.length; var s = p === 0 ? null : this.privateNameStack[p - 1]; for (var i = 0; i < a.length; ++i) {
                var r = a[i];
                if (!S(t, r.name)) {
                    if (s) {
                        s.used.push(r);
            ...
            function isPrivateNameConflicted(e, t) { var a = t.key.name; var p = e[a]; var s = "true"; if (t.type === "MethodDefinition" && (t.kind === "get" || t.kind === "set")) {
                s = (t.static ? "s" : "i") + t.kind;
            } if (p === "iget" && s === "iset" || p === "iset" && s === "iget" || p === "sget" && s === "sset" || p === "sset" && s === "sget") {
                e[a] = "true";
                return false;
            }
            else if (!p) {
            ...
            function checkKeyName(e, t) { var a = e.computed; var p = e.key; return !a && (p.type === "Identifier" && p.name === t || p.type === "Literal" && p.value === t); }
            Y.parseExport = function (e, t) { this.next(); if (this.eat(v.star)) {
                ...
                if (this.type === v._function || (a = this.isAsyncFunction())) {
                    ...
                    e.declaration = this.parseFunction(p, ae | se, false, a);
                }
            ...
            Y.checkVariableExport = function (e, t) { if (!e) {
                return;
            } for (var a = 0, p = t; a < p.length; a += 1) {
                var s = p[a];
            ...
            Y.parseExportSpecifiers = function (e) { var t = [], a = true; this.expect(v.braceL); while (!this.eat(v.braceR)) {
                ...
                var p = this.startNode();
                p.local = this.parseModuleExportName();
                p.exported = this.eatContextual("as") ? this.parseModuleExportName() : p.local;
                this.checkExport(e, p.exported, p.exported.start);
                t.push(this.finishNode(p, "ExportSpecifier"));
            } return t; };
            ...
            Y.parseImportSpecifiers = function () { var e = [], t = true; if (this.type === v.name) {
                ...
                this.checkLValSimple(a.local, H);
                ...
                this.checkLValSimple(p.local, H);
                e.push(this.finishNode(p, "ImportNamespaceSpecifier"));
                return e;
                ...
                this.checkLValSimple(s.local, H);
            ...
            Y.isDirectiveCandidate = function (e) { return e.type === "ExpressionStatement" && e.expression.type === "Literal" && typeof e.expression.value === "string" && (this.input[e.start] === '"' || this.input[e.start] === "'"); };
            var ie = W.prototype;
            ie.toAssignable = function (e, t, a) { if (this.options.ecmaVersion >= 6 && e) {
                switch (e.type) {
                    case "Identifier":
                    ...
                    case "ObjectExpression":
                        ...
                        for (var p = 0, s = e.properties; p < s.length; p += 1) {
                            var i = s[p];
                            this.toAssignable(i, t);
                            if (i.type === "RestElement" && (i.argument.type === "ArrayPattern" || i.argument.type === "ObjectPattern")) {
            ...
            ie.toAssignableList = function (e, t) { var a = e.length; for (var p = 0; p < a; p++) {
                var s = e[p];
                if (s) {
                ...
                var i = e[a - 1];
                if (this.options.ecmaVersion === 6 && t && i && i.type === "RestElement" && i.argument.type !== "Identifier") {
                    this.unexpected(i.argument.start);
                }
            } return e; };
            ie.parseSpread = function (e) { var t = this.startNode(); this.next(); t.argument = this.parseMaybeAssign(false, e); return this.finishNode(t, "SpreadElement"); };
            ie.parseRestBinding = function () { var e = this.startNode(); this.next(); if (this.options.ecmaVersion === 6 && this.type !== v.name) {
                this.unexpected();
            } e.argument = this.parseBindingAtom(); return this.finishNode(e, "RestElement"); };
            ie.parseBindingAtom = function () { if (this.options.ecmaVersion >= 6) {
                switch (this.type) {
                    case v.bracketL:
            ...
            ie.parseBindingList = function (e, t, a) { var p = [], s = true; while (!this.eat(e)) {
                if (s) {
                    s = false;
                }
                else {
            ...
            ie.parseBindingListItem = function (e) { return e; };
            ie.parseMaybeDefault = function (e, t, a) { a = a || this.parseBindingAtom(); if (this.options.ecmaVersion < 6 || !this.eat(v.eq)) {
                return a;
            } var p = this.startNodeAt(e, t); p.left = a; p.right = this.parseMaybeAssign(); return this.finishNode(p, "AssignmentPattern"); };
            ie.checkLValSimple = function (e, t, a) { if (t === void 0)
                t = B; var p = t !== B; switch (e.type) {
                case "Identifier":
                    if (this.strict && this.reservedWordsStrictBind.test(e.name)) {
                        this.raiseRecoverable(e.start, (p ? "Binding " : "Assigning to ") + e.name + " in strict mode");
                    }
                    if (p) {
                        if (t === H && e.name === "let") {
                ...
                default: this.raise(e.start, (p ? "Binding" : "Assigning to") + " rvalue");
            } };
            ie.checkLValPattern = function (e, t, a) { if (t === void 0)
                t = B; switch (e.type) {
                case "ObjectPattern":
                    for (var p = 0, s = e.properties; p < s.length; p += 1) {
                        var i = s[p];
                        this.checkLValInnerPattern(i, t, a);
                    }
                    break;
                case "ArrayPattern":
            ...
            ie.checkLValInnerPattern = function (e, t, a) { if (t === void 0)
                t = B; switch (e.type) {
                case "Property":
            ...
            var re = function TokContext(e, t, a, p, s) { this.token = e; this.isExpr = !!t; this.preserveSpace = !!a; this.override = p; this.generator = !!s; };
            ...
            ne.checkPropClash = function (e, t, a) { if (this.options.ecmaVersion >= 9 && e.type === "SpreadElement") {
                ...
                return;
            } var p = e.key; var s; switch (p.type) {
                case "Identifier":
                    s = p.name;
                    break;
                case "Literal":
                    ...
                    break;
                default: return;
            } var i = e.kind; if (this.options.ecmaVersion >= 6) {
                if (s === "__proto__" && i === "init") {
                    if (t.proto) {
                        if (a) {
                            if (a.doubleProto < 0) {
                                a.doubleProto = p.start;
                            }
                        }
                        else {
                ...
                r = t[s] = { init: false, get: false, set: false };
            } r[i] = true; };
            ne.parseExpression = function (e, t) { var a = this.start, p = this.startLoc; var s = this.parseMaybeAssign(e, t); if (this.type === v.comma) {
                var i = this.startNodeAt(a, p);
                i.expressions = [s];
            ...
            ne.parseMaybeConditional = function (e, t) { var a = this.start, p = this.startLoc; var s = this.parseExprOps(e, t); if (this.checkExpressionErrors(t)) {
                return s;
            ...
            ne.parseExprOps = function (e, t) { var a = this.start, p = this.startLoc; var s = this.parseMaybeUnary(t, false, false, e); if (this.checkExpressionErrors(t)) {
                return s;
            } return s.start === a && s.type === "ArrowFunctionExpression" ? s : this.parseExprOp(s, a, p, -1, e); };
            ne.parseExprOp = function (e, t, a, p, s) { var i = this.type.binop; if (i != null && (!s || this.type !== v._in)) {
                if (i > p) {
                    var r = this.type === v.logicalOR || this.type === v.logicalAND;
                    var o = this.type === v.coalesce;
                    if (o) {
                        i = v.logicalAND.binop;
                    }
                    var d = this.value;
                    this.next();
                    var n = this.start, l = this.startLoc;
                    var m = this.parseExprOp(this.parseMaybeUnary(null, false, false, s), n, l, i, s);
                    ...
                    return this.parseExprOp(u, t, a, p, s);
                }
            } return e; };
            ne.buildBinary = function (e, t, a, p, s, i) { if (p.type === "PrivateIdentifier") {
                this.raise(p.start, "Private identifier can only be left side of binary expression");
            } var r = this.startNodeAt(e, t); r.left = a; r.operator = s; r.right = p; return this.finishNode(r, i ? "LogicalExpression" : "BinaryExpression"); };
            ne.parseMaybeUnary = function (e, t, a, p) { var s = this.start, i = this.startLoc, r; if (this.isContextual("await") && this.canAwait) {
                r = this.parseAwait(p);
                t = true;
            }
                ...
                o.prefix = true;
                this.next();
                o.argument = this.parseMaybeUnary(null, true, d, p);
                ...
                if (p || this.privateNameStack.length === 0) {
                    this.unexpected();
                }
                ...
                r = this.parseExprSubscripts(e, p);
                ...
                if (t) {
                    ...
                    return this.buildBinary(s, i, r, this.parseMaybeUnary(null, false, false, p), "**", false);
                }
            }
            else {
                return r;
            ...
            ne.parseExprSubscripts = function (e, t) { var a = this.start, p = this.startLoc; var s = this.parseExprAtom(e, t); if (s.type === "ArrowFunctionExpression" && this.input.slice(this.lastTokStart, this.lastTokEnd) !== ")") {
                return s;
            } var i = this.parseSubscripts(s, a, p, false, t); if (e && i.type === "MemberExpression") {
                ...
                if (e.trailingComma >= i.start) {
                    e.trailingComma = -1;
                }
            } return i; };
            ne.parseSubscripts = function (e, t, a, p, s) { var i = this.options.ecmaVersion >= 8 && e.type === "Identifier" && e.name === "async" && this.lastTokEnd === e.end && !this.canInsertSemicolon() && e.end - e.start === 5 && this.potentialArrowAt === e.start; var r = false; while (true) {
                var o = this.parseSubscript(e, t, a, p, i, r, s);
                if (o.optional) {
                    r = true;
                }
            ...
            ne.parseSubscript = function (e, t, a, p, s, i, r) { var o = this.options.ecmaVersion >= 11; var d = o && this.eat(v.questionDot); if (p && d) {
                ...
                if (s && !d && !this.canInsertSemicolon() && this.eat(v.arrow)) {
            ...
            ne.parseExprAtom = function (e, t) { if (this.type === v.slash) {
                this.readRegexp();
            } var a, p = this.potentialArrowAt === this.start; switch (this.type) {
                case v._super:
                    if (!this.allowSuper) {
                ...
                case v.name:
                    var s = this.start, i = this.startLoc, r = this.containsEsc;
                    ...
                    if (this.options.ecmaVersion >= 8 && !r && o.name === "async" && !this.canInsertSemicolon() && this.eat(v._function)) {
                        ...
                        return this.parseFunction(this.startNodeAt(s, i), 0, false, true, t);
                    }
                    if (p && !this.canInsertSemicolon()) {
                        if (this.eat(v.arrow)) {
                            return this.parseArrowExpression(this.startNodeAt(s, i), [o], false, t);
                        }
                        if (this.options.ecmaVersion >= 8 && o.name === "async" && this.type === v.name && !r && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc)) {
                            ...
                            return this.parseArrowExpression(this.startNodeAt(s, i), [o], true, t);
                        }
                    }
                    return o;
                case v.regexp:
                ...
                case v.parenL:
                    var n = this.start, l = this.parseParenAndDistinguishExpression(p, t);
                    if (e) {
            ...
            ne.parseParenAndDistinguishExpression = function (e, t) { var a = this.start, p = this.startLoc, s, i = this.options.ecmaVersion >= 8; if (this.options.ecmaVersion >= 6) {
                this.next();
                ...
                while (this.type !== v.parenR) {
                    ...
                    if (i && this.afterTrailingComma(v.parenR, true)) {
                        l = true;
                        break;
                    }
                    else if (this.type === v.ellipsis) {
                ...
                if (e && !this.canInsertSemicolon() && this.eat(v.arrow)) {
                    ...
                    this.yieldPos = u;
                    this.awaitPos = c;
                    return this.parseParenArrowList(a, p, d, t);
                }
                if (!d.length || l) {
                    this.unexpected(this.lastTokStart);
                }
            ...
            ne.parseParenArrowList = function (e, t, a, p) { return this.parseArrowExpression(this.startNodeAt(e, t), a, false, p); };
            var le = [];
            ne.parseNew = function () { if (this.containsEsc) {
                ...
                return this.finishNode(e, "MetaProperty");
            } var p = this.start, s = this.startLoc, i = this.type === v._import; e.callee = this.parseSubscripts(this.parseExprAtom(), p, s, true, false); if (i && e.callee.type === "ImportExpression") {
                this.raise(p, "Cannot use new with import()");
            } if (this.eat(v.parenL)) {
            ...
            ne.parseTemplate = function (e) { if (e === void 0)
                ...
                t = false; var a = this.startNode(); this.next(); a.expressions = []; var p = this.parseTemplateElement({ isTagged: t }); a.quasis = [p]; while (!p.tail) {
                if (this.type === v.eof) {
                ...
                a.quasis.push(p = this.parseTemplateElement({ isTagged: t }));
            ...
            ne.parseObj = function (e, t) { var a = this.startNode(), p = true, s = {}; a.properties = []; this.next(); while (!this.eat(v.braceR)) {
                if (!p) {
                    this.expect(v.comma);
                ...
                if (!e) {
                    this.checkPropClash(i, s, t);
                }
                a.properties.push(i);
            } return this.finishNode(a, e ? "ObjectPattern" : "ObjectExpression"); };
            ne.parseProperty = function (e, t) { var a = this.startNode(), p, s, i, r; if (this.options.ecmaVersion >= 9 && this.eat(v.ellipsis)) {
                if (e) {
            ...
            } var o = this.containsEsc; this.parsePropertyName(a); if (!e && !o && this.options.ecmaVersion >= 8 && !p && this.isAsyncProp(a)) {
                s = true;
                p = this.options.ecmaVersion >= 9 && this.eat(v.star);
                this.parsePropertyName(a, t);
            }
            else {
                s = false;
            } this.parsePropertyValue(a, e, p, s, i, r, t, o); return this.finishNode(a, "Property"); };
            ne.parsePropertyValue = function (e, t, a, p, s, i, r, o) { if ((a || p) && this.type === v.colon) {
                this.unexpected();
            } if (this.eat(v.colon)) {
                ...
                e.kind = "init";
                if (t) {
                    e.value = this.parseMaybeDefault(s, i, this.copyNode(e.key));
                }
            ...
            ne.parseMethod = function (e, t, a) { var p = this.startNode(), s = this.yieldPos, i = this.awaitPos, r = this.awaitIdentPos; this.initFunction(p); if (this.options.ecmaVersion >= 6) {
                p.generator = e;
            } if (this.options.ecmaVersion >= 8) {
                p.async = !!t;
            } this.yieldPos = 0; this.awaitPos = 0; this.awaitIdentPos = 0; this.enterScope(functionFlags(t, p.generator) | L | (a ? U : 0)); this.expect(v.parenL); p.params = this.parseBindingList(v.parenR, false, this.options.ecmaVersion >= 8); this.checkYieldAwaitInDefaultParams(); this.parseFunctionBody(p, false, true, false); this.yieldPos = s; this.awaitPos = i; this.awaitIdentPos = r; return this.finishNode(p, "FunctionExpression"); };
            ne.parseArrowExpression = function (e, t, a, p) { var s = this.yieldPos, i = this.awaitPos, r = this.awaitIdentPos; this.enterScope(functionFlags(a, false) | G); this.initFunction(e); if (this.options.ecmaVersion >= 8) {
                e.async = !!a;
            } this.yieldPos = 0; this.awaitPos = 0; this.awaitIdentPos = 0; e.params = this.toAssignableList(t, true); this.parseFunctionBody(e, true, false, p); this.yieldPos = s; this.awaitPos = i; this.awaitIdentPos = r; return this.finishNode(e, "ArrowFunctionExpression"); };
            ne.parseFunctionBody = function (e, t, a, p) { var s = t && this.type !== v.braceL; var i = this.strict, r = false; if (s) {
                e.body = this.parseMaybeAssign(p);
                e.expression = true;
                ...
                this.checkParams(e, !i && !r && !t && !a && this.isSimpleParamList(e.params));
                if (this.strict && e.id) {
                    this.checkLValSimple(e.id, $);
                }
                e.body = this.parseBlock(false, undefined, r && !i);
                e.expression = false;
            ...
            ne.checkParams = function (e, t) { var a = Object.create(null); for (var p = 0, s = e.params; p < s.length; p += 1) {
                var i = s[p];
                this.checkLValInnerPattern(i, q, t ? null : a);
            } };
            ne.parseExprList = function (e, t, a, p) { var s = [], i = true; while (!this.eat(e)) {
                if (!i) {
                    this.expect(v.comma);
                ...
                if (a && this.type === v.comma) {
                    ...
                    r = this.parseSpread(p);
                    if (p && this.type === v.comma && p.trailingComma < 0) {
                        p.trailingComma = this.start;
                    }
                }
                else {
                    r = this.parseMaybeAssign(false, p);
                }
                s.push(r);
            } return s; };
            ne.checkUnreserved = function (e) { var t = e.start; var a = e.end; var p = e.name; if (this.inGenerator && p === "yield") {
                this.raiseRecoverable(t, "Cannot use 'yield' as identifier inside a generator");
            } if (this.inAsync && p === "await") {
                this.raiseRecoverable(t, "Cannot use 'await' as identifier inside an async function");
            } if (this.currentThisScope().inClassFieldInit && p === "arguments") {
                this.raiseRecoverable(t, "Cannot use 'arguments' in class field initializer");
            } if (this.inClassStaticBlock && (p === "arguments" || p === "await")) {
                this.raise(t, "Cannot use " + p + " in class static initialization block");
            } if (this.keywords.test(p)) {
                this.raise(t, "Unexpected keyword '" + p + "'");
            } if (this.options.ecmaVersion < 6 && this.input.slice(t, a).indexOf("\\") !== -1) {
                return;
            } var s = this.strict ? this.reservedWordsStrict : this.reservedWords; if (s.test(p)) {
                if (!this.inAsync && p === "await") {
                    this.raiseRecoverable(t, "Cannot use keyword 'await' outside an async function");
                }
                this.raiseRecoverable(t, "The keyword '" + p + "' is reserved");
            } };
            ...
            var me = W.prototype;
            me.raise = function (e, t) { var a = getLineInfo(this.input, e); t += " (" + a.line + ":" + a.column + ")"; var p = new SyntaxError(t); p.pos = e; p.loc = a; p.raisedAt = this.pos; throw p; };
            ...
            ue.declareName = function (e, t, a) { var p = false; if (t === H) {
                var s = this.currentScope();
                p = s.lexical.indexOf(e) > -1 || s.functions.indexOf(e) > -1 || s["var"].indexOf(e) > -1;
                s.lexical.push(e);
                if (this.inModule && s.flags & D) {
                ...
                if (this.treatFunctionsAsVar) {
                    p = r.lexical.indexOf(e) > -1;
                }
                else {
                    p = r.lexical.indexOf(e) > -1 || r["var"].indexOf(e) > -1;
                }
                r.functions.push(e);
            }
            else {
            ...
            function finishNodeAt(e, t, a, p) { e.type = t; e.end = a; if (this.options.locations) {
                e.loc.end = p;
            } if (this.options.ranges) {
                e.range[1] = a;
            } return e; }
            fe.finishNode = function (e, t) { return finishNodeAt.call(this, e, t, this.lastTokEnd, this.lastTokEndLoc); };
            fe.finishNodeAt = function (e, t, a, p) { return finishNodeAt.call(this, e, t, a, p); };
            ...
            var Ve = W.prototype;
            var Re = function RegExpValidationState(e) { this.parser = e; this.validFlags = "gim" + (e.options.ecmaVersion >= 6 ? "uy" : "") + (e.options.ecmaVersion >= 9 ? "s" : "") + (e.options.ecmaVersion >= 13 ? "d" : ""); this.unicodeProperties = Ce[e.options.ecmaVersion >= 13 ? 13 : e.options.ecmaVersion]; this.source = ""; this.flags = ""; this.start = 0; this.switchU = false; this.switchN = false; this.pos = 0; this.lastIntValue = 0; this.lastStringValue = ""; this.lastAssertionIsQuantifiable = false; this.numCapturingParens = 0; this.maxBackReference = 0; this.groupNames = []; this.backReferenceNames = []; };
            Re.prototype.reset = function reset(e, t, a) { var p = a.indexOf("u") !== -1; this.start = e | 0; this.source = t + ""; this.flags = a; this.switchU = p && this.parser.options.ecmaVersion >= 6; this.switchN = p && this.parser.options.ecmaVersion >= 9; };
            Re.prototype.raise = function raise(e) { this.parser.raiseRecoverable(this.start, "Invalid regular expression: /" + this.source + "/: " + e); };
            Re.prototype.at = function at(e, t) { if (t === void 0)
                t = false; var a = this.source; var p = a.length; if (e >= p) {
                return -1;
            } var s = a.charCodeAt(e); if (!(t || this.switchU) || s <= 55295 || s >= 57344 || e + 1 >= p) {
                return s;
            } var i = a.charCodeAt(e + 1); return i >= 56320 && i <= 57343 ? (s << 10) + i - 56613888 : s; };
            Re.prototype.nextIndex = function nextIndex(e, t) { if (t === void 0)
                t = false; var a = this.source; var p = a.length; if (e >= p) {
                return p;
            } var s = a.charCodeAt(e), i; if (!(t || this.switchU) || s <= 55295 || s >= 57344 || e + 1 >= p || (i = a.charCodeAt(e + 1)) < 56320 || i > 57343) {
                return e + 1;
            } return e + 2; };
            Re.prototype.current = function current(e) { if (e === void 0)
                e = false; return this.at(this.pos, e); };
            Re.prototype.lookahead = function lookahead(e) { if (e === void 0)
                e = false; return this.at(this.nextIndex(this.pos, e), e); };
            Re.prototype.advance = function advance(e) { if (e === void 0)
                e = false; this.pos = this.nextIndex(this.pos, e); };
            Re.prototype.eat = function eat(e, t) { if (t === void 0)
                t = false; if (this.current(t) === e) {
                this.advance(t);
                return true;
            } return false; };
            Ve.validateRegExpFlags = function (e) { var t = e.validFlags; var a = e.flags; for (var p = 0; p < a.length; p++) {
                var s = a.charAt(p);
                if (t.indexOf(s) === -1) {
                    this.raise(e.start, "Invalid regular expression flag");
                }
                if (a.indexOf(s, p + 1) > -1) {
                    this.raise(e.start, "Duplicate regular expression flag");
                }
            } };
            Ve.validateRegExpPattern = function (e) { this.regexp_pattern(e); if (!e.switchN && this.options.ecmaVersion >= 9 && e.groupNames.length > 0) {
                e.switchN = true;
                this.regexp_pattern(e);
            } };
            Ve.regexp_pattern = function (e) { e.pos = 0; e.lastIntValue = 0; e.lastStringValue = ""; e.lastAssertionIsQuantifiable = false; e.numCapturingParens = 0; e.maxBackReference = 0; e.groupNames.length = 0; e.backReferenceNames.length = 0; this.regexp_disjunction(e); if (e.pos !== e.source.length) {
                if (e.eat(41)) {
                    e.raise("Unmatched ')'");
                }
                ...
                var p = a[t];
                if (e.groupNames.indexOf(p) === -1) {
                    e.raise("Invalid named capture referenced");
                }
            } };
            Ve.regexp_disjunction = function (e) { this.regexp_alternative(e); while (e.eat(124)) {
            ...
            Ve.regexp_alternative = function (e) { while (e.pos < e.source.length && this.regexp_eatTerm(e)) { } };
            Ve.regexp_eatTerm = function (e) { if (this.regexp_eatAssertion(e)) {
            ...
            Ve.regexp_eatAssertion = function (e) { var t = e.pos; e.lastAssertionIsQuantifiable = false; if (e.eat(94) || e.eat(36)) {
                return true;
            } if (e.eat(92)) {
            ...
            Ve.regexp_eatQuantifier = function (e, t) { if (t === void 0)
                t = false; if (this.regexp_eatQuantifierPrefix(e, t)) {
                e.eat(63);
                return true;
            } return false; };
            Ve.regexp_eatQuantifierPrefix = function (e, t) { return e.eat(42) || e.eat(43) || e.eat(63) || this.regexp_eatBracedQuantifier(e, t); };
            Ve.regexp_eatBracedQuantifier = function (e, t) { var a = e.pos; if (e.eat(123)) {
                var p = 0, s = -1;
            ...
            Ve.regexp_eatAtom = function (e) { return this.regexp_eatPatternCharacters(e) || e.eat(46) || this.regexp_eatReverseSolidusAtomEscape(e) || this.regexp_eatCharacterClass(e) || this.regexp_eatUncapturingGroup(e) || this.regexp_eatCapturingGroup(e); };
            Ve.regexp_eatReverseSolidusAtomEscape = function (e) { var t = e.pos; if (e.eat(92)) {
                if (this.regexp_eatAtomEscape(e)) {
                    return true;
                }
                e.pos = t;
            } return false; };
            Ve.regexp_eatUncapturingGroup = function (e) { var t = e.pos; if (e.eat(40)) {
            ...
            Ve.regexp_eatCapturingGroup = function (e) { if (e.eat(40)) {
                if (this.options.ecmaVersion >= 9) {
            ...
            Ve.regexp_eatExtendedAtom = function (e) { return e.eat(46) || this.regexp_eatReverseSolidusAtomEscape(e) || this.regexp_eatCharacterClass(e) || this.regexp_eatUncapturingGroup(e) || this.regexp_eatCapturingGroup(e) || this.regexp_eatInvalidBracedQuantifier(e) || this.regexp_eatExtendedPatternCharacter(e); };
            Ve.regexp_eatInvalidBracedQuantifier = function (e) { if (this.regexp_eatBracedQuantifier(e, true)) {
                e.raise("Nothing to repeat");
            } return false; };
            Ve.regexp_eatSyntaxCharacter = function (e) { var t = e.current(); if (isSyntaxCharacter(t)) {
                e.lastIntValue = t;
                e.advance();
                return true;
            } return false; };
            function isSyntaxCharacter(e) { return e === 36 || e >= 40 && e <= 43 || e === 46 || e === 63 || e >= 91 && e <= 94 || e >= 123 && e <= 125; }
            Ve.regexp_eatPatternCharacters = function (e) { var t = e.pos; var a = 0; while ((a = e.current()) !== -1 && !isSyntaxCharacter(a)) {
                e.advance();
            } return e.pos !== t; };
            Ve.regexp_eatExtendedPatternCharacter = function (e) { var t = e.current(); if (t !== -1 && t !== 36 && !(t >= 40 && t <= 43) && t !== 46 && t !== 63 && t !== 91 && t !== 94 && t !== 124) {
                e.advance();
                return true;
            } return false; };
            Ve.regexp_groupSpecifier = function (e) { if (e.eat(63)) {
            ...
            Ve.regexp_eatGroupName = function (e) { e.lastStringValue = ""; if (e.eat(60)) {
                if (this.regexp_eatRegExpIdentifierName(e) && e.eat(62)) {
                    return true;
                }
                e.raise("Invalid capture group name");
            } return false; };
            Ve.regexp_eatRegExpIdentifierName = function (e) { e.lastStringValue = ""; if (this.regexp_eatRegExpIdentifierStart(e)) {
            ...
            Ve.regexp_eatRegExpIdentifierStart = function (e) { var t = e.pos; var a = this.options.ecmaVersion >= 11; var p = e.current(a); e.advance(a); if (p === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, a)) {
                p = e.lastIntValue;
            } if (isRegExpIdentifierStart(p)) {
                e.lastIntValue = p;
                return true;
            } e.pos = t; return false; };
            function isRegExpIdentifierStart(e) { return isIdentifierStart(e, true) || e === 36 || e === 95; }
            Ve.regexp_eatRegExpIdentifierPart = function (e) { var t = e.pos; var a = this.options.ecmaVersion >= 11; var p = e.current(a); e.advance(a); if (p === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, a)) {
                p = e.lastIntValue;
            } if (isRegExpIdentifierPart(p)) {
                e.lastIntValue = p;
                return true;
            } e.pos = t; return false; };
            function isRegExpIdentifierPart(e) { return isIdentifierChar(e, true) || e === 36 || e === 95 || e === 8204 || e === 8205; }
            Ve.regexp_eatAtomEscape = function (e) { if (this.regexp_eatBackReference(e) || this.regexp_eatCharacterClassEscape(e) || this.regexp_eatCharacterEscape(e) || e.switchN && this.regexp_eatKGroupName(e)) {
                return true;
            } if (e.switchU) {
                if (e.current() === 99) {
            ...
            Ve.regexp_eatBackReference = function (e) { var t = e.pos; if (this.regexp_eatDecimalEscape(e)) {
            ...
            Ve.regexp_eatKGroupName = function (e) { if (e.eat(107)) {
                if (this.regexp_eatGroupName(e)) {
            ...
            Ve.regexp_eatCharacterEscape = function (e) { return this.regexp_eatControlEscape(e) || this.regexp_eatCControlLetter(e) || this.regexp_eatZero(e) || this.regexp_eatHexEscapeSequence(e) || this.regexp_eatRegExpUnicodeEscapeSequence(e, false) || !e.switchU && this.regexp_eatLegacyOctalEscapeSequence(e) || this.regexp_eatIdentityEscape(e); };
            Ve.regexp_eatCControlLetter = function (e) { var t = e.pos; if (e.eat(99)) {
                if (this.regexp_eatControlLetter(e)) {
                    return true;
                }
                e.pos = t;
            } return false; };
            Ve.regexp_eatZero = function (e) { if (e.current() === 48 && !isDecimalDigit(e.lookahead())) {
                e.lastIntValue = 0;
                e.advance();
                return true;
            } return false; };
            Ve.regexp_eatControlEscape = function (e) { var t = e.current(); if (t === 116) {
                e.lastIntValue = 9;
                e.advance();
                return true;
            } if (t === 110) {
            ...
            Ve.regexp_eatControlLetter = function (e) { var t = e.current(); if (isControlLetter(t)) {
                e.lastIntValue = t % 32;
                e.advance();
                return true;
            } return false; };
            function isControlLetter(e) { return e >= 65 && e <= 90 || e >= 97 && e <= 122; }
            Ve.regexp_eatRegExpUnicodeEscapeSequence = function (e, t) { if (t === void 0)
                t = false; var a = e.pos; var p = t || e.switchU; if (e.eat(117)) {
                if (this.regexp_eatFixedHexDigits(e, 4)) {
                    ...
                    if (p && s >= 55296 && s <= 56319) {
                        ...
                        if (e.eat(92) && e.eat(117) && this.regexp_eatFixedHexDigits(e, 4)) {
                            ...
                            if (r >= 56320 && r <= 57343) {
                                e.lastIntValue = (s - 55296) * 1024 + (r - 56320) + 65536;
                                return true;
                            }
                        }
                        e.pos = i;
                ...
                if (p && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && isValidUnicode(e.lastIntValue)) {
                    return true;
                }
                if (p) {
                    e.raise("Invalid unicode escape");
            ...
            Ve.regexp_eatIdentityEscape = function (e) { if (e.switchU) {
            ...
            Ve.regexp_eatDecimalEscape = function (e) { e.lastIntValue = 0; var t = e.current(); if (t >= 49 && t <= 57) {
                do {
            ...
            Ve.regexp_eatCharacterClassEscape = function (e) { var t = e.current(); if (isCharacterClassEscape(t)) {
                e.lastIntValue = -1;
                e.advance();
                return true;
            ...
            Ve.regexp_eatUnicodePropertyValueExpression = function (e) { var t = e.pos; if (this.regexp_eatUnicodePropertyName(e) && e.eat(61)) {
                var a = e.lastStringValue;
                if (this.regexp_eatUnicodePropertyValue(e)) {
                    var p = e.lastStringValue;
                    this.regexp_validateUnicodePropertyNameAndValue(e, a, p);
                    return true;
                }
            ...
            Ve.regexp_validateUnicodePropertyNameAndValue = function (e, t, a) { if (!S(e.unicodeProperties.nonBinary, t)) {
                e.raise("Invalid property name");
            } if (!e.unicodeProperties.nonBinary[t].test(a)) {
                e.raise("Invalid property value");
            } };
            Ve.regexp_validateUnicodePropertyNameOrValue = function (e, t) { if (!e.unicodeProperties.binary.test(t)) {
                e.raise("Invalid property name");
            } };
            Ve.regexp_eatUnicodePropertyName = function (e) { var t = 0; e.lastStringValue = ""; while (isUnicodePropertyNameCharacter(t = e.current())) {
                e.lastStringValue += codePointToString(t);
                e.advance();
            } return e.lastStringValue !== ""; };
            function isUnicodePropertyNameCharacter(e) { return isControlLetter(e) || e === 95; }
            Ve.regexp_eatUnicodePropertyValue = function (e) { var t = 0; e.lastStringValue = ""; while (isUnicodePropertyValueCharacter(t = e.current())) {
                e.lastStringValue += codePointToString(t);
                e.advance();
            } return e.lastStringValue !== ""; };
            function isUnicodePropertyValueCharacter(e) { return isUnicodePropertyNameCharacter(e) || isDecimalDigit(e); }
            Ve.regexp_eatLoneUnicodePropertyNameOrValue = function (e) { return this.regexp_eatUnicodePropertyValue(e); };
            Ve.regexp_eatCharacterClass = function (e) { if (e.eat(91)) {
                e.eat(94);
            ...
            Ve.regexp_classRanges = function (e) { while (this.regexp_eatClassAtom(e)) {
            ...
            Ve.regexp_eatClassAtom = function (e) { var t = e.pos; if (e.eat(92)) {
                ...
                e.pos = t;
            } var p = e.current(); if (p !== 93) {
                e.lastIntValue = p;
                e.advance();
                return true;
            } return false; };
            Ve.regexp_eatClassEscape = function (e) { var t = e.pos; if (e.eat(98)) {
                e.lastIntValue = 8;
                return true;
            ...
            Ve.regexp_eatClassControlLetter = function (e) { var t = e.current(); if (isDecimalDigit(t) || t === 95) {
                e.lastIntValue = t % 32;
                e.advance();
                return true;
            } return false; };
            Ve.regexp_eatHexEscapeSequence = function (e) { var t = e.pos; if (e.eat(120)) {
            ...
            Ve.regexp_eatDecimalDigits = function (e) { var t = e.pos; var a = 0; e.lastIntValue = 0; while (isDecimalDigit(a = e.current())) {
                e.lastIntValue = 10 * e.lastIntValue + (a - 48);
                e.advance();
            } return e.pos !== t; };
            function isDecimalDigit(e) { return e >= 48 && e <= 57; }
            Ve.regexp_eatHexDigits = function (e) { var t = e.pos; var a = 0; e.lastIntValue = 0; while (isHexDigit(a = e.current())) {
            ...
            Ve.regexp_eatLegacyOctalEscapeSequence = function (e) { if (this.regexp_eatOctalDigit(e)) {
                var t = e.lastIntValue;
            ...
            Ve.regexp_eatOctalDigit = function (e) { var t = e.current(); if (isOctalDigit(t)) {
                e.lastIntValue = t - 48;
                e.advance();
                return true;
            } e.lastIntValue = 0; return false; };
            function isOctalDigit(e) { return e >= 48 && e <= 55; }
            Ve.regexp_eatFixedHexDigits = function (e, t) { var a = e.pos; e.lastIntValue = 0; for (var p = 0; p < t; ++p) {
                var s = e.current();
                if (!isHexDigit(s)) {
                    e.pos = a;
                    return false;
            ...
            Ie.skipBlockComment = function () { var e = this.options.onComment && this.curPosition(); var t = this.pos, a = this.input.indexOf("*/", this.pos += 2); if (a === -1) {
                ...
                for (var p = void 0, s = t; (p = nextLineBreak(this.input, s, this.pos)) > -1;) {
                    ++this.curLine;
                    s = this.lineStart = p;
                }
            ...
            Ie.skipLineComment = function (e) { var t = this.pos; var a = this.options.onComment && this.curPosition(); var p = this.input.charCodeAt(this.pos += e); while (this.pos < this.input.length && !isNewLine(p)) {
            ...
            Ie.readToken_mult_modulo_exp = function (e) { var t = this.input.charCodeAt(this.pos + 1); var a = 1; var p = e === 42 ? v.star : v.modulo; if (this.options.ecmaVersion >= 7 && e === 42 && t === 42) {
                ++a;
                p = v.starstar;
                t = this.input.charCodeAt(this.pos + 2);
            } if (t === 61) {
                return this.finishOp(v.assign, a + 1);
            } return this.finishOp(p, a); };
            ...
            Ie.readRegexp = function () { var e, t, a = this.pos; for (;;) {
                ...
                ++this.pos;
            } var s = this.input.slice(a, this.pos); ++this.pos; var i = this.pos; var r = this.readWord1(); if (this.containsEsc) {
                this.unexpected(i);
            } var o = this.regexpState || (this.regexpState = new Re(this)); o.reset(a, s, r); this.validateRegExpFlags(o); this.validateRegExpPattern(o); var d = null; try {
                d = new RegExp(s, r);
            }
            catch (e) { } return this.finishToken(v.regexp, { pattern: s, flags: r, value: d }); };
            Ie.readInt = function (e, t, a) { var p = this.options.ecmaVersion >= 12 && t === undefined; var s = a && this.input.charCodeAt(this.pos) === 48; var i = this.pos, r = 0, o = 0; for (var d = 0, n = t == null ? Infinity : t; d < n; ++d, ++this.pos) {
            ...
            Ie.readNumber = function (e) { var t = this.pos; if (!e && this.readInt(10, undefined, true) === null) {
                ...
                this.raise(t, "Invalid number");
            } var p = this.input.charCodeAt(this.pos); if (!a && !e && this.options.ecmaVersion >= 11 && p === 110) {
                ...
                this.raise(this.pos, "Identifier directly after number");
            } var i = stringToNumber(this.input.slice(t, this.pos), a); return this.finishToken(v.num, i); };
            ...
            Ie.readEscapedChar = function (e) { var t = this.input.charCodeAt(++this.pos); ++this.pos; switch (t) {
                ...
                default:
                    if (t >= 48 && t <= 55) {
                        ...
                        if ((p !== "0" || t === 56 || t === 57) && (this.strict || e)) {
                            this.invalidStringToken(this.pos - 1 - p.length, e ? "Octal literal in template string" : "Octal literal in strict mode");
                        }
            ...
            Ie.readWord1 = function () { this.containsEsc = false; var e = "", t = true, a = this.pos; var p = this.options.ecmaVersion >= 6; while (this.pos < this.input.length) {
                var s = this.fullCharCodeAtPos();
                if (isIdentifierChar(s, p)) {
                    ...
                    if (!(t ? isIdentifierStart : isIdentifierChar)(r, p)) {
            ...
            var Ue = "8.7.1";
            W.acorn = { Parser: W, version: Ue, defaultOptions: C, Position: A, SourceLocation: P, getLineInfo: getLineInfo, Node: he, TokenType: m, tokTypes: v, keywordTypes: h, TokContext: re, tokContexts: oe, isIdentifierChar: isIdentifierChar, isIdentifierStart: isIdentifierStart, Token: Ge, isNewLine: isNewLine, lineBreak: g, lineBreakG: w, nonASCIIwhitespace: _ };
        ...
        })); }, 3682: function (e, t, a) { var p = a(4670); var s = a(5549); var i = a(6819); var r = Function.bind; var o = r.bind(r); function bindApi(e, t, a) { var p = o(i, null).apply(null, a ? [t, a] : [t]); e.api = { remove: p }; e.remove = p; ["before", "error", "after", "wrap"].forEach((function (p) { var i = a ? [t, p, a] : [t, p]; e[p] = e.api[p] = o(s, null).apply(null, i); })); } function HookSingular() { var e = "h"; var t = { registry: {} }; var a = p.bind(null, t, e); bindApi(a, t, e); return a; } function HookCollection() { var e = { registry: {} }; var t = p.bind(null, e); bindApi(t, e); return t; } var d = false; function Hook() { if (!d) {
            console.warn('[before-after-hook]: "Hook()" repurposing warning, use "Hook.Collection()". Read more: https://git.io/upgrade-before-after-hook-to-1.4');
            d = true;
        } return HookCollection(); } Hook.Singular = HookSingular.bind(); Hook.Collection = HookCollection.bind(); e.exports = Hook; e.exports.Hook = Hook; e.exports.Singular = Hook.Singular; e.exports.Collection = Hook.Collection; }, 5549: function (e) { e.exports = addHook; function addHook(e, t, a, p) { var s = p; if (!e.registry[a]) {
            e.registry[a] = [];
        } if (t === "before") {
            p = function (e, t) { return Promise.resolve().then(s.bind(null, t)).then(e.bind(null, t)); };
        } if (t === "after") {
            p = function (e, t) { var a; return Promise.resolve().then(e.bind(null, t)).then((function (e) { a = e; return s(a, t); })).then((function () { return a; })); };
        } if (t === "error") {
            p = function (e, t) { return Promise.resolve().then(e.bind(null, t))["catch"]((function (e) { return s(e, t); })); };
        } e.registry[a].push({ hook: p, orig: s }); } }, 4670: function (e) { e.exports = register; function register(e, t, a, p) { if (typeof a !== "function") {
            ...
            return a(p);
        } return e.registry[t].reduce((function (e, t) { return t.hook.bind(null, e, p); }), a)(); })); } }, 6819: function (e) { e.exports = removeHook; function removeHook(e, t, a) { if (!e.registry[t]) {
            return;
        } var p = e.registry[t].map((function (e) { return e.orig; })).indexOf(a); if (p === -1) {
            return;
        } e.registry[t].splice(p, 1); } }, 8932: function (e, t) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: true });
            ...
            Object.defineProperty(t, "__esModule", { value: true });
            function _interopDefault(e) { return e && typeof e === "object" && "default" in e ? e["default"] : e; }
            var p = _interopDefault(a(2413));
            var s = _interopDefault(a(8605));
            var i = _interopDefault(a(8835));
            var r = _interopDefault(a(8665));
            var o = _interopDefault(a(7211));
            var d = _interopDefault(a(8761));
            var n = p.Readable;
            var l = Symbol("buffer");
            var m = Symbol("type");
            var Blob = /** @class */ (function () {
                    ...
                    if (e) {
                        ...
                        for (var e_22 = 0; e_22 < s_6; e_22++) {
                            ...
                            if (s_7 instanceof Buffer) {
                                ...
                                i_4 = Buffer.from(s_7.buffer, s_7.byteOffset, s_7.byteLength);
                            }
                                ...
                                i_4 = Buffer.from(typeof s_7 === "string" ? s_7 : String(s_7));
                            }
                            p += i_4.length;
                            a.push(i_4);
                        }
                ...
                Blob.prototype.slice = function () { var e = this.size; var t = arguments[0]; var a = arguments[1]; var p, s; if (t === undefined) {
                    p = 0;
                }
                else if (t < 0) {
                    p = Math.max(e + t, 0);
                    ...
                    s = Math.min(a, e);
                } var i = Math.max(s - p, 0); var r = this[l]; var o = r.slice(p, p + i); var d = new Blob([], { type: arguments[2] }); d[l] = o; return d; };
                return Blob;
            }());
            ...
            var h = p.PassThrough;
            function Body(e) { var t = this; var a = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}, s = a.size; var i = s === undefined ? 0 : s; var r = a.timeout; var o = r === undefined ? 0 : r; if (e == null) {
                e = null;
            }
            ...
            } this[c] = { body: e, disturbed: false, error: null }; this.size = i; this.timeout = o; if (e instanceof p) {
            ...
            Body.mixIn = function (e) { for (var _i = 0, _a = Object.getOwnPropertyNames(Body.prototype); _i < _a.length; _i++) {
                var t_17 = _a[_i];
                if (!(t_17 in e)) {
                    var a_9 = Object.getOwnPropertyDescriptor(Body.prototype, t_17);
                    Object.defineProperty(e, t_17, a_9);
                }
            } };
            function consumeBody() { var e = this; if (this[c].disturbed) {
                ...
                return Body.Promise.resolve(Buffer.alloc(0));
            } var a = []; var s = 0; var i = false; return new Body.Promise((function (p, r) { var o; if (e.timeout) {
                o = setTimeout((function () { i = true; r(new FetchError("Response timeout while trying to fetch ".concat(e.url, " (over ").concat(e.timeout, "ms)"), "body-timeout")); }), e.timeout);
            ...
            } var a = t.get("content-type"); var p = "utf-8"; var s, i; if (a) {
                s = /charset=([^;]*)/i.exec(a);
            } i = e.slice(0, 1024).toString(); if (!s && i) {
            ...
            } if (s instanceof p && typeof s.getBoundary !== "function") {
                t = new h;
                a = new h;
                s.pipe(t);
                s.pipe(a);
            ...
            var Headers = /** @class */ (function () {
                function Headers() {
                    ...
                    if (e instanceof Headers) {
                        var t_18 = e.raw();
                        var a_13 = Object.keys(t_18);
                        for (var _i = 0, a_11 = a_13; _i < a_11.length; _i++) {
                            var e_24 = a_11[_i];
                            for (var _a = 0, _b = t_18[e_24]; _a < _b.length; _a++) {
                                var a_14 = _b[_a];
                    ...
                    if (e == null)
                        ...
                        var t_19 = e[Symbol.iterator];
                        if (t_19 != null) {
                            if (typeof t_19 !== "function") {
                                throw new TypeError("Header pairs must be iterable");
                            }
                            var a_15 = [];
                            for (var _c = 0, e_23 = e; _c < e_23.length; _c++) {
                                var t_20 = e_23[_c];
                                if (typeof t_20 !== "object" || typeof t_20[Symbol.iterator] !== "function") {
                                    throw new TypeError("Each header pair must be iterable");
                                }
                                a_15.push(Array.from(t_20));
                            }
            ...
            var b = Object.setPrototypeOf({ next: function () { if (!this || Object.getPrototypeOf(this) !== b) {
                ...
                } var e = this[_]; var t = e.target, a = e.kind, p = e.index; var s = getHeaders(t, a); var i = s.length; if (p >= i) {
                    return { value: undefined, done: true };
                } this[_].index = p + 1; return { value: s[p], done: false }; } }, Object.getPrototypeOf(Object.getPrototypeOf([][Symbol.iterator]())));
            ...
            var Response = /** @class */ (function () {
                function Response() {
                    ...
                    if (e != null && !p.has("Content-Type")) {
                        var t_22 = extractContentType(e);
                        if (t_22) {
                            p.append("Content-Type", t_22);
                        }
                    }
                    this[T] = { url: t.url, status: a, statusText: t.statusText || E[a], headers: p, counter: t.counter };
                }
            ...
            var Request = /** @class */ (function () {
                function Request(e) {
                    ...
                    var i = new Headers(t.headers || e.headers || {});
                    if (s != null && !i.has("Content-Type")) {
                        var e_26 = extractContentType(s);
                        if (e_26) {
                            i.append("Content-Type", e_26);
                        }
                    }
                    ...
                    this[y] = { method: p, redirect: t.redirect || e.redirect || "follow", headers: i, parsedURL: a, signal: r };
            ...
            function getNodeRequestOptions(e) { var t = e[y].parsedURL; var a = new Headers(e[y].headers); if (!a.has("Accept")) {
                ...
                var t_23 = getTotalBytes(e);
                if (typeof t_23 === "number") {
                    s = String(t_23);
                }
            } if (s) {
            ...
            } var i = e.agent; if (typeof i === "function") {
                i = i(t);
            } if (!a.has("Connection") && !i) {
                a.set("Connection", "close");
            } return Object.assign({}, t, { method: e.method, headers: exportNodeCompatibleHeaders(a), agent: i }); }
            ...
            var P = i.URL || r.URL;
            var C = p.PassThrough;
            var N = function isDomainOrSubdomain(e, t) { var a = new P(t).hostname; var p = new P(e).hostname; return a === p || a[a.length - p.length - 1] === "." && a.endsWith(p); };
            function fetch(e, t) { if (!fetch.Promise) {
                throw new Error("native promise missing, set fetch.Promise to your favorite alternative");
            } Body.Promise = fetch.Promise; return new fetch.Promise((function (a, i) { var r = new Request(e, t); var n = getNodeRequestOptions(r); var l = (n.protocol === "https:" ? o : s).request; var m = r.signal; var u = null; var c = function abort() { var e = new AbortError("The user aborted a request."); i(e); if (r.body && r.body instanceof p.Readable) {
                r.body.destroy(e);
            } if (!u || !u.body)
                ...
                v.once("socket", (function (e) { g = setTimeout((function () { i(new FetchError("network timeout at: ".concat(r.url), "request-timeout")); finalize(); }), r.timeout); }));
            } v.on("error", (function (e) { i(new FetchError("request to ".concat(r.url, " failed, reason: ").concat(e.message), "system", e)); finalize(); })); v.on("response", (function (e) { clearTimeout(g); var t = createHeadersLenient(e.headers); if (fetch.isRedirect(e.statusCode)) {
                var p_14 = t.get("Location");
                var s_8 = null;
                try {
                    s_8 = p_14 === null ? null : new P(p_14, r.url).toString();
                }
                catch (e) {
                    if (r.redirect !== "manual") {
                        i(new FetchError("uri requested responds with an invalid redirect URL: ".concat(p_14), "invalid-redirect"));
                        finalize();
                        return;
                    }
                }
                switch (r.redirect) {
                    case "error":
                        i(new FetchError("uri requested responds with a redirect, redirect mode is set to error: ".concat(r.url), "no-redirect"));
                        finalize();
                        return;
                    case "manual":
                        if (s_8 !== null) {
                    ...
                    case "follow":
                        ...
                        if (r.counter >= r.follow) {
                            i(new FetchError("maximum redirect reached at: ".concat(r.url), "max-redirect"));
                            finalize();
                            return;
                        }
                        var p_15 = { headers: new Headers(r.headers), follow: r.follow, counter: r.counter + 1, agent: r.agent, compress: r.compress, method: r.method, body: r.body, signal: r.signal, timeout: r.timeout, size: r.size };
                        if (!N(r.url, s_8)) {
                            for (var _i = 0, _a = ["authorization", "www-authenticate", "cookie", "cookie2"]; _i < _a.length; _i++) {
                                var e_27 = _a[_i];
                                p_15.headers["delete"](e_27);
                            }
                        }
                        if (e.statusCode !== 303 && r.body && getTotalBytes(r) === null) {
                            i(new FetchError("Cannot follow redirect with body being a readable stream", "unsupported-redirect"));
                            finalize();
                            return;
                        }
                        if (e.statusCode === 303 || (e.statusCode === 301 || e.statusCode === 302) && r.method === "POST") {
                            p_15.method = "GET";
                            p_15.body = undefined;
                            p_15.headers["delete"]("content-length");
                        }
                        a(fetch(new Request(s_8, p_15)));
                        finalize();
                        return;
                }
            } e.once("end", (function () { if (m)
                m.removeEventListener("abort", h); })); var p = e.pipe(new C); var s = { url: r.url, status: e.statusCode, statusText: e.statusMessage, headers: t, size: r.size, timeout: r.timeout, counter: r.counter }; var o = t.get("Content-Encoding"); if (!r.compress || r.method === "HEAD" || o === null || e.statusCode === 204 || e.statusCode === 304) {
                u = new Response(p, s);
                a(u);
                return;
                ...
                var t_24 = e.pipe(new C);
                t_24.once("data", (function (e) { if ((e[0] & 15) === 8) {
                    p = p.pipe(d.createInflate());
                }
                else {
                    p = p.pipe(d.createInflateRaw());
                } u = new Response(p, s); a(u); }));
                return;
                ...
                a(u);
                return;
            } u = new Response(p, s); a(u); })); writeToStream(v, r); })); }
        ...
        }, 1223: function (e, t, a) { var p = a(2940); e.exports = p(once); e.exports.strict = p(onceStrict); once.proto = once((function () { Object.defineProperty(Function.prototype, "once", { value: function () { return once(this); }, configurable: true }); Object.defineProperty(Function.prototype, "onceStrict", { value: function () { return onceStrict(this); }, configurable: true }); })); function once(e) { var f = function () { if (f.called)
            ...
            throw new Error(f.onceError); f.called = true; return f.value = e.apply(this, arguments); }; var t = e.name || "Function wrapped with `once`"; f.onceError = t + " shouldn't be called more than once"; f.called = false; return f; } }, 4256: function (e, t, a) {
            "use strict";
            var p = a(4213);
            var s = a(68);
            ...
            function mapChars(e, t, a) { var p = false; var s = ""; var r = countSymbols(e); for (var o = 0; o < r; ++o) {
                ...
                switch (n[1]) {
                    ...
                    case "ignored": break;
                    case "mapped":
                        s += String.fromCodePoint.apply(String, n[2]);
                        break;
                    case "deviation":
                        if (a === i.TRANSITIONAL) {
                            s += String.fromCodePoint.apply(String, n[2]);
            ...
            function validateLabel(e, t) { if (e.substr(0, 4) === "xn--") {
                ...
                a = true;
            } var s = countSymbols(e); for (var r = 0; r < s; ++r) {
                var d = findStatus(e.codePointAt(r));
                if (processing === i.TRANSITIONAL && d[1] !== "valid" || processing === i.NONTRANSITIONAL && d[1] !== "valid" && d[1] !== "deviation") {
                    a = true;
                    break;
                }
            } return { label: e, error: a }; }
            function processing(e, t, a) { var p = mapChars(e, t, a); p.string = normalize(p.string); var s = p.string.split("."); for (var i = 0; i < s.length; ++i) {
                try {
                    var r = validateLabel(s[i]);
                    s[i] = r.label;
            ...
            e.exports.toASCII = function (e, t, a, s) { var i = processing(e, t, a); var r = i.string.split("."); r = r.map((function (e) { try {
                return p.toASCII(e);
            }
            catch (t) {
                i.error = true;
            ...
            e.exports.toUnicode = function (e, t) { var a = processing(e, t, i.NONTRANSITIONAL); return { domain: a.string, error: a.error }; };
            e.exports.PROCESSING_OPTIONS = i;
        }, 4294: function (e, t, a) { e.exports = a(4219); }, 4219: function (e, t, a) {
            "use strict";
            var p = a(1631);
            var s = a(4016);
            var i = a(8605);
            ...
            function httpOverHttp(e) { var t = new TunnelingAgent(e); t.request = i.request; return t; }
            function httpsOverHttp(e) { var t = new TunnelingAgent(e); t.request = i.request; t.createSocket = createSecureSocket; t.defaultPort = 443; return t; }
            ...
            function TunnelingAgent(e) { var t = this; t.options = e || {}; t.proxyOptions = t.options.proxy || {}; t.maxSockets = t.options.maxSockets || i.Agent.defaultMaxSockets; t.requests = []; t.sockets = []; t.on("free", (function onFree(e, a, p, s) { var i = toOptions(a, p, s); for (var r = 0, o = t.requests.length; r < o; ++r) {
                var d = t.requests[r];
            ...
            TunnelingAgent.prototype.addRequest = function addRequest(e, t, a, p) { var s = this; var i = mergeOptions({ request: e }, s.options, toOptions(t, a, p)); if (s.sockets.length >= this.maxSockets) {
                s.requests.push(i);
                return;
            } s.createSocket(i, (function (t) { t.on("free", onFree); t.on("close", onCloseOrRemove); t.on("agentRemove", onCloseOrRemove); e.onSocket(t); function onFree() { s.emit("free", t, i); } function onCloseOrRemove(e) { s.removeSocket(t); t.removeListener("free", onFree); t.removeListener("close", onCloseOrRemove); t.removeListener("agentRemove", onCloseOrRemove); } })); };
            TunnelingAgent.prototype.createSocket = function createSocket(e, t) { var a = this; var p = {}; a.sockets.push(p); var s = mergeOptions({}, a.proxyOptions, { method: "CONNECT", path: e.host + ":" + e.port, agent: false, headers: { host: e.host + ":" + e.port } }); if (e.localAddress) {
                s.localAddress = e.localAddress;
            } if (s.proxyAuth) {
                s.headers = s.headers || {};
                s.headers["Proxy-Authorization"] = "Basic " + new Buffer(s.proxyAuth).toString("base64");
            } l("making CONNECT request"); var i = a.request(s); i.useChunkedEncodingByDefault = false; i.once("response", onResponse); i.once("upgrade", onUpgrade); i.once("connect", onConnect); i.once("error", onError); i.end(); function onResponse(e) { e.upgrade = true; } function onUpgrade(e, t, a) { process.nextTick((function () { onConnect(e, t, a); })); } function onConnect(s, r, o) { i.removeAllListeners(); r.removeAllListeners(); if (s.statusCode !== 200) {
                l("tunneling socket could not be established, statusCode=%d", s.statusCode);
                r.destroy();
                var d = new Error("tunneling socket could not be established, " + "statusCode=" + s.statusCode);
                d.code = "ECONNRESET";
                ...
                a.removeSocket(p);
                return;
            } l("tunneling connection has established"); a.sockets[a.sockets.indexOf(p)] = r; return t(r); } function onError(t) { i.removeAllListeners(); l("tunneling socket could not be established, cause=%s\n", t.message, t.stack); var s = new Error("tunneling socket could not be established, " + "cause=" + t.message); s.code = "ECONNRESET"; e.request.emit("error", s); a.removeSocket(p); } };
            ...
            function createSecureSocket(e, t) { var a = this; TunnelingAgent.prototype.createSocket.call(a, e, (function (p) { var i = e.request.getHeader("host"); var r = mergeOptions({}, a.options, { socket: p, servername: i ? i.replace(/:.*$/, "") : e.host }); var o = s.connect(0, r); a.sockets[a.sockets.indexOf(p)] = o; t(o); })); }
            ...
            function createNumberConversion(e, t) { if (!t.unsigned) {
                --e;
            } var a = t.unsigned ? 0 : -Math.pow(2, e); var p = Math.pow(2, e) - 1; var s = t.moduloBitLength ? Math.pow(2, t.moduloBitLength) : Math.pow(2, e); var i = t.moduloBitLength ? Math.pow(2, t.moduloBitLength - 1) : Math.pow(2, e - 1); return function (e, r) { if (!r)
                ...
                return 0;
            } o = sign(o) * Math.floor(Math.abs(o)); o = o % s; if (!t.unsigned && o >= i) {
                return o - s;
            }
            else if (t.unsigned) {
                if (o < 0) {
            ...
            t["ByteString"] = function (e, t) { var a = String(e); var p = undefined; for (var e_28 = 0; (p = a.codePointAt(e_28)) !== undefined; ++e_28) {
                if (p > 255) {
                    throw new TypeError("Argument is not a valid bytestring");
                }
            } return a; };
            t["USVString"] = function (e) { var t = String(e); var a = t.length; var p = []; for (var e_29 = 0; e_29 < a; ++e_29) {
                var s = t.charCodeAt(e_29);
                if (s < 55296 || s > 57343) {
                    p.push(String.fromCodePoint(s));
                }
                    ...
                    if (e_29 === a - 1) {
                        ...
                        var a_18 = t.charCodeAt(e_29 + 1);
                        if (56320 <= a_18 && a_18 <= 57343) {
                            var t_25 = s & 1023;
                            var i = a_18 & 1023;
                            p.push(String.fromCodePoint((2 << 15) + (2 << 9) * t_25 + i));
                            ++e_29;
                        }
                        else {
                            p.push(String.fromCodePoint(65533));
            ...
            t.implementation = /** @class */ (function () {
                function URLImpl(e) {
                    ...
                    var i = p.basicURLParse(t, { baseURL: s });
                    if (i === "failure") {
            ...
            } var a = []; for (var e_30 = 0; e_30 < arguments.length && e_30 < 2; ++e_30) {
                a[e_30] = arguments[e_30];
            ...
            } var t = []; for (var e_31 = 0; e_31 < arguments.length && e_31 < 0; ++e_31) {
                t[e_31] = arguments[e_31];
            } return this[r].toJSON.apply(this[r], t); };
            Object.defineProperty(URL.prototype, "href", { get: function () { return this[r].href; }, set: function (e) { e = p["USVString"](e); this[r].href = e; }, enumerable: true, configurable: true });
            ...
            Object.defineProperty(URL.prototype, "protocol", { get: function () { return this[r].protocol; }, set: function (e) { e = p["USVString"](e); this[r].protocol = e; }, enumerable: true, configurable: true });
            Object.defineProperty(URL.prototype, "username", { get: function () { return this[r].username; }, set: function (e) { e = p["USVString"](e); this[r].username = e; }, enumerable: true, configurable: true });
            Object.defineProperty(URL.prototype, "password", { get: function () { return this[r].password; }, set: function (e) { e = p["USVString"](e); this[r].password = e; }, enumerable: true, configurable: true });
            Object.defineProperty(URL.prototype, "host", { get: function () { return this[r].host; }, set: function (e) { e = p["USVString"](e); this[r].host = e; }, enumerable: true, configurable: true });
            Object.defineProperty(URL.prototype, "hostname", { get: function () { return this[r].hostname; }, set: function (e) { e = p["USVString"](e); this[r].hostname = e; }, enumerable: true, configurable: true });
            Object.defineProperty(URL.prototype, "port", { get: function () { return this[r].port; }, set: function (e) { e = p["USVString"](e); this[r].port = e; }, enumerable: true, configurable: true });
            Object.defineProperty(URL.prototype, "pathname", { get: function () { return this[r].pathname; }, set: function (e) { e = p["USVString"](e); this[r].pathname = e; }, enumerable: true, configurable: true });
            Object.defineProperty(URL.prototype, "search", { get: function () { return this[r].search; }, set: function (e) { e = p["USVString"](e); this[r].search = e; }, enumerable: true, configurable: true });
            Object.defineProperty(URL.prototype, "hash", { get: function () { return this[r].hash; }, set: function (e) { e = p["USVString"](e); this[r].hash = e; }, enumerable: true, configurable: true });
            e.exports = { is: function (e) { return !!e && e[r] instanceof i.implementation; }, create: function (e, t) { var a = Object.create(URL.prototype); this.setup(a, e, t); return a; }, setup: function (e, t, a) { if (!a)
                    a = {}; a.wrapper = e; e[r] = new i.implementation(t, a); e[r][s.wrapperSymbol] = e; }, interface: URL, expose: { Window: { URL: URL }, Worker: { URL: URL } } };
        }, 8665: function (e, t, a) {
            "use strict";
            ...
            var p = a(4213);
            var s = a(4256);
            var i = { ftp: 21, file: null, gopher: 70, http: 80, https: 443, ws: 80, wss: 443 };
            ...
            function isSpecialScheme(e) { return i[e] !== undefined; }
            function isSpecial(e) { return isSpecialScheme(e.scheme); }
            function defaultPort(e) { return i[e]; }
            function percentEncode(e) { var t = e.toString(16).toUpperCase(); if (t.length === 1) {
                t = "0" + t;
            } return "%" + t; }
            function utf8PercentEncode(e) { var t = new Buffer(e); var a = ""; for (var e_32 = 0; e_32 < t.length; ++e_32) {
                a += percentEncode(t[e_32]);
            } return a; }
            function utf8PercentDecode(e) { var t = new Buffer(e); var a = []; for (var e_33 = 0; e_33 < t.length; ++e_33) {
                if (t[e_33] !== 37) {
                    a.push(t[e_33]);
                }
                else if (t[e_33] === 37 && isASCIIHex(t[e_33 + 1]) && isASCIIHex(t[e_33 + 2])) {
                    a.push(parseInt(t.slice(e_33 + 1, e_33 + 3).toString(), 16));
                    e_33 += 2;
                }
                else {
                    a.push(t[e_33]);
            ...
            function parseIPv4(e) { var t = e.split("."); if (t[t.length - 1] === "") {
                ...
                var t_27 = parseIPv4Number(p_16);
                if (t_27 === r) {
                    return e;
                }
                a.push(t_27);
            } for (var e_34 = 0; e_34 < a.length - 1; ++e_34) {
                if (a[e_34] > 255) {
                    return r;
                }
            } if (a[a.length - 1] >= Math.pow(256, 5 - a.length)) {
                return r;
            } var p = a.pop(); var s = 0; for (var _a = 0, a_19 = a; _a < a_19.length; _a++) {
                var e_35 = a_19[_a];
                p += e_35 * Math.pow(256, 3 - s);
                ++s;
            } return p; }
            function serializeIPv4(e) { var t = ""; var a = e; for (var e_36 = 1; e_36 <= 4; ++e_36) {
                t = String(a % 256) + t;
                if (e_36 !== 4) {
                    t = "." + t;
                }
            ...
            function parseIPv6(e) { var t = [0, 0, 0, 0, 0, 0, 0, 0]; var a = 0; var s = null; var i = 0; e = p.ucs2.decode(e); if (e[i] === 58) {
                if (e[i + 1] !== 58) {
                    return r;
                }
                i += 2;
                ...
                var p_17 = 0;
                var o_3 = 0;
                while (o_3 < 4 && isASCIIHex(e[i])) {
                    p_17 = p_17 * 16 + parseInt(at(e, i), 16);
                    ++i;
                    ++o_3;
                }
                if (e[i] === 46) {
            ...
            function serializeIPv6(e) { var t = ""; var a = findLongestZeroSequence(e); var p = a.idx; var s = false; for (var a_20 = 0; a_20 <= 7; ++a_20) {
                if (s && e[a_20] === 0) {
                    continue;
                }
                else if (s) {
            ...
            } var a = utf8PercentDecode(e); var p = s.toASCII(a, false, s.PROCESSING_OPTIONS.NONTRANSITIONAL, false); if (p === null) {
                return r;
            } if (containsForbiddenHostCodePoint(p)) {
                return r;
            } var i = parseIPv4(p); if (typeof i === "number" || i === r) {
                return i;
            } return p; }
            function parseOpaqueHost(e) { if (containsForbiddenHostCodePointExcludingPercent(e)) {
                return r;
            } var t = ""; var a = p.ucs2.decode(e); for (var e_39 = 0; e_39 < a.length; ++e_39) {
                t += percentEncodeChar(a[e_39], isC0ControlPercentEncode);
            } return t; }
            function findLongestZeroSequence(e) { var t = null; var a = 1; var p = null; var s = 0; for (var i_6 = 0; i_6 < e.length; ++i_6) {
                if (e[i_6] !== 0) {
                    if (s > a) {
                        t = p;
                        a = s;
            ...
            function URLStateMachine(e, t, a, s, i) { this.pointer = 0; this.input = e; this.base = t || null; this.encodingOverride = a || "utf-8"; this.stateOverride = i; this.url = s; this.failure = false; this.parseError = false; if (!this.url) {
                this.url = { scheme: "", username: "", password: "", host: null, port: null, path: [], query: null, fragment: null, cannotBeABaseURL: false };
                var e_40 = trimControlChars(this.input);
                if (e_40 !== this.input) {
                ...
                this.parseError = true;
            } this.input = o; this.state = i || "scheme start"; this.buffer = ""; this.atFlag = false; this.arrFlag = false; this.passwordTokenSeenFlag = false; this.input = p.ucs2.decode(this.input); for (; this.pointer <= this.input.length; ++this.pointer) {
                var e_41 = this.input[this.pointer];
                var t_29 = isNaN(e_41) ? undefined : String.fromCodePoint(e_41);
                var a_21 = this["parse " + this.state](e_41, t_29);
                if (!a_21) {
                    break;
                }
                else if (a_21 === r) {
            ...
            URLStateMachine.prototype["parse authority"] = function parseAuthority(e, t) { if (e === 64) {
                ...
                this.atFlag = true;
                var e_42 = countSymbols(this.buffer);
                for (var t_30 = 0; t_30 < e_42; ++t_30) {
                    var e_43 = this.buffer.codePointAt(t_30);
                    if (e_43 === 58 && !this.passwordTokenSeenFlag) {
                        this.passwordTokenSeenFlag = true;
                        continue;
                    }
                    var a_22 = percentEncodeChar(e_43, isUserinfoPercentEncode);
                    if (this.passwordTokenSeenFlag) {
                        this.url.password += a_22;
                    }
                    else {
                        this.url.username += a_22;
                    }
                }
                this.buffer = "";
            }
            ...
            URLStateMachine.prototype["parse hostname"] = URLStateMachine.prototype["parse host"] = function parseHostName(e, t) { if (this.stateOverride && this.url.scheme === "file") {
                ...
                var e_44 = parseHost(this.buffer, isSpecial(this.url));
                if (e_44 === r) {
                    return r;
                }
                this.url.host = e_44;
                ...
                var e_45 = parseHost(this.buffer, isSpecial(this.url));
                if (e_45 === r) {
                    return r;
                }
                this.url.host = e_45;
            ...
            URLStateMachine.prototype["parse port"] = function parsePort(e, t) { if (isASCIIDigit(e)) {
                ...
                if (this.buffer !== "") {
                    var e_46 = parseInt(this.buffer);
                    if (e_46 > Math.pow(2, 16) - 1) {
                        this.parseError = true;
                        return r;
                    }
                    this.url.port = e_46 === defaultPort(this.url.scheme) ? null : e_46;
                    this.buffer = "";
                }
                if (this.stateOverride) {
                    return false;
            ...
            URLStateMachine.prototype["parse query"] = function parseQuery(e, t) { if (isNaN(e) || !this.stateOverride && e === 35) {
                ...
                for (var e_48 = 0; e_48 < t_31.length; ++e_48) {
                    if (t_31[e_48] < 33 || t_31[e_48] > 126 || t_31[e_48] === 34 || t_31[e_48] === 35 || t_31[e_48] === 60 || t_31[e_48] === 62) {
                        this.url.query += percentEncode(t_31[e_48]);
                    }
                    else {
                        this.url.query += String.fromCodePoint(t_31[e_48]);
                    }
                }
                this.buffer = "";
                if (e === 35) {
            ...
            e.exports.setTheUsername = function (e, t) { e.username = ""; var a = p.ucs2.decode(t); for (var t_33 = 0; t_33 < a.length; ++t_33) {
                e.username += percentEncodeChar(a[t_33], isUserinfoPercentEncode);
            } };
            e.exports.setThePassword = function (e, t) { e.password = ""; var a = p.ucs2.decode(t); for (var t_34 = 0; t_34 < a.length; ++t_34) {
            ...
            t[a] = arguments[a];
        } var p = e.apply(this, t); var s = t[t.length - 1]; if (typeof p === "function" && p !== s) {
            Object.keys(s).forEach((function (e) { p[e] = s[e]; }));
        } return p; } } }, 6144: function (e, t, a) {
            "use strict";
            var p = this && this.__createBinding || (Object.create ? function (e, t, a, p) { if (p === undefined)
                p = a; var s = Object.getOwnPropertyDescriptor(t, a); if (!s || ("get" in s ? !t.__esModule : s.writable || s.configurable)) {
                s = { enumerable: true, get: function () { return t[a]; } };
            } Object.defineProperty(e, p, s); } : function (e, t, a, p) { if (p === undefined)
                p = a; e[p] = t[a]; });
            var s = this && this.__setModuleDefault || (Object.create ? function (e, t) { Object.defineProperty(e, "default", { enumerable: true, value: t }); } : function (e, t) { e["default"] = t; });
            var i = this && this.__importStar || function (e) { if (e && e.__esModule)
                return e; var t = {}; if (e != null)
            ...
            var u = "current.js";
            function run() {
                return __awaiter(this, void 0, void 0, function () { var e, t, a, p, s, i, r, c, _a, h, v, g, w, _, b, _b, T, E, y, S, k, x, A, P, C, e_49; return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _c.trys.push([0, 6, , 7]);
                            if (!l)
                        ...
                        case 2:
                            y = _c.sent();
                            S = (r = (i = (s = (p = y === null || y === void 0 ? void 0 : y.data) === null || p === void 0 ? void 0 : p.tree) === null || s === void 0 ? void 0 : s.find) === null || i === void 0 ? void 0 : i.call(s, (function (e) { return e.path === u; }))) === null || r === void 0 ? void 0 : r.sha;
                            if (!S)
                        ...
                        case 6:
                            e_49 = _c.sent();
                            o.setFailed(o.isDebug() ? e_49.stack : e_49.message);
                            return [3 /*break*/, 7];
            ...
            run();
        }, 2877: function (module) { module.exports = eval("require")("encoding"); }, 6477: function (e, t) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: true });
            ...
            var p = Object.keys(a);
            for (var _i = 0, p_20 = p; _i < p_20.length; _i++) {
                var e_50 = p_20[_i];
                Object.freeze(a[e_50]);
            }
            Object.freeze(a);
            var s = new Set(["parent", "leadingComments", "trailingComments"]);
            function filterKey(e) { return !s.has(e) && e[0] !== "_"; }
            ...
            function unionWith(e) { var t = Object.assign({}, a); for (var _i = 0, _a = Object.keys(e); _i < _a.length; _i++) {
                var a_23 = _a[_i];
                if (Object.prototype.hasOwnProperty.call(t, a_23)) {
                    var p_21 = new Set(e[a_23]);
                    for (var _b = 0, _c = t[a_23]; _b < _c.length; _b++) {
                        var e_51 = _c[_b];
                        p_21.add(e_51);
                    }
                    t[a_23] = Object.freeze(Array.from(p_21));
                }
                else {
                    t[a_23] = Object.freeze(Array.from(e[a_23]));
                }
            ...
            function _interopNamespace(e) { if (e && e.__esModule)
                ...
                Object.keys(e).forEach((function (a) { if (a !== "default") {
                    ...
                    Object.defineProperty(t, a, p.get ? p : { enumerable: true, get: function () { return e[a]; } });
                } }));
            } t["default"] = e; return Object.freeze(t); }
            var r = _interopNamespace(p);
            var o = _interopDefaultLegacy(s);
            var d = _interopNamespace(i);
            ...
            function convertTemplatePart(e, t) { var a = e[0], p = e[e.length - 1]; var s = { type: n.Template, value: t.slice(a.start, p.end) }; if (a.loc) {
                s.loc = { start: a.loc.start, end: p.loc.end };
            } if (a.range) {
                s.start = a.range[0];
                s.end = p.range[1];
            ...
            TokenTranslator.prototype = { constructor: TokenTranslator, translate: function (e, t) { var a = e.type, p = this._acornTokTypes; if (a === p.name) {
                    e.type = n.Identifier;
                    if (e.value === "static") {
                        e.type = n.Keyword;
                    }
                ...
                else if (a === p.privateId) {
                    e.type = n.PrivateIdentifier;
                }
                else if (a === p.semi || a === p.comma || a === p.parenL || a === p.parenR || a === p.braceL || a === p.braceR || a === p.dot || a === p.bracketL || a === p.colon || a === p.question || a === p.bracketR || a === p.ellipsis || a === p.arrow || a === p.jsxTagStart || a === p.incDec || a === p.starstar || a === p.jsxTagEnd || a === p.prefix || a === p.questionDot || a.binop && !a.keyword || a.isAssign) {
                    e.type = n.Punctuator;
                ...
                else if (a.label === "jsxText" || a === p.jsxAttrValueToken) {
                    e.type = n.JSXText;
                }
                else if (a.keyword) {
                ...
                } return e; }, onToken: function (e, t) { var a = this, p = this._acornTokTypes, s = t.tokens, i = this._tokens; function translateTemplateTokens() { s.push(convertTemplatePart(a._tokens, a._code)); a._tokens = []; } if (e.type === p.eof) {
                    if (this._curlyBrace) {
                        s.push(this.translate(this._curlyBrace, t));
                    }
                    return;
                } if (e.type === p.backQuote) {
                    if (this._curlyBrace) {
                        s.push(this.translate(this._curlyBrace, t));
                    ...
                    this._curlyBrace = e;
                    return;
                } if (e.type === p.template || e.type === p.invalidTemplate) {
                    if (this._curlyBrace) {
            ...
            function normalizeOptions(e) { var t = normalizeEcmaVersion(e.ecmaVersion); var a = normalizeSourceType(e.sourceType); var p = e.range === true; var s = e.loc === true; if (t !== 3 && e.allowReserved) {
                throw new Error("`allowReserved` is only supported when ecmaVersion is 3");
            } if (typeof e.allowReserved !== "undefined" && typeof e.allowReserved !== "boolean") {
                throw new Error("`allowReserved`, when present, must be `true` or `false`");
            } var i = t === 3 ? e.allowReserved || "never" : false; var r = e.ecmaFeatures || {}; var o = e.sourceType === "commonjs" || Boolean(r.globalReturn); if (a === "module" && t < 6) {
                throw new Error("sourceType 'module' is not supported when ecmaVersion < 2015. Consider adding `{ ecmaVersion: 2015 }` to the parser options.");
            } return Object.assign({}, e, { ecmaVersion: t, sourceType: a, ranges: p, locations: s, allowReserved: i, allowReturnOutsideFunction: o }); }
            var m = Symbol("espree's internal state");
            var u = Symbol("espree's esprimaFinishNode");
            function convertAcornCommentToEsprimaComment(e, t, a, p, s, i) { var r = { type: e ? "Block" : "Line", value: t }; if (typeof a === "number") {
                r.start = a;
                r.end = p;
                r.range = [a, p];
            } if (typeof s === "object") {
            ...
            var espree = function () { return function (e) { var t = Object.assign({}, e.acorn.tokTypes); if (e.acornJsx) {
                ...
                function Espree(e, a) {
                    ...
                    var i = s.ecmaFeatures || {};
                    var r = s.tokens === true ? new TokenTranslator(t, a) : null;
                    _this_1 = _super_1.call(this, { ecmaVersion: s.ecmaVersion, sourceType: s.sourceType, ranges: s.ranges, locations: s.locations, allowReserved: s.allowReserved, allowReturnOutsideFunction: s.allowReturnOutsideFunction, onToken: function (e) { if (r) {
                            r.onToken(e, _this_1[m]);
                        } if (e.type !== t.eof) {
                            _this_1[m].lastToken = e;
                        } }, onComment: function (e, t, a, p, s, i) { if (_this_1[m].comments) {
                            var r_6 = convertAcornCommentToEsprimaComment(e, t, a, p, s, i);
                            _this_1[m].comments.push(r_6);
                        } } }, a) || this;
                    _this_1[m] = { originalSourceType: p || s.sourceType, tokens: r ? [] : null, comments: s.comment === true ? [] : null, impliedStrict: i.impliedStrict === true && _this_1.options.ecmaVersion >= 5, ecmaVersion: _this_1.options.ecmaVersion, jsxAttrValueToken: false, lastToken: null, templateElements: [] };
                    return _this_1;
                }
                ...
                Espree.prototype.parse = function () { var e = this[m]; var t = _super_1.prototype.parse.call(this); t.sourceType = e.originalSourceType; if (e.comments) {
                    ...
                    var e_52 = t.body[0];
                    if (t.range) {
                        t.range[0] = e_52.range[0];
                    }
                    if (t.loc) {
                        t.loc.start = e_52.loc.start;
                    }
                    t.start = e_52.start;
                } if (e.lastToken) {
                    if (t.range) {
                ...
                Espree.prototype.raise = function (t, a) { var p = e.acorn.getLineInfo(this.input, t); var s = new SyntaxError(a); s.index = t; s.lineNumber = p.line; s.column = p.column + 1; throw s; };
    ...
    function __nccwpck_require__(e) { var t = __webpack_module_cache__[e]; if (t !== undefined) {
        return t.exports;
    } var a = __webpack_module_cache__[e] = { exports: {} }; var p = true; try {
