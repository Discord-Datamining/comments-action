...
(function () {
    var __webpack_modules__ = { 1346: function (e, t, a) {
            ...
            } s.appendFileSync(a, "".concat(d.toCommandValue(t)).concat(o.EOL), { encoding: "utf8" }); }
            t.issueCommand = issueCommand;
        }, 4892: function (e, t, a) {
            "use strict";
            ...
            var i = a(2037);
            var r = a(7147);
            var _a = r.promises, s = _a.access, o = _a.appendFile, d = _a.writeFile;
            ...
            var Summary = /** @class */ (function () {
                ...
                Summary.prototype.addTable = function (e) {
                    ...
                    } var t = e.header, a = e.data, p = e.colspan, i = e.rowspan; var r = t ? "th" : "td"; var s = Object.assign(Object.assign({}, p && { colspan: p }), i && { rowspan: i }); return _this_1.wrap(r, a, s); })).join(""); return _this_1.wrap("tr", t); })).join("");
            ...
            function getOctokit(e, t) {
                ...
                var p = (_a = o.GitHub).plugin.apply(_a, a);
            ...
            var g = [m.BadGateway, m.ServiceUnavailable, m.GatewayTimeout];
            ...
            var HttpClientResponse = /** @class */ (function () {
                ...
                HttpClientResponse.prototype.readBody = function () { return s(this, void 0, void 0, (function () {
                    ...
                    return __generator(this, function (_a) {
                        return [2 /*return*/, new Promise((function (e) { return s(_this_1, void 0, void 0, (function () { var t; return __generator(this, function (_a) {
                                t = Buffer.alloc(0);
            ...
            var HttpClient = /** @class */ (function () {
                ...
                HttpClient.prototype.getJson = function (e, t) {
                    ...
                    return s(this, void 0, void 0, (function () { var a; return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                t[u.Accept] = this._getExistingOrDefaultHeader(t, u.Accept, h.ApplicationJson);
                    ...
                    return s(this, void 0, void 0, (function () { var p, i; return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                a[u.Accept] = this._getExistingOrDefaultHeader(a, u.Accept, h.ApplicationJson);
                                a[u.ContentType] = this._getExistingOrDefaultHeader(a, u.ContentType, h.ApplicationJson);
                ...
                HttpClient.prototype.request = function (e, t, a, p) { return s(this, void 0, void 0, (function () { var i, r, s, o, d, e_4, _i, _a, t_6, t_7, s_1, o_1, e_5; return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (this._disposed) {
                            ...
                            s = this._allowRetries && w.includes(e) ? this._maxRetries + 1 : 1;
                            o = 0;
                            _b.label = 1;
                        ...
                        case 2:
                            ...
                            _b.label = 3;
                        case 3:
                            if (!(d.message.statusCode && v.includes(d.message.statusCode) && this._allowRedirects && t_7 > 0)) return [3 /*break*/, 6];
                            s_1 = d.message.headers["location"];
                            if (!s_1) {
                                return [3 /*break*/, 6];
                            }
                            o_1 = new URL(s_1);
                            if (i.protocol === "https:" && i.protocol !== o_1.protocol && !this._allowRedirectDowngrade) {
                                throw new Error("Redirect from HTTPS to HTTP protocol. This downgrade is not allowed for security reasons. If you want to allow this behavior, set the allowRedirectDowngrade option to true.");
                            }
                            return [4 /*yield*/, d.readBody()];
                        case 4:
                            _b.sent();
                            if (o_1.hostname !== i.hostname) {
                                for (e_5 in p) {
                            ...
                            r = this._prepareRequest(e, o_1, p);
                ...
                HttpClient.prototype._prepareRequest = function (e, t, a) { var p = {}; p.parsedUrl = t; var i = p.parsedUrl.protocol === "https:"; p.httpModule = i ? d : o; var r = i ? 443 : 80; p.options = {}; p.options.host = p.parsedUrl.hostname; p.options.port = p.parsedUrl.port ? parseInt(p.parsedUrl.port) : r; p.options.path = (p.parsedUrl.pathname || "") + (p.parsedUrl.search || ""); p.options.method = e; p.options.headers = this._mergeHeaders(a); if (this.userAgent != null) {
                ...
                HttpClient.prototype._getAgent = function (e) { var t; var a = n.getProxyUrl(e); var p = a && a.hostname; if (this._keepAlive && p) {
                    ...
                    r = this.requestOptions.maxSockets || o.globalAgent.maxSockets;
                } if (a && a.hostname) {
                    ...
                    t = i ? new d.Agent(e_8) : new o.Agent(e_8);
                    this._agent = t;
                } if (!t) {
                ...
                HttpClient.prototype._processResponse = function (e, t) { return s(this, void 0, void 0, (function () {
                    var _this_1 = this;
                    return __generator(this, function (_a) {
                        return [2 /*return*/, new Promise((function (a, p) { return s(_this_1, void 0, void 0, (function () { function dateTimeDeserializer(e, t) { if (typeof t === "string") {
                                var e_10 = new Date(t);
                                if (!isNaN(e_10.valueOf())) {
                                    return e_10;
                                }
                            } return t; } var i, r, s, o, e_9, e_11, t_8; return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 2:
                                        ...
                                        if (o && o.length > 0) {
                                            if (t && t.deserializeDates) {
                                                s = JSON.parse(o, dateTimeDeserializer);
                                            }
                                            else {
                                                s = JSON.parse(o);
                                            }
            ...
            var Octokit = /** @class */ (function () {
                function Octokit(e) {
                    ...
                    if (!e.authStrategy) {
                        ...
                        var a_5 = e.authStrategy, p_4 = _objectWithoutProperties(e, n);
            ...
            function parse(e) { var t = e.method.toUpperCase(); var a = (e.url || "/").replace(/:([a-z]\w+)/g, "{+$1}"); var p = Object.assign({}, e.headers); var i; var r = omit(e, ["method", "baseUrl", "url", "headers", "request", "mediaType"]); var s = extractUrlVariableNames(a); a = parseUrl(a).expand(r); if (!/^http/.test(a)) {
                a = e.baseUrl + a;
            } var o = Object.keys(e).filter((function (e) { return s.includes(e); })).concat("baseUrl"); var d = omit(r, o); var n = /application\/octet-stream/i.test(p.accept); if (!n) {
            ...
            var s = "6.0.5";
            var o = "octokit-endpoint.js/".concat(s, " ").concat(i.getUserAgent());
            ...
            var n = withDefaults(p.request, { headers: { "user-agent": "octokit-graphql.js/".concat(r, " ").concat(i.getUserAgent()) }, method: "POST", url: "/graphql" });
                ...
                return _a = {}, _a[Symbol.asyncIterator] = function () { return ({ next: function () {
                        return __awaiter(this, void 0, void 0, function () { var e_18, t_11, e_17; return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                    return [4 /*yield*/, i({ method: r, url: o, headers: s })];
                                case 2:
                                    e_18 = _a.sent();
            ...
            function endpointsToMethods(e, t) { var a = {}; for (var _i = 0, _a = Object.entries(t); _i < _a.length; _i++) {
                ...
                for (var _c = 0, _d = Object.entries(i); _c < _d.length; _c++) {
                    ...
                    var i_3 = r[0], s = r[1], o = r[2];
                    var _g = i_3.split(/ /), d = _g[0], n = _g[1];
                    var l = Object.assign({ method: d, url: n }, s);
                    if (!a[p_6]) {
                        a[p_6] = {};
                    }
                    var m = a[p_6];
                    if (o) {
                        m[t_12] = decorate(e, p_6, t_12, l, o);
                        continue;
                    }
            ...
            function decorate(e, t, a, p, i) { var r = e.request.defaults(p); function withDecorations() {
                ...
                if (i.renamedParameters) {
                    ...
                    for (var _f = 0, _g = Object.entries(i.renamedParameters); _f < _g.length; _f++) {
                        var _h = _g[_f], p_8 = _h[0], r_2 = _h[1];
                        if (p_8 in s_3) {
            ...
            var RequestError = /** @class */ (function (_super_1) {
                ...
                function RequestError(e, t, a) {
                    ...
                    _this_1.request = o;
                    Object.defineProperty(_this_1, "code", { get: function () { r(new p.Deprecation("[@octokit/request-error] `error.code` is deprecated, use `error.status`.")); return t; } });
                    Object.defineProperty(_this_1, "headers", { get: function () { s(new p.Deprecation("[@octokit/request-error] `error.headers` is deprecated, use `error.response.headers`.")); return i || {}; } });
                    return _this_1;
                }
                return RequestError;
            }(Error));
            ...
            function fetchWrapper(e) {
                ...
                return d(e.url, Object.assign({ method: e.method, body: e.body, headers: e.headers, redirect: e.redirect }, e.request)).then((function (r) { return __awaiter(_this_1, void 0, void 0, function () {
                        ...
                        switch (_h.label) {
                            case 0:
                                ...
                                if (e.method === "HEAD") {
                                    ...
                                    throw new o.RequestError(r.statusText, p, { response: { url: i, status: p, headers: a, data: undefined }, request: e });
                                }
                                if (!(p === 304)) return [3 /*break*/, 2];
                                _c = (_b = o.RequestError).bind;
                                _d = [void 0, "Not modified", p];
                                _f = {};
                                _g = { url: i, status: p, headers: a };
                            ...
                            case 3:
                                t_13 = _h.sent();
                                s_4 = new o.RequestError(toErrorMessage(t_13), p, { response: { url: i, status: p, headers: a, data: t_13 }, request: e });
                                throw s_4;
                            case 4: return [2 /*return*/, getResponseData(r)];
                        }
                    });
                }); })).then((function (e) { return ({ status: p, url: i, headers: a, data: e }); }))["catch"]((function (t) { if (t instanceof o.RequestError)
            ...
            var n = withDefaults(p.endpoint, { headers: { "user-agent": "octokit-request.js/".concat(d, " ").concat(i.getUserAgent()) } });
            t.request = n;
        }, 9081: function (e, t, a) { var p = a(7334); var i = a(1706); var r = a(400); var s = Function.bind; var o = s.bind(s); function bindApi(e, t, a) { var p = o(r, null).apply(null, a ? [t, a] : [t]); e.api = { remove: p }; e.remove = p; ["before", "error", "after", "wrap"].forEach((function (p) { var r = a ? [t, p, a] : [t, p]; e[p] = e.api[p] = o(i, null).apply(null, r); })); } function HookSingular() { var e = "h"; var t = { registry: {} }; var a = p.bind(null, t, e); bindApi(a, t, e); return a; } function HookCollection() { var e = { registry: {} }; var t = p.bind(null, e); bindApi(t, e); return t; } var d = false; function Hook() { if (!d) {
            ...
            var Blob = /** @class */ (function () {
                ...
                Blob.prototype.slice = function () { var e = this.size; var t = arguments[0]; var a = arguments[1]; var p, i; if (t === undefined) {
                    ...
                    i = Math.min(a, e);
                } var r = Math.max(i - p, 0); var s = this[l]; var o = s.slice(p, p + r); var d = new Blob([], { type: arguments[2] }); d[l] = o; return d; };
                return Blob;
            }());
            ...
            var v = p.PassThrough;
            function Body(e) { var t = this; var a = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}, i = a.size; var r = i === undefined ? 0 : i; var s = a.timeout; var o = s === undefined ? 0 : s; if (e == null) {
                e = null;
            }
            ...
            } this[h] = { body: e, disturbed: false, error: null }; this.size = r; this.timeout = o; if (e instanceof p) {
            ...
            function consumeBody() { var e = this; if (this[h].disturbed) {
                ...
                return Body.Promise.resolve(Buffer.alloc(0));
            } var a = []; var i = 0; var r = false; return new Body.Promise((function (p, s) { var o; if (e.timeout) {
                o = setTimeout((function () { r = true; s(new FetchError("Response timeout while trying to fetch ".concat(e.url, " (over ").concat(e.timeout, "ms)"), "body-timeout")); }), e.timeout);
            ...
            function createHeadersIterator(e, t) { var a = Object.create(E); a[b] = { target: e, kind: t, index: 0 }; return a; }
            var E = Object.setPrototypeOf({ next: function () { if (!this || Object.getPrototypeOf(this) !== E) {
                    throw new TypeError("Value of `this` is not a HeadersIterator");
                } var e = this[b]; var t = e.target, a = e.kind, p = e.index; var i = getHeaders(t, a); var r = i.length; if (p >= r) {
                    return { value: undefined, done: true };
                } this[b].index = p + 1; return { value: i[p], done: false }; } }, Object.getPrototypeOf(Object.getPrototypeOf([][Symbol.iterator]())));
            ...
            function createHeadersLenient(e) { var t = new Headers; for (var _i = 0, _a = Object.keys(e); _i < _a.length; _i++) {
                ...
                else if (!w.test(e[a_15])) {
                    t[_][a_15] = [e[a_15]];
                }
            } return t; }
            var T = Symbol("Response internals");
            var y = i.STATUS_CODES;
            var Response = /** @class */ (function () {
                function Response() {
                    ...
                    this[T] = { url: t.url, status: a, statusText: t.statusText || y[a], headers: p, counter: t.counter };
                }
            ...
            var S = Symbol("Request internals");
            var k = r.URL || s.URL;
            var x = r.parse;
            var P = r.format;
            ...
            function isRequest(e) { return typeof e === "object" && typeof e[S] === "object"; }
            ...
            var Request = /** @class */ (function () {
                function Request(e) {
                    ...
                    this[S] = { method: p, redirect: t.redirect || e.redirect || "follow", headers: r, parsedURL: a, signal: s };
                ...
                Object.defineProperty(Request.prototype, "method", {
                    get: function () { return this[S].method; },
                    enumerable: false,
                    configurable: true
                });
                Object.defineProperty(Request.prototype, "url", {
                    get: function () { return P(this[S].parsedURL); },
                    enumerable: false,
                    configurable: true
                });
                Object.defineProperty(Request.prototype, "headers", {
                    get: function () { return this[S].headers; },
                    enumerable: false,
                    configurable: true
                });
                Object.defineProperty(Request.prototype, "redirect", {
                    get: function () { return this[S].redirect; },
                    enumerable: false,
                    configurable: true
                });
                Object.defineProperty(Request.prototype, "signal", {
                    get: function () { return this[S].signal; },
                    enumerable: false,
                    configurable: true
                });
            ...
            function getNodeRequestOptions(e) { var t = e[S].parsedURL; var a = new Headers(e[S].headers); if (!a.has("Accept")) {
                a.set("Accept", "*/*");
            ...
            var C = r.URL || s.URL;
            var D = p.PassThrough;
            var N = function isDomainOrSubdomain(e, t) { var a = new C(t).hostname; var p = new C(e).hostname; return a === p || a[a.length - p.length - 1] === "." && a.endsWith(p); };
            function fetch(e, t) { if (!fetch.Promise) {
                throw new Error("native promise missing, set fetch.Promise to your favorite alternative");
            } Body.Promise = fetch.Promise; return new fetch.Promise((function (a, r) { var s = new Request(e, t); var n = getNodeRequestOptions(s); var l = (n.protocol === "https:" ? o : i).request; var m = s.signal; var u = null; var h = function abort() { var e = new AbortError("The user aborted a request."); r(e); if (s.body && s.body instanceof p.Readable) {
                s.body.destroy(e);
            } if (!u || !u.body)
                return; u.body.emit("error", e); }; if (m && m.aborted) {
                h();
                return;
            } var v = function abortAndFinalize() { h(); finalize(); }; var g = l(n); var w; if (m) {
                m.addEventListener("abort", v);
            } function finalize() { g.abort(); if (m)
                m.removeEventListener("abort", v); clearTimeout(w); } if (s.timeout) {
                g.once("socket", (function (e) { w = setTimeout((function () { r(new FetchError("network timeout at: ".concat(s.url), "request-timeout")); finalize(); }), s.timeout); }));
            } g.on("error", (function (e) { r(new FetchError("request to ".concat(s.url, " failed, reason: ").concat(e.message), "system", e)); finalize(); })); g.on("response", (function (e) { clearTimeout(w); var t = createHeadersLenient(e.headers); if (fetch.isRedirect(e.statusCode)) {
                var p_11 = t.get("Location");
                var i_7 = null;
                try {
                    i_7 = p_11 === null ? null : new C(p_11, s.url).toString();
                }
                catch (e) {
                ...
                m.removeEventListener("abort", v); })); var p = e.pipe(new D); var i = { url: s.url, status: e.statusCode, statusText: e.statusMessage, headers: t, size: s.size, timeout: s.timeout, counter: s.counter }; var o = t.get("Content-Encoding"); if (!s.compress || s.method === "HEAD" || o === null || e.statusCode === 204 || e.statusCode === 304) {
                u = new Response(p, i);
                a(u);
                return;
                ...
                a(u);
                return;
            } u = new Response(p, i); a(u); })); writeToStream(g, s); })); }
            ...
            function mapChars(e, t, a) { var p = false; var i = ""; var s = countSymbols(e); for (var o = 0; o < s; ++o) {
            ...
            function TunnelingAgent(e) { var t = this; t.options = e || {}; t.proxyOptions = t.options.proxy || {}; t.maxSockets = t.options.maxSockets || r.Agent.defaultMaxSockets; t.requests = []; t.sockets = []; t.on("free", (function onFree(e, a, p, i) { var r = toOptions(a, p, i); for (var s = 0, o = t.requests.length; s < o; ++s) {
                var d = t.requests[s];
            ...
            function createSecureSocket(e, t) { var a = this; TunnelingAgent.prototype.createSocket.call(a, e, (function (p) { var r = e.request.getHeader("host"); var s = mergeOptions({}, a.options, { socket: p, servername: r ? r.replace(/:.*$/, "") : e.host }); var o = i.connect(0, s); a.sockets[a.sockets.indexOf(p)] = o; t(o); })); }
            ...
            var o = 0;
            var d = 0;
            function v1(e, t, a) { var n = t && a || 0; var l = t || new Array(16); e = e || {}; var m = e.node || r; var u = e.clockseq !== undefined ? e.clockseq : s; if (m == null || u == null) {
                var t_23 = e.random || (e.rng || p["default"])();
                if (m == null) {
                    m = r = [t_23[0] | 1, t_23[1], t_23[2], t_23[3], t_23[4], t_23[5]];
                }
                if (u == null) {
                    u = s = (t_23[6] << 8 | t_23[7]) & 16383;
                }
            } var h = e.msecs !== undefined ? e.msecs : Date.now(); var v = e.nsecs !== undefined ? e.nsecs : d + 1; var g = h - o + (v - d) / 1e4; if (g < 0 && e.clockseq === undefined) {
                u = u + 1 & 16383;
            } if ((g < 0 || h > o) && e.nsecs === undefined) {
                v = 0;
            } if (v >= 1e4) {
                throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
            } o = h; d = v; s = u; h += 122192928e5; var w = ((h & 268435455) * 1e4 + v) % 4294967296; l[n++] = w >>> 24 & 255; l[n++] = w >>> 16 & 255; l[n++] = w >>> 8 & 255; l[n++] = w & 255; var _ = h / 4294967296 * 1e4 & 268435455; l[n++] = _ >>> 8 & 255; l[n++] = _ & 255; l[n++] = _ >>> 24 & 15 | 16; l[n++] = _ >>> 16 & 255; l[n++] = u >>> 8 | 128; l[n++] = u & 255; for (var e_27 = 0; e_27 < 6; ++e_27) {
                l[n + e_27] = m[e_27];
            ...
            t.URL = s;
            function _default(e, t, a) { function generateUUID(e, r, s, o) { if (typeof e === "string") {
                e = stringToBytes(e);
            } if (typeof r === "string") {
                r = (0, i["default"])(r);
            } if (r.length !== 16) {
            ...
            function createNumberConversion(e, t) { if (!t.unsigned) {
                ...
                return 0;
            } o = sign(o) * Math.floor(Math.abs(o)); o = o % i; if (!t.unsigned && o >= r) {
                return o - i;
            }
            else if (t.unsigned) {
                if (o < 0) {
            ...
            function URLStateMachine(e, t, a, i, r) { this.pointer = 0; this.input = e; this.base = t || null; this.encodingOverride = a || "utf-8"; this.stateOverride = r; this.url = i; this.failure = false; this.parseError = false; if (!this.url) {
                ...
                this.parseError = true;
            } this.input = o; this.state = r || "scheme start"; this.buffer = ""; this.atFlag = false; this.arrFlag = false; this.passwordTokenSeenFlag = false; this.input = p.ucs2.decode(this.input); for (; this.pointer <= this.input.length; ++this.pointer) {
        ...
        } return p; } } }, 8891: function (e, t, a) {
            "use strict";
            var p = this && this.__importDefault || function (e) { return e && e.__esModule ? e : { "default": e }; };
            Object.defineProperty(t, "__esModule", { value: true });
            var i = a(5681);
            var r = a(4128);
            var s = p(a(9519));
            var o = process.env.GITHUB_TOKEN;
            var d = /(?:\/\d{4}\/(?:\d{4}-\d{2}-\d{2}|\d{2}\/\d{2})\/[a-z0-9]{20,}|current)\.js$/;
            var n = "current.js";
            function run() {
                return __awaiter(this, void 0, void 0, function () { var e, t, a, p, l, m, u, h, _a, v, g, w, _, b, E, _b, T, y, S, k, x, P, A, C, D, e_51; return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _c.trys.push([0, 6, , 7]);
                            if (!o)
                        ...
                        case 1:
                            ...
                            E = (e = b.data.files) === null || e === void 0 ? void 0 : e[0];
                            if (!E || (E === null || E === void 0 ? void 0 : E.status) !== "modified")
                                return [2 /*return*/, (0, i.info)("not a build commit")];
                            _b = (a = (t = b === null || b === void 0 ? void 0 : b.data) === null || t === void 0 ? void 0 : t.files) === null || a === void 0 ? void 0 : a[0], T = _b.blob_url, y = _b.sha;
                        ...
                        case 2:
                            S = _c.sent();
                            k = (u = (m = (l = (p = S === null || S === void 0 ? void 0 : S.data) === null || p === void 0 ? void 0 : p.tree) === null || l === void 0 ? void 0 : l.find) === null || m === void 0 ? void 0 : m.call(l, (function (e) { return e.path === n; }))) === null || u === void 0 ? void 0 : u.sha;
                            if (!k)
                                return [2 /*return*/, (0, i.info)("no current file")];
                            return [4 /*yield*/, h.rest.git.getBlob({ owner: v, repo: g, file_sha: k })];
                        case 3:
                            x = _c.sent();
                            return [4 /*yield*/, h.rest.git.getBlob({ owner: v, repo: g, file_sha: y })];
                        case 4:
                            P = _c.sent();
                            A = Buffer.from(x.data.content, "base64").toString("utf8");
                            C = Buffer.from(P.data.content, "base64").toString("utf8");
                            if ((0, i.isDebug)()) {
                                (0, i.debug)("".concat(A.length));
                                (0, i.debug)("".concat(C.length));
                            }
                            D = void 0;
                            try {
                                D = (0, s["default"])(A, C, "codeblock");
                            }
                            catch (e) {
                            ...
                            return [4 /*yield*/, h.rest.repos.createCommitComment({ owner: v, repo: g, commit_sha: _, body: D })];
                        case 5:
                            _c.sent();
                            return [2 /*return*/, (0, i.info)("created commit comment")];
                        case 6:
                            e_51 = _c.sent();
                            (0, i.setFailed)((0, i.isDebug)() ? e_51.stack : e_51.message);
                            return [3 /*break*/, 7];
            ...
            "use strict";
            a.r(t);
            a.d(t, { "default": function () { return et; } });
            ...
            var d = "break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this";
            var n = { 5: d, "5module": d + " export import", 6: d + " const class extends export import super" };
            var l = /^in(stanceof)?$/;
            var m = new RegExp("[" + s + "]");
            var u = new RegExp("[" + s + r + "]");
            ...
            function isIdentifierChar(e, t) { if (e < 48) {
                ...
                return false;
            } return isInAstralSet(e, i) || isInAstralSet(e, p); }
            ...
            function nextLineBreak(e, t, a) { if (a === void 0)
                ...
                if (isNewLine(i)) {
                    return p < a - 1 && i === 13 && e.charCodeAt(p + 1) === 10 ? p + 2 : p + 1;
                }
            } return -1; }
            var T = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/;
            var y = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g;
            ...
            var x = S.toString;
            var P = Object.hasOwn || function (e, t) { return k.call(e, t); };
            var A = Array.isArray || function (e) { return x.call(e) === "[object Array]"; };
            ...
            var O = function SourceLocation(e, t, a) { this.start = t; this.end = a; if (e.sourceFile !== null) {
                this.source = e.sourceFile;
            } };
            function getLineInfo(e, t) { for (var a = 1, p = 0;;) {
                var i = nextLineBreak(e, p, t);
                if (i < 0) {
                    return new N(a, t - p);
                }
                ++a;
            ...
            var V = false;
            function getOptions(e) { var t = {}; for (var a in R) {
                t[a] = e && P(e, a) ? e[a] : R[a];
            ...
            function pushComment(e, t) { return function (a, p, i, r, s, o) { var d = { type: a ? "Block" : "Line", value: p, start: i, end: r }; if (e.locations) {
                d.loc = new O(this, s, o);
            } if (e.ranges) {
                d.range = [i, r];
            } t.push(d); }; }
            var G = 1, I = 2, U = 4, L = 8, F = 16, B = 32, j = 64, q = 128, H = 256, M = G | I | H;
            function functionFlags(e, t) { return I | (e ? U : 0) | (t ? L : 0); }
            var z = 0, $ = 1, W = 2, K = 3, J = 4, Q = 5;
            var Y = function Parser(e, t, a) { this.options = e = getOptions(e); this.sourceFile = e.sourceFile; this.keywords = wordsRegexp(n[e.ecmaVersion >= 6 ? 6 : e.sourceType === "module" ? "5module" : 5]); var p = ""; if (e.allowReserved !== true) {
                p = o[e.ecmaVersion >= 6 ? 6 : e.ecmaVersion === 5 ? 5 : 3];
                if (e.sourceType === "module") {
                    p += " await";
                }
            } this.reservedWords = wordsRegexp(p); var i = (p ? p + " " : "") + o.strict; this.reservedWordsStrict = wordsRegexp(i); this.reservedWordsStrictBind = wordsRegexp(i + " " + o.strictBind); this.input = String(t); this.containsEsc = false; if (a) {
                this.pos = a;
            ...
            } this.scopeStack = []; this.enterScope(G); this.regexpState = null; this.privateNameStack = []; };
            var Z = { inFunction: { configurable: true }, inGenerator: { configurable: true }, inAsync: { configurable: true }, canAwait: { configurable: true }, allowSuper: { configurable: true }, allowDirectSuper: { configurable: true }, treatFunctionsAsVar: { configurable: true }, allowNewDotTarget: { configurable: true }, inClassStaticBlock: { configurable: true } };
            Y.prototype.parse = function parse() { var e = this.options.program || this.startNode(); this.nextToken(); return this.parseTopLevel(e); };
            Z.inFunction.get = function () { return (this.currentVarScope().flags & I) > 0; };
            Z.inGenerator.get = function () { return (this.currentVarScope().flags & L) > 0 && !this.currentVarScope().inClassFieldInit; };
            Z.inAsync.get = function () { return (this.currentVarScope().flags & U) > 0 && !this.currentVarScope().inClassFieldInit; };
            Z.canAwait.get = function () { for (var e = this.scopeStack.length - 1; e >= 0; e--) {
            ...
            Z.allowSuper.get = function () { var e = this.currentThisScope(); var t = e.flags; var a = e.inClassFieldInit; return (t & j) > 0 || a || this.options.allowSuperOutsideMethod; };
            Z.allowDirectSuper.get = function () { return (this.currentThisScope().flags & q) > 0; };
            Z.treatFunctionsAsVar.get = function () { return this.treatFunctionsAsVarInScope(this.currentScope()); };
            Z.allowNewDotTarget.get = function () { var e = this.currentThisScope(); var t = e.flags; var a = e.inClassFieldInit; return (t & (I | H)) > 0 || a; };
            Z.inClassStaticBlock.get = function () { return (this.currentVarScope().flags & H) > 0; };
            Y.extend = function extend() { var e = [], t = arguments.length; while (t--)
                e[t] = arguments[t]; var a = this; for (var p = 0; p < e.length; p++) {
                a = e[p](a);
            } return a; };
            Y.parse = function parse(e, t) { return new this(t, e).parse(); };
            Y.parseExpressionAt = function parseExpressionAt(e, t, a) { var p = new this(a, e, t); p.nextToken(); return p.parseExpression(); };
            Y.tokenizer = function tokenizer(e, t) { return new this(t, e); };
            Object.defineProperties(Y.prototype, Z);
            var X = Y.prototype;
            var ee = /^(?:'((?:\\.|[^'\\])*?)'|"((?:\\.|[^"\\])*?)")/;
            X.strictDirective = function (e) { if (this.options.ecmaVersion < 5) {
                return false;
            } for (;;) {
                y.lastIndex = e;
                ...
                if ((t[1] || t[2]) === "use strict") {
                    ...
                    var a = y.exec(this.input), p = a.index + a[0].length;
                    var i = this.input.charAt(p);
                    return i === ";" || i === "}" || b.test(a[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(i) || i === "!" && this.input.charAt(p + 1) === "=");
                }
                e += t[0].length;
                y.lastIndex = e;
                e += y.exec(this.input)[0].length;
            ...
            X.eat = function (e) { if (this.type === e) {
                this.next();
                return true;
            }
            else {
            ...
            X.isContextual = function (e) { return this.type === _.name && this.value === e && !this.containsEsc; };
            X.eatContextual = function (e) { if (!this.isContextual(e)) {
                return false;
            } this.next(); return true; };
            X.expectContextual = function (e) { if (!this.eatContextual(e)) {
                this.unexpected();
            } };
            X.canInsertSemicolon = function () { return this.type === _.eof || this.type === _.braceR || b.test(this.input.slice(this.lastTokEnd, this.start)); };
            X.insertSemicolon = function () { if (this.canInsertSemicolon()) {
                if (this.options.onInsertedSemicolon) {
                    this.options.onInsertedSemicolon(this.lastTokEnd, this.lastTokEndLoc);
                }
                return true;
            } };
            X.semicolon = function () { if (!this.eat(_.semi) && !this.insertSemicolon()) {
                this.unexpected();
            } };
            X.afterTrailingComma = function (e, t) { if (this.type === e) {
            ...
            X.expect = function (e) { this.eat(e) || this.unexpected(); };
            X.unexpected = function (e) { this.raise(e != null ? e : this.start, "Unexpected token"); };
            ...
            X.checkPatternErrors = function (e, t) { if (!e) {
                return;
            ...
            X.checkExpressionErrors = function (e, t) { if (!e) {
                return false;
            ...
            X.checkYieldAwaitInDefaultParams = function () { if (this.yieldPos && (!this.awaitPos || this.yieldPos < this.awaitPos)) {
                this.raise(this.yieldPos, "Yield expression cannot be a default value");
            } if (this.awaitPos) {
                this.raise(this.awaitPos, "Await expression cannot be a default value");
            } };
            X.isSimpleAssignTarget = function (e) { if (e.type === "ParenthesizedExpression") {
            ...
            ae.parseTopLevel = function (e) { var t = Object.create(null); if (!e.body) {
                ...
                for (var p = 0, i = Object.keys(this.undefinedExports); p < i.length; p += 1) {
                    var r = i[p];
            ...
            var pe = { kind: "loop" }, ie = { kind: "switch" };
            ae.isLet = function (e) { if (this.options.ecmaVersion < 6 || !this.isContextual("let")) {
                return false;
            } y.lastIndex = this.pos; var t = y.exec(this.input); var a = this.pos + t[0].length, p = this.input.charCodeAt(a); if (p === 91 || p === 92) {
                return true;
            } if (e) {
                return false;
                ...
                var i = a + 1;
                while (isIdentifierChar(p = this.input.charCodeAt(i), true)) {
                    ++i;
                }
                if (p === 92 || p > 55295 && p < 56320) {
                    return true;
                }
                var r = this.input.slice(a, i);
                if (!l.test(r)) {
                    return true;
                }
            } return false; };
            ae.isAsyncFunction = function () { if (this.options.ecmaVersion < 8 || !this.isContextual("async")) {
                return false;
            } y.lastIndex = this.pos; var e = y.exec(this.input); var t = this.pos + e[0].length, a; return !b.test(this.input.slice(this.pos, t)) && this.input.slice(t, t + 8) === "function" && (t + 8 === this.input.length || !(isIdentifierChar(a = this.input.charCodeAt(t + 8)) || a > 55295 && a < 56320)); };
            ae.parseStatement = function (e, t, a) { var p = this.type, i = this.startNode(), r; if (this.isLet(e)) {
                p = _._var;
                r = "let";
            } switch (p) {
                case _._break:
                case _._continue: return this.parseBreakContinueStatement(i, p.keyword);
                case _._debugger: return this.parseDebuggerStatement(i);
                case _._do: return this.parseDoStatement(i);
                case _._for: return this.parseForStatement(i);
                case _._function:
                ...
                case _._if: return this.parseIfStatement(i);
                case _._return: return this.parseReturnStatement(i);
                case _._switch: return this.parseSwitchStatement(i);
                case _._throw: return this.parseThrowStatement(i);
                case _._try: return this.parseTryStatement(i);
                case _._const:
                case _._var:
                    r = r || this.value;
                    if (e && r !== "var") {
                ...
                case _._while: return this.parseWhileStatement(i);
                case _._with: return this.parseWithStatement(i);
                case _.braceL: return this.parseBlock(true, i);
                case _.semi: return this.parseEmptyStatement(i);
                case _._export:
                case _._import:
                    if (this.options.ecmaVersion > 10 && p === _._import) {
                        y.lastIndex = this.pos;
                        var s = y.exec(this.input);
                        var o = this.pos + s[0].length, d = this.input.charCodeAt(o);
                        if (d === 40 || d === 46) {
                    ...
                    return p === _._import ? this.parseImport(i) : this.parseExport(i, a);
                default:
                    ...
                    if (p === _.name && l.type === "Identifier" && this.eat(_.colon)) {
                        return this.parseLabeledStatement(i, n, l, e);
                    }
                    else {
                        return this.parseExpressionStatement(i, l);
                    }
            } };
            ...
            ae.parseDoStatement = function (e) { this.next(); this.labels.push(pe); e.body = this.parseStatement("do"); this.labels.pop(); this.expect(_._while); e.test = this.parseParenExpression(); if (this.options.ecmaVersion >= 6) {
                this.eat(_.semi);
            }
            else {
                this.semicolon();
            } return this.finishNode(e, "DoWhileStatement"); };
            ae.parseForStatement = function (e) { this.next(); var t = this.options.ecmaVersion >= 9 && this.canAwait && this.eatContextual("await") ? this.lastTokStart : -1; this.labels.push(pe); this.enterScope(0); this.expect(_.parenL); if (this.type === _.semi) {
                if (t > -1) {
                    this.unexpected(t);
                }
                return this.parseFor(e, null);
            } var a = this.isLet(); if (this.type === _._var || this.type === _._const || a) {
                var p = this.startNode(), i = a ? "let" : this.value;
                this.next();
                this.parseVar(p, true, i);
                this.finishNode(p, "VariableDeclaration");
                if ((this.type === _._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) && p.declarations.length === 1) {
            ...
            } var r = this.isContextual("let"), s = false; var o = new te; var d = this.parseExpression(t > -1 ? "await" : true, o); if (this.type === _._in || (s = this.options.ecmaVersion >= 6 && this.isContextual("of"))) {
                if (this.options.ecmaVersion >= 9) {
                    if (this.type === _._in) {
                        if (t > -1) {
                            this.unexpected(t);
            ...
            ae.parseFunctionStatement = function (e, t, a) { this.next(); return this.parseFunction(e, se | (a ? 0 : oe), false, t); };
            ...
            ae.parseSwitchStatement = function (e) { this.next(); e.discriminant = this.parseParenExpression(); e.cases = []; this.expect(_.braceL); this.labels.push(ie); this.enterScope(0); var t; for (var a = false; this.type !== _.braceR;) {
                if (this.type === _._case || this.type === _._default) {
                    var p = this.type === _._case;
                    if (t) {
            ...
            var re = [];
            ae.parseCatchClauseParam = function () { var e = this.parseBindingAtom(); var t = e.type === "Identifier"; this.enterScope(t ? B : 0); this.checkLValPattern(e, t ? J : W); this.expect(_.parenR); return e; };
            ...
            ae.parseWhileStatement = function (e) { this.next(); e.test = this.parseParenExpression(); this.labels.push(pe); e.body = this.parseStatement("while"); this.labels.pop(); return this.finishNode(e, "WhileStatement"); };
            ...
            ae.parseLabeledStatement = function (e, t, a, p) { for (var i = 0, r = this.labels; i < r.length; i += 1) {
                var s = r[i];
                if (s.name === t) {
                    this.raise(a.start, "Label '" + t + "' is already declared");
                }
            } var o = this.type.isLoop ? "loop" : this.type === _._switch ? "switch" : null; for (var d = this.labels.length - 1; d >= 0; d--) {
                var n = this.labels[d];
            ...
            ae.parseVar = function (e, t, a, p) { e.declarations = []; e.kind = a; for (;;) {
                var i = this.startNode();
                this.parseVarId(i, a);
                if (this.eat(_.eq)) {
                    i.init = this.parseMaybeAssign(t);
                }
                else if (!p && a === "const" && !(this.type === _._in || this.options.ecmaVersion >= 6 && this.isContextual("of"))) {
                    this.unexpected();
                }
                else if (!p && i.id.type !== "Identifier" && !(t && (this.type === _._in || this.isContextual("of")))) {
            ...
            var se = 1, oe = 2, de = 4;
            ae.parseFunction = function (e, t, a, p, i) { this.initFunction(e); if (this.options.ecmaVersion >= 9 || this.options.ecmaVersion >= 6 && !p) {
                ...
                e.id = t & de && this.type !== _.name ? null : this.parseIdent();
                if (e.id && !(t & oe)) {
                    this.checkLValSimple(e.id, this.strict || e.generator || e.async ? this.treatFunctionsAsVar ? $ : W : K);
                }
            } var r = this.yieldPos, s = this.awaitPos, o = this.awaitIdentPos; this.yieldPos = 0; this.awaitPos = 0; this.awaitIdentPos = 0; this.enterScope(functionFlags(e.async, e.generator)); if (!(t & se)) {
                e.id = this.type === _.name ? this.parseIdent() : null;
            } this.parseFunctionParams(e); this.parseFunctionBody(e, a, false, i); this.yieldPos = r; this.awaitPos = s; this.awaitIdentPos = o; return this.finishNode(e, t & se ? "FunctionDeclaration" : "FunctionExpression"); };
            ...
            ae.parseClass = function (e, t) { this.next(); var a = this.strict; this.strict = true; this.parseClassId(e, t); this.parseClassSuper(e); var p = this.enterClassBody(); var i = this.startNode(); var r = false; i.body = []; this.expect(_.braceL); while (this.type !== _.braceR) {
                var s = this.parseClassElement(e.superClass !== null);
                if (s) {
                    i.body.push(s);
                    if (s.type === "MethodDefinition" && s.kind === "constructor") {
                        if (r) {
                            this.raiseRecoverable(s.start, "Duplicate constructor in the same class");
                        }
                        r = true;
                    }
                    else if (s.key && s.key.type === "PrivateIdentifier" && isPrivateNameConflicted(p, s)) {
                        this.raiseRecoverable(s.key.start, "Identifier '#" + s.key.name + "' has already been declared");
                    }
                }
            } this.strict = a; this.next(); e.body = this.finishNode(i, "ClassBody"); this.exitClassBody(); return this.finishNode(e, t ? "ClassDeclaration" : "ClassExpression"); };
            ae.parseClassElement = function (e) { if (this.eat(_.semi)) {
                return null;
            } var t = this.options.ecmaVersion; var a = this.startNode(); var p = ""; var i = false; var r = false; var s = "method"; var o = false; if (this.eatContextual("static")) {
            ...
            ae.parseClassMethod = function (e, t, a, p) { var i = e.key; if (e.kind === "constructor") {
                if (t) {
            ...
            } var r = e.value = this.parseMethod(t, a, p); if (e.kind === "get" && r.params.length !== 0) {
            ...
            ae.parseClassStaticBlock = function (e) { e.body = []; var t = this.labels; this.labels = []; this.enterScope(H | j); while (this.type !== _.braceR) {
            ...
            ae.exitClassBody = function () { var e = this.privateNameStack.pop(); var t = e.declared; var a = e.used; if (!this.options.checkPrivateFields) {
                return;
            } var p = this.privateNameStack.length; var i = p === 0 ? null : this.privateNameStack[p - 1]; for (var r = 0; r < a.length; ++r) {
                var s = a[r];
                if (!P(t, s.name)) {
                    if (i) {
                        i.used.push(s);
                        ...
                        this.raiseRecoverable(s.start, "Private field '#" + s.name + "' must be declared in an enclosing class");
                    }
                }
            } };
            function isPrivateNameConflicted(e, t) { var a = t.key.name; var p = e[a]; var i = "true"; if (t.type === "MethodDefinition" && (t.kind === "get" || t.kind === "set")) {
                i = (t.static ? "s" : "i") + t.kind;
            } if (p === "iget" && i === "iset" || p === "iset" && i === "iget" || p === "sget" && i === "sset" || p === "sset" && i === "sget") {
                e[a] = "true";
                return false;
            }
            else if (!p) {
            ...
            ae.parseExport = function (e, t) { this.next(); if (this.eat(_.star)) {
                ...
                if (this.eatContextual("from")) {
                    ...
                    for (var a = 0, p = e.specifiers; a < p.length; a += 1) {
                        var i = p[a];
            ...
            ae.parseExportDefaultDeclaration = function () { var e; if (this.type === _._function || (e = this.isAsyncFunction())) {
                ...
                return this.parseFunction(t, se | de, false, e);
            }
            ...
            ae.checkPatternExport = function (e, t) { var a = t.type; if (a === "Identifier") {
                ...
                for (var p = 0, i = t.properties; p < i.length; p += 1) {
                    var r = i[p];
            ...
            ae.parseImportDefaultSpecifier = function () { var e = this.startNode(); e.local = this.parseIdent(); this.checkLValSimple(e.local, W); return this.finishNode(e, "ImportDefaultSpecifier"); };
            ae.parseImportNamespaceSpecifier = function () { var e = this.startNode(); this.next(); this.expectContextual("as"); e.local = this.parseIdent(); this.checkLValSimple(e.local, W); return this.finishNode(e, "ImportNamespaceSpecifier"); };
            ...
            ne.toAssignable = function (e, t, a) { if (this.options.ecmaVersion >= 6 && e) {
                switch (e.type) {
                    ...
                    case "ObjectExpression":
                        ...
                        for (var p = 0, i = e.properties; p < i.length; p += 1) {
                            var r = i[p];
            ...
            ne.toAssignableList = function (e, t) { var a = e.length; for (var p = 0; p < a; p++) {
                var i = e[p];
                if (i) {
            ...
            ne.parseRestBinding = function () { var e = this.startNode(); this.next(); if (this.options.ecmaVersion === 6 && this.type !== _.name) {
                this.unexpected();
            ...
            ne.parseBindingList = function (e, t, a, p) { var i = [], r = true; while (!this.eat(e)) {
                if (r) {
                    r = false;
                }
                else {
                ...
                if (t && this.type === _.comma) {
                    ...
                    i.push(this.parseAssignableListItem(p));
                }
            } return i; };
            ...
            ne.parseMaybeDefault = function (e, t, a) { a = a || this.parseBindingAtom(); if (this.options.ecmaVersion < 6 || !this.eat(_.eq)) {
                return a;
            ...
            var le = function TokContext(e, t, a, p, i) { this.token = e; this.isExpr = !!t; this.preserveSpace = !!a; this.override = p; this.generator = !!i; };
            var me = { b_stat: new le("{", false), b_expr: new le("{", true), b_tmpl: new le("${", false), p_stat: new le("(", false), p_expr: new le("(", true), q_tmpl: new le("`", true, true, (function (e) { return e.tryReadTemplateToken(); })), f_stat: new le("function", false), f_expr: new le("function", true), f_expr_gen: new le("function", true, false, null, true), f_gen: new le("function", false, false, null, true) };
            var ue = Y.prototype;
            ue.initialContext = function () { return [me.b_stat]; };
            ue.curContext = function () { return this.context[this.context.length - 1]; };
            ue.braceIsBlock = function (e) { var t = this.curContext(); if (t === me.f_expr || t === me.f_stat) {
                return true;
            } if (e === _.colon && (t === me.b_stat || t === me.b_expr)) {
                return !t.isExpr;
            ...
            ue.inGeneratorContext = function () { for (var e = this.context.length - 1; e >= 1; e--) {
                var t = this.context[e];
                if (t.token === "function") {
                    return t.generator;
                }
            } return false; };
            ue.updateContext = function (e) { var t, a = this.type; if (a.keyword && e === _.dot) {
            ...
            ue.overrideContext = function (e) { if (this.curContext() !== e) {
                this.context[this.context.length - 1] = e;
            } };
            _.parenR.updateContext = _.braceR.updateContext = function () { if (this.context.length === 1) {
                this.exprAllowed = true;
                return;
            } var e = this.context.pop(); if (e === me.b_stat && this.curContext().token === "function") {
                e = this.context.pop();
            } this.exprAllowed = !e.isExpr; };
            _.braceL.updateContext = function (e) { this.context.push(this.braceIsBlock(e) ? me.b_stat : me.b_expr); this.exprAllowed = true; };
            _.dollarBraceL.updateContext = function () { this.context.push(me.b_tmpl); this.exprAllowed = true; };
            _.parenL.updateContext = function (e) { var t = e === _._if || e === _._for || e === _._with || e === _._while; this.context.push(t ? me.p_stat : me.p_expr); this.exprAllowed = true; };
            _.incDec.updateContext = function () { };
            _._function.updateContext = _._class.updateContext = function (e) { if (e.beforeExpr && e !== _._else && !(e === _.semi && this.curContext() !== me.p_stat) && !(e === _._return && b.test(this.input.slice(this.lastTokEnd, this.start))) && !((e === _.colon || e === _.braceL) && this.curContext() === me.b_stat)) {
                this.context.push(me.f_expr);
            }
            else {
                this.context.push(me.f_stat);
            } this.exprAllowed = false; };
            _.colon.updateContext = function () { if (this.curContext().token === "function") {
                this.context.pop();
            } this.exprAllowed = true; };
            _.backQuote.updateContext = function () { if (this.curContext() === me.q_tmpl) {
                this.context.pop();
            }
            else {
                this.context.push(me.q_tmpl);
            } this.exprAllowed = false; };
            _.star.updateContext = function (e) { if (e === _._function) {
                var t = this.context.length - 1;
                if (this.context[t] === me.f_expr) {
                    this.context[t] = me.f_expr_gen;
                }
                else {
                    this.context[t] = me.f_gen;
                }
            } this.exprAllowed = true; };
            ...
            var ce = Y.prototype;
            ce.checkPropClash = function (e, t, a) { if (this.options.ecmaVersion >= 9 && e.type === "SpreadElement") {
                return;
            } if (this.options.ecmaVersion >= 6 && (e.computed || e.method || e.shorthand)) {
                return;
            } var p = e.key; var i; switch (p.type) {
                case "Identifier":
                    i = p.name;
                    break;
                case "Literal":
                ...
                s = t[i] = { init: false, get: false, set: false };
            } s[r] = true; };
            ce.parseExpression = function (e, t) { var a = this.start, p = this.startLoc; var i = this.parseMaybeAssign(e, t); if (this.type === _.comma) {
                var r = this.startNodeAt(a, p);
                r.expressions = [i];
            ...
            ce.parseMaybeAssign = function (e, t, a) { if (this.isContextual("yield")) {
                if (this.inGenerator) {
                ...
                t = new te;
                p = true;
            } var o = this.start, d = this.startLoc; if (this.type === _.parenL || this.type === _.name) {
            ...
            ce.parseMaybeConditional = function (e, t) { var a = this.start, p = this.startLoc; var i = this.parseExprOps(e, t); if (this.checkExpressionErrors(t)) {
                return i;
            ...
            ce.parseExprOps = function (e, t) { var a = this.start, p = this.startLoc; var i = this.parseMaybeUnary(t, false, false, e); if (this.checkExpressionErrors(t)) {
                return i;
            } return i.start === a && i.type === "ArrowFunctionExpression" ? i : this.parseExprOp(i, a, p, -1, e); };
            ce.parseExprOp = function (e, t, a, p, i) { var r = this.type.binop; if (r != null && (!i || this.type !== _._in)) {
                if (r > p) {
                    var s = this.type === _.logicalOR || this.type === _.logicalAND;
                    var o = this.type === _.coalesce;
                    if (o) {
                    ...
                    var m = this.parseExprOp(this.parseMaybeUnary(null, false, false, i), n, l, r, i);
                    var u = this.buildBinary(t, a, e, m, d, s || o);
                    if (s && this.type === _.coalesce || o && (this.type === _.logicalOR || this.type === _.logicalAND)) {
                        this.raiseRecoverable(this.start, "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses");
                    }
                    return this.parseExprOp(u, t, a, p, i);
                }
            } return e; };
            ce.buildBinary = function (e, t, a, p, i, r) { if (p.type === "PrivateIdentifier") {
                this.raise(p.start, "Private identifier can only be left side of binary expression");
            } var s = this.startNodeAt(e, t); s.left = a; s.operator = i; s.right = p; return this.finishNode(s, r ? "LogicalExpression" : "BinaryExpression"); };
            ce.parseMaybeUnary = function (e, t, a, p) { var i = this.start, r = this.startLoc, s; if (this.isContextual("await") && this.canAwait) {
                s = this.parseAwait(p);
                t = true;
            }
            else if (this.type.prefix) {
                var o = this.startNode(), d = this.type === _.incDec;
                ...
                s = this.finishNode(o, d ? "UpdateExpression" : "UnaryExpression");
            }
            else if (!t && this.type === _.privateId) {
                if ((p || this.privateNameStack.length === 0) && this.options.checkPrivateFields) {
                    this.unexpected();
                }
                ...
                s = this.parseExprSubscripts(e, p);
                ...
                if (t) {
                    ...
                    return this.buildBinary(i, r, s, this.parseMaybeUnary(null, false, false, p), "**", false);
                }
            }
            else {
                return s;
            ...
            ce.parseExprSubscripts = function (e, t) { var a = this.start, p = this.startLoc; var i = this.parseExprAtom(e, t); if (i.type === "ArrowFunctionExpression" && this.input.slice(this.lastTokStart, this.lastTokEnd) !== ")") {
                return i;
            } var r = this.parseSubscripts(i, a, p, false, t); if (e && r.type === "MemberExpression") {
            ...
            ce.parseSubscripts = function (e, t, a, p, i) { var r = this.options.ecmaVersion >= 8 && e.type === "Identifier" && e.name === "async" && this.lastTokEnd === e.end && !this.canInsertSemicolon() && e.end - e.start === 5 && this.potentialArrowAt === e.start; var s = false; while (true) {
                var o = this.parseSubscript(e, t, a, p, r, s, i);
                if (o.optional) {
                    s = true;
                }
            ...
            ce.shouldParseAsyncArrow = function () { return !this.canInsertSemicolon() && this.eat(_.arrow); };
            ce.parseSubscriptAsyncArrow = function (e, t, a, p) { return this.parseArrowExpression(this.startNodeAt(e, t), a, true, p); };
            ce.parseSubscript = function (e, t, a, p, i, r, s) { var o = this.options.ecmaVersion >= 11; var d = o && this.eat(_.questionDot); if (p && d) {
                this.raise(this.lastTokStart, "Optional chaining cannot appear in the callee of new expressions");
            } var n = this.eat(_.bracketL); if (n || d && this.type !== _.parenL && this.type !== _.backQuote || this.eat(_.dot)) {
            ...
            else if (!p && this.eat(_.parenL)) {
                var m = new te, u = this.yieldPos, h = this.awaitPos, v = this.awaitIdentPos;
                this.yieldPos = 0;
                this.awaitPos = 0;
                this.awaitIdentPos = 0;
                var g = this.parseExprList(_.parenR, this.options.ecmaVersion >= 8, false, m);
                if (i && !d && this.shouldParseAsyncArrow()) {
                    ...
                    return this.parseSubscriptAsyncArrow(t, a, g, s);
                }
            ...
            ce.parseExprAtom = function (e, t, a) { if (this.type === _.slash) {
                this.readRegexp();
            } var p, i = this.potentialArrowAt === this.start; switch (this.type) {
                case _._super:
                    if (!this.allowSuper) {
                    ...
                    return this.finishNode(p, "Super");
                case _._this:
                    p = this.startNode();
                    this.next();
                    return this.finishNode(p, "ThisExpression");
                case _.name:
                    var r = this.start, s = this.startLoc, o = this.containsEsc;
                    var d = this.parseIdent(false);
                    if (this.options.ecmaVersion >= 8 && !o && d.name === "async" && !this.canInsertSemicolon() && this.eat(_._function)) {
                        this.overrideContext(me.f_expr);
                        return this.parseFunction(this.startNodeAt(r, s), 0, false, true, t);
                    }
                    if (i && !this.canInsertSemicolon()) {
                        if (this.eat(_.arrow)) {
                            return this.parseArrowExpression(this.startNodeAt(r, s), [d], false, t);
                        }
                        if (this.options.ecmaVersion >= 8 && d.name === "async" && this.type === _.name && !o && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc)) {
                            d = this.parseIdent(false);
                            if (this.canInsertSemicolon() || !this.eat(_.arrow)) {
                                this.unexpected();
                            }
                            return this.parseArrowExpression(this.startNodeAt(r, s), [d], true, t);
                        }
                    }
                    return d;
                case _.regexp:
                    var n = this.value;
                    p = this.parseLiteral(n.value);
                    p.regex = { pattern: n.pattern, flags: n.flags };
                    return p;
                case _.num:
                ...
                case _._false:
                    p = this.startNode();
                    p.value = this.type === _._null ? null : this.type === _._true;
                    p.raw = this.type.keyword;
                    this.next();
                    return this.finishNode(p, "Literal");
                case _.parenL:
                    var l = this.start, m = this.parseParenAndDistinguishExpression(i, t);
                    if (e) {
                        if (e.parenthesizedAssign < 0 && !this.isSimpleAssignTarget(m)) {
                ...
                case _.bracketL:
                    p = this.startNode();
                    this.next();
                    p.elements = this.parseExprList(_.bracketR, true, true, e);
                    return this.finishNode(p, "ArrayExpression");
                case _.braceL:
                    this.overrideContext(me.b_expr);
                    return this.parseObj(false, e);
                case _._function:
                    p = this.startNode();
                    this.next();
                    return this.parseFunction(p, 0);
            ...
            ce.parseExprAtomDefault = function () { this.unexpected(); };
            ce.parseExprImport = function (e) { var t = this.startNode(); if (this.containsEsc) {
            ...
            ce.parseDynamicImport = function (e) { this.next(); e.source = this.parseMaybeAssign(); if (!this.eat(_.parenR)) {
                var t = this.start;
            ...
            ce.parseImportMeta = function (e) { this.next(); var t = this.containsEsc; e.property = this.parseIdent(true); if (e.property.name !== "meta") {
            ...
            ce.parseLiteral = function (e) { var t = this.startNode(); t.value = e; t.raw = this.input.slice(this.start, this.end); if (t.raw.charCodeAt(t.raw.length - 1) === 110) {
                t.bigint = t.raw.slice(0, -1).replace(/_/g, "");
            } this.next(); return this.finishNode(t, "Literal"); };
            ce.parseParenExpression = function () { this.expect(_.parenL); var e = this.parseExpression(); this.expect(_.parenR); return e; };
            ce.shouldParseArrow = function (e) { return !this.canInsertSemicolon(); };
            ce.parseParenAndDistinguishExpression = function (e, t) { var a = this.start, p = this.startLoc, i, r = this.options.ecmaVersion >= 8; if (this.options.ecmaVersion >= 6) {
                this.next();
                var s = this.start, o = this.startLoc;
                var d = [], n = true, l = false;
                var m = new te, u = this.yieldPos, h = this.awaitPos, v;
                this.yieldPos = 0;
                this.awaitPos = 0;
                while (this.type !== _.parenR) {
                    n ? n = false : this.expect(_.comma);
                ...
                if (e && this.shouldParseArrow(d) && this.eat(_.arrow)) {
                    this.checkPatternErrors(m, false);
                    this.checkYieldAwaitInDefaultParams();
                    this.yieldPos = u;
                    this.awaitPos = h;
                ...
                this.awaitPos = h || this.awaitPos;
                if (d.length > 1) {
                    i = this.startNodeAt(s, o);
                    i.expressions = d;
                    this.finishNodeAt(i, "SequenceExpression", g, w);
                }
                else {
                    i = d[0];
                }
            ...
            ce.parseParenItem = function (e) { return e; };
            ce.parseParenArrowList = function (e, t, a, p) { return this.parseArrowExpression(this.startNodeAt(e, t), a, false, p); };
            var he = [];
            ce.parseNew = function () { if (this.containsEsc) {
                ...
                return this.finishNode(e, "MetaProperty");
            } var p = this.start, i = this.startLoc; e.callee = this.parseSubscripts(this.parseExprAtom(null, false, true), p, i, true, false); if (this.eat(_.parenL)) {
                e.arguments = this.parseExprList(_.parenR, this.options.ecmaVersion >= 8, false);
            }
            else {
                e.arguments = he;
            } return this.finishNode(e, "NewExpression"); };
            ce.parseTemplateElement = function (e) { var t = e.isTagged; var a = this.startNode(); if (this.type === _.invalidTemplate) {
                if (!t) {
            ...
            ce.parseTemplate = function (e) { if (e === void 0)
            ...
            ce.isAsyncProp = function (e) { return !e.computed && e.key.type === "Identifier" && e.key.name === "async" && (this.type === _.name || this.type === _.num || this.type === _.string || this.type === _.bracketL || this.type.keyword || this.options.ecmaVersion >= 9 && this.type === _.star) && !b.test(this.input.slice(this.lastTokEnd, this.start)); };
            ce.parseObj = function (e, t) { var a = this.startNode(), p = true, i = {}; a.properties = []; this.next(); while (!this.eat(_.braceR)) {
                if (!p) {
                    this.expect(_.comma);
                ...
                if (!e) {
                    this.checkPropClash(r, i, t);
                }
                a.properties.push(r);
            } return this.finishNode(a, e ? "ObjectPattern" : "ObjectExpression"); };
            ce.parseProperty = function (e, t) { var a = this.startNode(), p, i, r, s; if (this.options.ecmaVersion >= 9 && this.eat(_.ellipsis)) {
                if (e) {
                ...
                i = true;
                p = this.options.ecmaVersion >= 9 && this.eat(_.star);
                this.parsePropertyName(a);
            }
            else {
                i = false;
            } this.parsePropertyValue(a, e, p, i, r, s, t, o); return this.finishNode(a, "Property"); };
            ce.parseGetterSetter = function (e) { e.kind = e.key.name; this.parsePropertyName(e); e.value = this.parseMethod(false); var t = e.kind === "get" ? 0 : 1; if (e.value.params.length !== t) {
                var a = e.value.start;
                if (e.kind === "get") {
            ...
            ce.parsePropertyValue = function (e, t, a, p, i, r, s, o) { if ((a || p) && this.type === _.colon) {
                this.unexpected();
            } if (this.eat(_.colon)) {
                e.value = t ? this.parseMaybeDefault(this.start, this.startLoc) : this.parseMaybeAssign(false, s);
                e.kind = "init";
            }
            ...
            else if (!t && !o && this.options.ecmaVersion >= 5 && !e.computed && e.key.type === "Identifier" && (e.key.name === "get" || e.key.name === "set") && (this.type !== _.comma && this.type !== _.braceR && this.type !== _.eq)) {
                if (a || p) {
                    this.unexpected();
                }
                ...
                e.kind = "init";
                if (t) {
                    e.value = this.parseMaybeDefault(i, r, this.copyNode(e.key));
                }
                else if (this.type === _.eq && s) {
                    if (s.shorthandAssign < 0) {
            ...
            ce.parsePropertyName = function (e) { if (this.options.ecmaVersion >= 6) {
            ...
            ce.initFunction = function (e) { e.id = null; if (this.options.ecmaVersion >= 6) {
                e.generator = e.expression = false;
            } if (this.options.ecmaVersion >= 8) {
                e.async = false;
            } };
            ce.parseMethod = function (e, t, a) { var p = this.startNode(), i = this.yieldPos, r = this.awaitPos, s = this.awaitIdentPos; this.initFunction(p); if (this.options.ecmaVersion >= 6) {
                p.generator = e;
            } if (this.options.ecmaVersion >= 8) {
                p.async = !!t;
            } this.yieldPos = 0; this.awaitPos = 0; this.awaitIdentPos = 0; this.enterScope(functionFlags(t, p.generator) | j | (a ? q : 0)); this.expect(_.parenL); p.params = this.parseBindingList(_.parenR, false, this.options.ecmaVersion >= 8); this.checkYieldAwaitInDefaultParams(); this.parseFunctionBody(p, false, true, false); this.yieldPos = i; this.awaitPos = r; this.awaitIdentPos = s; return this.finishNode(p, "FunctionExpression"); };
            ce.parseArrowExpression = function (e, t, a, p) { var i = this.yieldPos, r = this.awaitPos, s = this.awaitIdentPos; this.enterScope(functionFlags(a, false) | F); this.initFunction(e); if (this.options.ecmaVersion >= 8) {
                e.async = !!a;
            } this.yieldPos = 0; this.awaitPos = 0; this.awaitIdentPos = 0; e.params = this.toAssignableList(t, true); this.parseFunctionBody(e, true, false, p); this.yieldPos = i; this.awaitPos = r; this.awaitIdentPos = s; return this.finishNode(e, "ArrowFunctionExpression"); };
            ce.parseFunctionBody = function (e, t, a, p) { var i = t && this.type !== _.braceL; var r = this.strict, s = false; if (i) {
                ...
                this.checkParams(e, !r && !s && !t && !a && this.isSimpleParamList(e.params));
                if (this.strict && e.id) {
                    this.checkLValSimple(e.id, Q);
                }
                e.body = this.parseBlock(false, undefined, s && !r);
                e.expression = false;
                this.adaptDirectivePrologue(e.body.body);
                this.labels = d;
            } this.exitScope(); };
            ce.isSimpleParamList = function (e) { for (var t = 0, a = e; t < a.length; t += 1) {
                var p = a[t];
                if (p.type !== "Identifier") {
                    return false;
                }
            } return true; };
            ce.checkParams = function (e, t) { var a = Object.create(null); for (var p = 0, i = e.params; p < i.length; p += 1) {
                var r = i[p];
                this.checkLValInnerPattern(r, $, t ? null : a);
            } };
            ce.parseExprList = function (e, t, a, p) { var i = [], r = true; while (!this.eat(e)) {
                if (!r) {
                    this.expect(_.comma);
                ...
                if (a && this.type === _.comma) {
                    ...
                    s = this.parseSpread(p);
                    if (p && this.type === _.comma && p.trailingComma < 0) {
                        p.trailingComma = this.start;
                    }
                }
                else {
                    s = this.parseMaybeAssign(false, p);
                }
                i.push(s);
            } return i; };
            ce.checkUnreserved = function (e) { var t = e.start; var a = e.end; var p = e.name; if (this.inGenerator && p === "yield") {
                ...
                return;
            } var i = this.strict ? this.reservedWordsStrict : this.reservedWords; if (i.test(p)) {
                if (!this.inAsync && p === "await") {
            ...
            ce.parseIdent = function (e) { var t = this.parseIdentNode(); this.next(!!e); this.finishNode(t, "Identifier"); if (!e) {
                this.checkUnreserved(t);
                if (t.name === "await" && !this.awaitIdentPos) {
                    this.awaitIdentPos = t.start;
                }
            } return t; };
            ce.parseIdentNode = function () { var e = this.startNode(); if (this.type === _.name) {
                e.name = this.value;
            }
            ...
            ce.parsePrivateIdent = function () { var e = this.startNode(); if (this.type === _.privateId) {
                e.name = this.value;
            }
            else {
                this.unexpected();
            ...
            ce.parseYield = function (e) { if (!this.yieldPos) {
            ...
            ce.parseAwait = function (e) { if (!this.awaitPos) {
            ...
            var fe = Y.prototype;
            fe.raise = function (e, t) { var a = getLineInfo(this.input, e); t += " (" + a.line + ":" + a.column + ")"; var p = new SyntaxError(t); p.pos = e; p.loc = a; p.raisedAt = this.pos; throw p; };
            ...
            ve.treatFunctionsAsVarInScope = function (e) { return e.flags & I || !this.inModule && e.flags & G; };
            ve.declareName = function (e, t, a) { var p = false; if (t === W) {
                var i = this.currentScope();
                p = i.lexical.indexOf(e) > -1 || i.functions.indexOf(e) > -1 || i["var"].indexOf(e) > -1;
                i.lexical.push(e);
                if (this.inModule && i.flags & G) {
                ...
                if (this.treatFunctionsAsVar) {
                    p = s.lexical.indexOf(e) > -1;
                }
                else {
                    p = s.lexical.indexOf(e) > -1 || s["var"].indexOf(e) > -1;
                }
                s.functions.push(e);
            }
            else {
                for (var o = this.scopeStack.length - 1; o >= 0; --o) {
                    ...
                    if (d.lexical.indexOf(e) > -1 && !(d.flags & B && d.lexical[0] === e) || !this.treatFunctionsAsVarInScope(d) && d.functions.indexOf(e) > -1) {
                        p = true;
                        break;
                    }
                    d["var"].push(e);
                    if (this.inModule && d.flags & G) {
                        delete this.undefinedExports[e];
                    }
                    if (d.flags & M) {
                        break;
            ...
            _e.finishNodeAt = function (e, t, a, p) { return finishNodeAt.call(this, e, t, a, p); };
            ...
            var Ee = be + " Extended_Pictographic";
            var Te = Ee;
            var ye = Te + " EBase EComp EMod EPres ExtPict";
            var Se = ye;
            var ke = Se;
            var xe = { 9: be, 10: Ee, 11: Te, 12: ye, 13: Se, 14: ke };
            var Pe = "Basic_Emoji Emoji_Keycap_Sequence RGI_Emoji_Modifier_Sequence RGI_Emoji_Flag_Sequence RGI_Emoji_Tag_Sequence RGI_Emoji_ZWJ_Sequence RGI_Emoji";
            var Ae = { 9: "", 10: "", 11: "", 12: "", 13: "", 14: Pe };
            ...
            var De = "Adlam Adlm Ahom Anatolian_Hieroglyphs Hluw Arabic Arab Armenian Armn Avestan Avst Balinese Bali Bamum Bamu Bassa_Vah Bass Batak Batk Bengali Beng Bhaiksuki Bhks Bopomofo Bopo Brahmi Brah Braille Brai Buginese Bugi Buhid Buhd Canadian_Aboriginal Cans Carian Cari Caucasian_Albanian Aghb Chakma Cakm Cham Cham Cherokee Cher Common Zyyy Coptic Copt Qaac Cuneiform Xsux Cypriot Cprt Cyrillic Cyrl Deseret Dsrt Devanagari Deva Duployan Dupl Egyptian_Hieroglyphs Egyp Elbasan Elba Ethiopic Ethi Georgian Geor Glagolitic Glag Gothic Goth Grantha Gran Greek Grek Gujarati Gujr Gurmukhi Guru Han Hani Hangul Hang Hanunoo Hano Hatran Hatr Hebrew Hebr Hiragana Hira Imperial_Aramaic Armi Inherited Zinh Qaai Inscriptional_Pahlavi Phli Inscriptional_Parthian Prti Javanese Java Kaithi Kthi Kannada Knda Katakana Kana Kayah_Li Kali Kharoshthi Khar Khmer Khmr Khojki Khoj Khudawadi Sind Lao Laoo Latin Latn Lepcha Lepc Limbu Limb Linear_A Lina Linear_B Linb Lisu Lisu Lycian Lyci Lydian Lydi Mahajani Mahj Malayalam Mlym Mandaic Mand Manichaean Mani Marchen Marc Masaram_Gondi Gonm Meetei_Mayek Mtei Mende_Kikakui Mend Meroitic_Cursive Merc Meroitic_Hieroglyphs Mero Miao Plrd Modi Mongolian Mong Mro Mroo Multani Mult Myanmar Mymr Nabataean Nbat New_Tai_Lue Talu Newa Newa Nko Nkoo Nushu Nshu Ogham Ogam Ol_Chiki Olck Old_Hungarian Hung Old_Italic Ital Old_North_Arabian Narb Old_Permic Perm Old_Persian Xpeo Old_South_Arabian Sarb Old_Turkic Orkh Oriya Orya Osage Osge Osmanya Osma Pahawh_Hmong Hmng Palmyrene Palm Pau_Cin_Hau Pauc Phags_Pa Phag Phoenician Phnx Psalter_Pahlavi Phlp Rejang Rjng Runic Runr Samaritan Samr Saurashtra Saur Sharada Shrd Shavian Shaw Siddham Sidd SignWriting Sgnw Sinhala Sinh Sora_Sompeng Sora Soyombo Soyo Sundanese Sund Syloti_Nagri Sylo Syriac Syrc Tagalog Tglg Tagbanwa Tagb Tai_Le Tale Tai_Tham Lana Tai_Viet Tavt Takri Takr Tamil Taml Tangut Tang Telugu Telu Thaana Thaa Thai Thai Tibetan Tibt Tifinagh Tfng Tirhuta Tirh Ugaritic Ugar Vai Vaii Warang_Citi Wara Yi Yiii Zanabazar_Square Zanb";
            var Ne = De + " Dogra Dogr Gunjala_Gondi Gong Hanifi_Rohingya Rohg Makasar Maka Medefaidrin Medf Old_Sogdian Sogo Sogdian Sogd";
            var Oe = Ne + " Elymaic Elym Nandinagari Nand Nyiakeng_Puachue_Hmong Hmnp Wancho Wcho";
            var Re = Oe + " Chorasmian Chrs Diak Dives_Akuru Khitan_Small_Script Kits Yezi Yezidi";
            var Ve = Re + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith";
            var Ge = Ve + " Hrkt Katakana_Or_Hiragana Kawi Nag_Mundari Nagm Unknown Zzzz";
            var Ie = { 9: De, 10: Ne, 11: Oe, 12: Re, 13: Ve, 14: Ge };
            var Ue = {};
            function buildUnicodeData(e) { var t = Ue[e] = { binary: wordsRegexp(xe[e] + " " + Ce), binaryOfStrings: wordsRegexp(Ae[e]), nonBinary: { General_Category: wordsRegexp(Ce), Script: wordsRegexp(Ie[e]) } }; t.nonBinary.Script_Extensions = t.nonBinary.Script; t.nonBinary.gc = t.nonBinary.General_Category; t.nonBinary.sc = t.nonBinary.Script; t.nonBinary.scx = t.nonBinary.Script_Extensions; }
            for (var Le = 0, Fe = [9, 10, 11, 12, 13, 14]; Le < Fe.length; Le += 1) {
                var Be = Fe[Le];
                buildUnicodeData(Be);
            }
            var je = Y.prototype;
            ...
            qe.prototype.reset = function reset(e, t, a) { var p = a.indexOf("v") !== -1; var i = a.indexOf("u") !== -1; this.start = e | 0; this.source = t + ""; this.flags = a; if (p && this.parser.options.ecmaVersion >= 15) {
                this.switchU = true;
                this.switchV = true;
                this.switchN = true;
            }
            ...
            qe.prototype.at = function at(e, t) { if (t === void 0)
                ...
                return -1;
            } var i = a.charCodeAt(e); if (!(t || this.switchU) || i <= 55295 || i >= 57344 || e + 1 >= p) {
                return i;
            } var r = a.charCodeAt(e + 1); return r >= 56320 && r <= 57343 ? (i << 10) + r - 56613888 : i; };
            qe.prototype.nextIndex = function nextIndex(e, t) { if (t === void 0)
                t = false; var a = this.source; var p = a.length; if (e >= p) {
                return p;
            } var i = a.charCodeAt(e), r; if (!(t || this.switchU) || i <= 55295 || i >= 57344 || e + 1 >= p || (r = a.charCodeAt(e + 1)) < 56320 || r > 57343) {
                return e + 1;
            } return e + 2; };
            ...
            qe.prototype.eatChars = function eatChars(e, t) { if (t === void 0)
                t = false; var a = this.pos; for (var p = 0, i = e; p < i.length; p += 1) {
                var r = i[p];
                var s = this.at(a, t);
                if (s === -1 || s !== r) {
                    return false;
            ...
            je.validateRegExpFlags = function (e) { var t = e.validFlags; var a = e.flags; var p = false; var i = false; for (var r = 0; r < a.length; r++) {
                var s = a.charAt(r);
                if (t.indexOf(s) === -1) {
                    this.raise(e.start, "Invalid regular expression flag");
                }
                if (a.indexOf(s, r + 1) > -1) {
            ...
            } if (this.options.ecmaVersion >= 15 && p && i) {
                this.raise(e.start, "Invalid regular expression flag");
            } };
            ...
            je.regexp_eatRegExpIdentifierStart = function (e) { var t = e.pos; var a = this.options.ecmaVersion >= 11; var p = e.current(a); e.advance(a); if (p === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, a)) {
                p = e.lastIntValue;
            ...
            je.regexp_eatRegExpIdentifierPart = function (e) { var t = e.pos; var a = this.options.ecmaVersion >= 11; var p = e.current(a); e.advance(a); if (p === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, a)) {
                p = e.lastIntValue;
            ...
            je.regexp_eatCharacterClassEscape = function (e) { var t = e.current(); if (isCharacterClassEscape(t)) {
                ...
                e.advance();
                var p;
                if (e.eat(123) && (p = this.regexp_eatUnicodePropertyValueExpression(e)) && e.eat(125)) {
                    if (a && p === ze) {
            ...
            je.regexp_validateUnicodePropertyNameAndValue = function (e, t, a) { if (!P(e.unicodeProperties.nonBinary, t)) {
                e.raise("Invalid property name");
            ...
            } this.regexp_nonEmptyClassRanges(e); return Me; };
            ...
            je.regexp_classSetExpression = function (e) { var t = Me, a; if (this.regexp_eatClassSetRange(e))
                ;
            ...
            je.regexp_eatNestedClass = function (e) { var t = e.pos; if (e.eat(91)) {
                var a = e.eat(94);
                var p = this.regexp_classContents(e);
                if (e.eat(93)) {
                    if (a && p === ze) {
                        e.raise("Negated character class may contain strings");
                    }
            ...
            je.regexp_eatFixedHexDigits = function (e, t) { var a = e.pos; e.lastIntValue = 0; for (var p = 0; p < t; ++p) {
                var i = e.current();
                if (!isHexDigit(i)) {
                    e.pos = a;
                    return false;
            ...
            var $e = function Token(e) { this.type = e.type; this.value = e.value; this.start = e.start; this.end = e.end; if (e.options.locations) {
            ...
            We.getToken = function () { this.next(); return new $e(this); };
            if (typeof Symbol !== "undefined") {
                We[Symbol.iterator] = function () { var e = this; return { next: function () { var t = e.getToken(); return { done: t.type === _.eof, value: t }; } }; };
            }
            ...
            We.skipBlockComment = function () { var e = this.options.onComment && this.curPosition(); var t = this.pos, a = this.input.indexOf("*/", this.pos += 2); if (a === -1) {
                this.raise(this.pos - 2, "Unterminated comment");
            } this.pos = a + 2; if (this.options.locations) {
                for (var p = void 0, i = t; (p = nextLineBreak(this.input, i, this.pos)) > -1;) {
                    ++this.curLine;
                    i = this.lineStart = p;
                }
            ...
            We.skipLineComment = function (e) { var t = this.pos; var a = this.options.onComment && this.curPosition(); var p = this.input.charCodeAt(this.pos += e); while (this.pos < this.input.length && !isNewLine(p)) {
            ...
            We.skipSpace = function () { e: while (this.pos < this.input.length) {
                ...
                switch (e) {
                    ...
                    case 47:
                        ...
                        break;
                    default: if (e > 8 && e < 14 || e >= 5760 && T.test(String.fromCharCode(e))) {
                        ++this.pos;
                    }
                    else {
                        break e;
            ...
            We.readToken_mult_modulo_exp = function (e) { var t = this.input.charCodeAt(this.pos + 1); var a = 1; var p = e === 42 ? _.star : _.modulo; if (this.options.ecmaVersion >= 7 && e === 42 && t === 42) {
                ++a;
                p = _.starstar;
            ...
            We.readToken_lt_gt = function (e) { var t = this.input.charCodeAt(this.pos + 1); var a = 1; if (t === e) {
            ...
            We.finishOp = function (e, t) { var a = this.input.slice(this.pos, this.pos + t); this.pos += t; return this.finishToken(e, a); };
            We.readRegexp = function () { var e, t, a = this.pos; for (;;) {
                if (this.pos >= this.input.length) {
                ...
                ++this.pos;
            } var i = this.input.slice(a, this.pos); ++this.pos; var r = this.pos; var s = this.readWord1(); if (this.containsEsc) {
                this.unexpected(r);
            } var o = this.regexpState || (this.regexpState = new qe(this)); o.reset(a, i, s); this.validateRegExpFlags(o); this.validateRegExpPattern(o); var d = null; try {
                d = new RegExp(i, s);
            }
            catch (e) { } return this.finishToken(_.regexp, { pattern: i, flags: s, value: d }); };
            We.readInt = function (e, t, a) { var p = this.options.ecmaVersion >= 12 && t === undefined; var i = a && this.input.charCodeAt(this.pos) === 48; var r = this.pos, s = 0, o = 0; for (var d = 0, n = t == null ? Infinity : t; d < n; ++d, ++this.pos) {
            ...
            We.readRadixNumber = function (e) { var t = this.pos; this.pos += 2; var a = this.readInt(e); if (a == null) {
            ...
            We.readNumber = function (e) { var t = this.pos; if (!e && this.readInt(10, undefined, true) === null) {
                ...
                return this.finishToken(_.num, i);
            ...
            We.readString = function (e) { var t = "", a = ++this.pos; for (;;) {
                if (this.pos >= this.input.length) {
            ...
            We.readHexChar = function (e) { var t = this.pos; var a = this.readInt(16, e); if (a === null) {
                this.invalidStringToken(t, "Bad character escape sequence");
            } return a; };
            We.readWord1 = function () { this.containsEsc = false; var e = "", t = true, a = this.pos; var p = this.options.ecmaVersion >= 6; while (this.pos < this.input.length) {
                var i = this.fullCharCodeAtPos();
                if (isIdentifierChar(i, p)) {
                    ...
                    if (!(t ? isIdentifierStart : isIdentifierChar)(s, p)) {
                        this.invalidStringToken(r, "Invalid Unicode escape");
                    }
                    e += codePointToString(s);
                    a = this.pos;
                }
                else {
                    break;
            ...
            We.readWord = function () { var e = this.readWord1(); var t = _.name; if (this.keywords.test(e)) {
                t = w[e];
            } return this.finishToken(t, e); };
            var Je = "8.11.3";
            Y.acorn = { Parser: Y, version: Je, defaultOptions: R, Position: N, SourceLocation: O, getLineInfo: getLineInfo, Node: we, TokenType: h, tokTypes: _, keywordTypes: w, TokContext: le, tokContexts: me, isIdentifierChar: isIdentifierChar, isIdentifierStart: isIdentifierStart, Token: $e, isNewLine: isNewLine, lineBreak: b, lineBreakG: E, nonASCIIwhitespace: T };
            function parse(e, t) { return Y.parse(e, t); }
            function parseExpressionAt(e, t, a) { return Y.parseExpressionAt(e, t, a); }
            function tokenizer(e, t) { return Y.tokenizer(e, t); }
            function simple(e, t, a, p, i) { if (!a) {
                a = Ye;
            } (function c(e, p, i) { var r = i || e.type; a[r](e, p, c); if (t[r]) {
                t[r](e, p);
            } })(e, p, i); }
            function ancestor(e, t, a, p, i) { var r = []; if (!a) {
                a = Ye;
            } (function c(e, p, i) { var s = i || e.type; var o = e !== r[r.length - 1]; if (o) {
                r.push(e);
            } a[s](e, p, c); if (t[s]) {
                t[s](e, p || r, r);
            } if (o) {
            ...
            function recursive(e, t, a, p, i) { var r = a ? make(a, p || undefined) : p; (function c(e, t, a) { r[a || e.type](e, t, c); })(e, t, i); }
            ...
            var Qe = function Found(e, t) { this.node = e; this.state = t; };
            function full(e, t, a, p, i) { if (!a) {
                a = Ye;
            } var r; (function c(e, p, i) { var s = i || e.type; a[s](e, p, c); if (r !== e) {
                t(e, p, s);
                r = e;
            } })(e, p, i); }
            function fullAncestor(e, t, a, p) { if (!a) {
                a = Ye;
            } var i = [], r; (function c(e, p, s) { var o = s || e.type; var d = e !== i[i.length - 1]; if (d) {
                i.push(e);
            } a[o](e, p, c); if (r !== e) {
                t(e, p || i, i, o);
                r = e;
            ...
            function findNodeAt(e, t, a, p, i, r) { if (!i) {
                i = Ye;
            } p = makeTest(p); try {
                (function c(e, r, s) { var o = s || e.type; if ((t == null || e.start <= t) && (a == null || e.end >= a)) {
                    i[o](e, r, c);
                } if ((t == null || e.start === t) && (a == null || e.end === a) && p(o, e)) {
                    throw new Qe(e, r);
                } })(e, r);
            }
            catch (e) {
            ...
            function findNodeAround(e, t, a, p, i) { a = makeTest(a); if (!p) {
                p = Ye;
            } try {
                (function c(e, i, r) { var s = r || e.type; if (e.start > t || e.end < t) {
                    return;
                } p[s](e, i, c); if (a(s, e)) {
                    throw new Qe(e, i);
                } })(e, i);
            ...
            function findNodeAfter(e, t, a, p, i) { a = makeTest(a); if (!p) {
                p = Ye;
            } try {
                (function c(e, i, r) { if (e.end < t) {
                    return;
                } var s = r || e.type; if (e.start >= t && a(s, e)) {
                    throw new Qe(e, i);
                } p[s](e, i, c); })(e, i);
            }
            catch (e) {
            ...
            function findNodeBefore(e, t, a, p, i) { a = makeTest(a); if (!p) {
                p = Ye;
            } var r; (function c(e, i, s) { if (e.start > t) {
                return;
            } var o = s || e.type; if (e.end <= t && (!r || r.node.end < e.end) && a(o, e)) {
                r = new Qe(e, i);
            } p[o](e, i, c); })(e, i); return r; }
            function make(e, t) { var a = Object.create(t || Ye); for (var p in e) {
                a[p] = e[p];
            } return a; }
            function skipThrough(e, t, a) { a(e, t); }
            function ignore(e, t, a) { }
            var Ye = {};
            Ye.Program = Ye.BlockStatement = Ye.StaticBlock = function (e, t, a) { for (var p = 0, i = e.body; p < i.length; p += 1) {
                var r = i[p];
                a(r, t, "Statement");
            } };
            Ye.Statement = skipThrough;
            Ye.EmptyStatement = ignore;
            Ye.ExpressionStatement = Ye.ParenthesizedExpression = Ye.ChainExpression = function (e, t, a) { return a(e.expression, t, "Expression"); };
            Ye.IfStatement = function (e, t, a) { a(e.test, t, "Expression"); a(e.consequent, t, "Statement"); if (e.alternate) {
                a(e.alternate, t, "Statement");
            } };
            Ye.LabeledStatement = function (e, t, a) { return a(e.body, t, "Statement"); };
            Ye.BreakStatement = Ye.ContinueStatement = ignore;
            Ye.WithStatement = function (e, t, a) { a(e.object, t, "Expression"); a(e.body, t, "Statement"); };
            Ye.SwitchStatement = function (e, t, a) { a(e.discriminant, t, "Expression"); for (var p = 0, i = e.cases; p < i.length; p += 1) {
                var r = i[p];
                if (r.test) {
                    a(r.test, t, "Expression");
                }
                for (var s = 0, o = r.consequent; s < o.length; s += 1) {
                    var d = o[s];
                    a(d, t, "Statement");
                }
            } };
            Ye.SwitchCase = function (e, t, a) { if (e.test) {
                a(e.test, t, "Expression");
            } for (var p = 0, i = e.consequent; p < i.length; p += 1) {
                var r = i[p];
                a(r, t, "Statement");
            } };
            Ye.ReturnStatement = Ye.YieldExpression = Ye.AwaitExpression = function (e, t, a) { if (e.argument) {
                a(e.argument, t, "Expression");
            } };
            Ye.ThrowStatement = Ye.SpreadElement = function (e, t, a) { return a(e.argument, t, "Expression"); };
            Ye.TryStatement = function (e, t, a) { a(e.block, t, "Statement"); if (e.handler) {
                a(e.handler, t);
            } if (e.finalizer) {
                a(e.finalizer, t, "Statement");
            } };
            Ye.CatchClause = function (e, t, a) { if (e.param) {
                a(e.param, t, "Pattern");
            } a(e.body, t, "Statement"); };
            Ye.WhileStatement = Ye.DoWhileStatement = function (e, t, a) { a(e.test, t, "Expression"); a(e.body, t, "Statement"); };
            Ye.ForStatement = function (e, t, a) { if (e.init) {
                a(e.init, t, "ForInit");
            } if (e.test) {
                a(e.test, t, "Expression");
            } if (e.update) {
            ...
            Ye.ForInStatement = Ye.ForOfStatement = function (e, t, a) { a(e.left, t, "ForInit"); a(e.right, t, "Expression"); a(e.body, t, "Statement"); };
            Ye.ForInit = function (e, t, a) { if (e.type === "VariableDeclaration") {
                a(e, t);
            }
            else {
                a(e, t, "Expression");
            } };
            Ye.DebuggerStatement = ignore;
            Ye.FunctionDeclaration = function (e, t, a) { return a(e, t, "Function"); };
            Ye.VariableDeclaration = function (e, t, a) { for (var p = 0, i = e.declarations; p < i.length; p += 1) {
                var r = i[p];
                a(r, t);
            } };
            Ye.VariableDeclarator = function (e, t, a) { a(e.id, t, "Pattern"); if (e.init) {
                a(e.init, t, "Expression");
            } };
            Ye.Function = function (e, t, a) { if (e.id) {
                a(e.id, t, "Pattern");
            } for (var p = 0, i = e.params; p < i.length; p += 1) {
                var r = i[p];
                a(r, t, "Pattern");
            } a(e.body, t, e.expression ? "Expression" : "Statement"); };
            Ye.Pattern = function (e, t, a) { if (e.type === "Identifier") {
            ...
            Ye.VariablePattern = ignore;
            Ye.MemberPattern = skipThrough;
            Ye.RestElement = function (e, t, a) { return a(e.argument, t, "Pattern"); };
            Ye.ArrayPattern = function (e, t, a) { for (var p = 0, i = e.elements; p < i.length; p += 1) {
                var r = i[p];
                if (r) {
                    a(r, t, "Pattern");
                }
            } };
            Ye.ObjectPattern = function (e, t, a) { for (var p = 0, i = e.properties; p < i.length; p += 1) {
                var r = i[p];
                if (r.type === "Property") {
                    if (r.computed) {
            ...
            Ye.Expression = skipThrough;
            Ye.ThisExpression = Ye.Super = Ye.MetaProperty = ignore;
            Ye.ArrayExpression = function (e, t, a) { for (var p = 0, i = e.elements; p < i.length; p += 1) {
                var r = i[p];
                if (r) {
                    a(r, t, "Expression");
                }
            } };
            Ye.ObjectExpression = function (e, t, a) { for (var p = 0, i = e.properties; p < i.length; p += 1) {
                var r = i[p];
                a(r, t);
            } };
            Ye.FunctionExpression = Ye.ArrowFunctionExpression = Ye.FunctionDeclaration;
            Ye.SequenceExpression = function (e, t, a) { for (var p = 0, i = e.expressions; p < i.length; p += 1) {
                var r = i[p];
                a(r, t, "Expression");
            } };
            Ye.TemplateLiteral = function (e, t, a) { for (var p = 0, i = e.quasis; p < i.length; p += 1) {
                var r = i[p];
                a(r, t);
            ...
            Ye.TemplateElement = ignore;
            Ye.UnaryExpression = Ye.UpdateExpression = function (e, t, a) { a(e.argument, t, "Expression"); };
            Ye.BinaryExpression = Ye.LogicalExpression = function (e, t, a) { a(e.left, t, "Expression"); a(e.right, t, "Expression"); };
            Ye.AssignmentExpression = Ye.AssignmentPattern = function (e, t, a) { a(e.left, t, "Pattern"); a(e.right, t, "Expression"); };
            Ye.ConditionalExpression = function (e, t, a) { a(e.test, t, "Expression"); a(e.consequent, t, "Expression"); a(e.alternate, t, "Expression"); };
            Ye.NewExpression = Ye.CallExpression = function (e, t, a) { a(e.callee, t, "Expression"); if (e.arguments) {
                for (var p = 0, i = e.arguments; p < i.length; p += 1) {
                    var r = i[p];
                    a(r, t, "Expression");
                }
            } };
            Ye.MemberExpression = function (e, t, a) { a(e.object, t, "Expression"); if (e.computed) {
                a(e.property, t, "Expression");
            } };
            Ye.ExportNamedDeclaration = Ye.ExportDefaultDeclaration = function (e, t, a) { if (e.declaration) {
                a(e.declaration, t, e.type === "ExportNamedDeclaration" || e.declaration.id ? "Statement" : "Expression");
            } if (e.source) {
                a(e.source, t, "Expression");
            } };
            Ye.ExportAllDeclaration = function (e, t, a) { if (e.exported) {
                a(e.exported, t);
            } a(e.source, t, "Expression"); };
            Ye.ImportDeclaration = function (e, t, a) { for (var p = 0, i = e.specifiers; p < i.length; p += 1) {
                var r = i[p];
                a(r, t);
            } a(e.source, t, "Expression"); };
            Ye.ImportExpression = function (e, t, a) { a(e.source, t, "Expression"); };
            Ye.ImportSpecifier = Ye.ImportDefaultSpecifier = Ye.ImportNamespaceSpecifier = Ye.Identifier = Ye.PrivateIdentifier = Ye.Literal = ignore;
            Ye.TaggedTemplateExpression = function (e, t, a) { a(e.tag, t, "Expression"); a(e.quasi, t, "Expression"); };
            Ye.ClassDeclaration = Ye.ClassExpression = function (e, t, a) { return a(e, t, "Class"); };
            Ye.Class = function (e, t, a) { if (e.id) {
                a(e.id, t, "Pattern");
            } if (e.superClass) {
                a(e.superClass, t, "Expression");
            } a(e.body, t); };
            Ye.ClassBody = function (e, t, a) { for (var p = 0, i = e.body; p < i.length; p += 1) {
                var r = i[p];
                a(r, t);
            } };
            Ye.MethodDefinition = Ye.PropertyDefinition = Ye.Property = function (e, t, a) { if (e.computed) {
            ...
            function getLangStrings(e) { var t = {}; var a = parse(e, { ecmaVersion: "2022" }); simple(a, { ObjectExpression: function (e) { var _a; if (e.properties.find((function (e) { var _a; return ((_a = e.key) === null || _a === void 0 ? void 0 : _a.type) === "Identifier" && (e.key.name === "DISCORD_NAME" || e.key.name === "DISCORD_DESC_SHORT"); }))) {
                    for (var _i = 0, _b = e.properties; _i < _b.length; _i++) {
                        var a_22 = _b[_i];
                        var e_52 = (_a = a_22.key.value) !== null && _a !== void 0 ? _a : a_22.key.name;
                        var p_17 = void 0;
                        if (a_22.value.type === "Literal") {
                            p_17 = a_22.value.raw;
                        }
                        else if (a_22.value.type === "TemplateLiteral") {
                            var e_53 = a_22.value.quasis.map((function (e) { return e.value.cooked; })).join("");
                            var t_34 = JSON.stringify(e_53);
                            p_17 = t_34;
                        }
                        t[e_52] = p_17;
                    }
                } } }); return t; }
            function getEndpoints(e) { var t = {}; var a = parse(e, { ecmaVersion: "latest" }); simple(a, { ObjectExpression: function (e, a) { if (a.step === 0 && e.properties.find((function (e) { var _a; return ((_a = e.key) === null || _a === void 0 ? void 0 : _a.name) === "USER_RELATIONSHIP"; }))) {
                    a.step = 1;
                    var _loop_2 = function (a_23) {
                        var e_54 = a_23.key.name;
                        var p_18;
                        if (a_23.value.type === "Literal") {
                            p_18 = a_23.value.value;
                        }
                        else if (["FunctionExpression", "ArrowFunctionExpression"].includes(a_23.value.type)) {
                            p_18 = "";
                            if (a_23.value.type === "ArrowFunctionExpression" && a_23.value.body.type === "Literal") {
                                p_18 = a_23.value.body.value;
                            }
                            else {
                                simple(a_23.value, { CallExpression: function (e) { if (e.callee.type === "MemberExpression" && e.callee.object.type === "Literal") {
                                        p_18 += e.callee.object.value;
                                    } for (var _i = 0, _a = e.arguments; _i < _a.length; _i++) {
                                        var t_35 = _a[_i];
                                        if (t_35.type === "Identifier") {
                                            p_18 += ":param";
                                        }
                                        else if (t_35.type === "Literal") {
                                            p_18 += t_35.value;
                                        }
                                    } } });
                            }
                            ...
                            throw new Error("Unexpected node type: ".concat(a_23.value.type));
                        }
                        t[e_54] = p_18;
                    };
                ...
                } } }, undefined, { step: 0 }); return t; }
            var Ze = { codeblock: { startString: { strings: "## Strings\n```diff", endpoints: "## Endpoints\n```diff" }, endString: "```", addedHeader: "\n# Added\n", updatedHeader: "\n# Updated\n", removedHeader: "\n# Removed\n", added: function (e) { return "+ ".concat(e[0], ": ").concat(e[1], "\n"); }, updated: function (e) { return "- ".concat(e[0], ": ").concat(e[1], "\n+ ").concat(e[0], ": ").concat(e[2], "\n"); }, removed: function (e) { return "- ".concat(e[0], ": ").concat(e[1], "\n"); } }, inline: { startString: { strings: "## Strings\n```diff", endpoints: "## Endpoints\n```diff" }, endString: "", addedHeader: "### Added\n", updatedHeader: "### Updated\n", removedHeader: "### Removed\n", added: function (e) { return " - `".concat(e[0], "`: `").concat(e[1], "`\n"); }, updated: function (e) { return " - `".concat(e[0], "`: `").concat(e[1], "` -> `").concat(e[2], "`\n"); }, removed: function (e) { return " - `".concat(e[0], "`: `").concat(e[1], "`\n"); } } };
            var Xe;
            function doWork(e, t, a) { var p = [getLangStrings(e), getLangStrings(t)]; var i = [getEndpoints(e), getEndpoints(t)]; var _a = diff(p), r = _a.addedStrings, s = _a.updatedStrings, o = _a.removedStrings; var _b = diff(i), d = _b.addedStrings, n = _b.updatedStrings, l = _b.removedStrings; Xe = a; var m = buildString("strings", r, s, o); var u = buildString("endpoints", d, n, l); var h = ""; if (m) {
                h += m;
            } if (u) {
                h += m ? "\n" + u : u;
            } return h; }
            function diff(e) { var t = []; var a = []; var p = []; for (var _i = 0, _a = Object.keys(e[0]); _i < _a.length; _i++) {
                var p_19 = _a[_i];
                if (e[1][p_19] != undefined) {
                    if (e[0][p_19] !== e[1][p_19]) {
                        a.push([p_19, e[0][p_19], e[1][p_19]]);
                    }
                }
                else {
                    t.push([p_19, e[0][p_19]]);
                }
            } for (var _b = 0, _c = Object.keys(e[1]); _b < _c.length; _b++) {
                var t_36 = _c[_b];
                if (e[0][t_36] == undefined) {
                    p.push([t_36, e[1][t_36]]);
                }
            } return { addedStrings: p, updatedStrings: a, removedStrings: t }; }
            function buildString(e, t, a, p) { var i = ""; if (t[0] || a[0] || p[0]) {
                i += Ze[Xe].startString[e];
                if (t[0]) {
                    i += Ze[Xe].addedHeader;
                    i += buildDiffString(t, "added");
                }
                if (a[0]) {
                    i += Ze[Xe].updatedHeader;
                    i += buildDiffString(a, "updated");
                }
                if (p[0]) {
                    i += Ze[Xe].removedHeader;
                    i += buildDiffString(p, "removed");
                }
                i += Ze[Xe].endString;
            } return i; }
            function buildDiffString(e, t) { var a = ""; e.forEach((function (e) { a += Ze[Xe][t](e); })); return a; }
            var et = doWork;
        }, 1229: function (e) {
            "use strict";
